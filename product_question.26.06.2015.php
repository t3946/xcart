...
db_query("INSERT INTO $sql_tbl[product_question] (productid, email, phone, question, date, company, zipcode, name) VALUES ('$productid', '$customer_email', '$phone', '$question', '".time()."', '".addslashes($company)."', '".addslashes($b_zipcode)."', '".addslashes($firstname)."')");
...
$product_question_subject_line = str_replace("{{prqnid}}", $prefix_product_question_id, $product_question_subject_line);
$product_question_subject_line = str_replace("{{signature}}", $signature, $product_question_subject_line);

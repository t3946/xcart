...
if (!empty($product_tabs) && is_array($product_tabs)) {
	...
	$count_shipping_rates_for_canada = func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[shipping_rates] WHERE manufacturerid='$product_info[manufacturerid]' AND type='R' AND zoneid='12'");

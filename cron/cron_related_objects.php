...
Select SQL_NO_CACHE categoryid, SUM(t.Views) As V, SUM(t.Sales) As S
From 
(Select 
                                C.categoryid,
...
Select SQL_NO_CACHE PP.productid,
...
Select SQL_NO_CACHE CS.categoryid,
                        COUNT(SPS.id), LENGTH(GROUP_CONCAT( SMS.goal_order)) - LENGTH(REPLACE(GROUP_CONCAT( SMS.goal_order),'Y','')) As Sales
From 
(Select 
                                SM.id
...
Select SQL_NO_CACHE SP.resource_id, GROUP_CONCAT(SP.additional_data) As FV

...
$google_inventory_batch_count = 1;
$google_products_batch_count = 1;
...
$max_google_batch = 300;
$amazon_inventory_batch_count = 1;
$amazon_products_batch_count = 1;
$ainventory = array();
$aproducts = array();
...
//if (!($product["productid"] == "140060" || $product["productid"] == "209955"))
//continue;
...
//die("A");
				...
				if ($product_amazon_enable == "Y"){
					$AddProductToAmazonBatch_arr = AddProductToAmazonBatch($product["productid"], $product["utype"]);
				}
				...
				if ($amazon_inventory_batch_count == $max_amazon_batch){
					$SubmitAmazonInventoryBatch_arr = SubmitAmazonInventoryBatch();

...
//    if ($pageid == "27"){
	...
	$linktous_text_sample = '<a href="'.$config["Company"]["company_website"]. '" title="'.addslashes($config["Company"]["cidev_description"]).'">'.$config["Company"]["company_name"].'</a>';
...
//	$linktous_text_sample = htmlspecialchars($linktous_text_sample);
	...
	$linktous_banner_sample = '<a href="'.$config["Company"]["company_website"]. '" title="'.addslashes($config["Company"]["cidev_description"]).'"><img src="'.$config["Company"]["company_website"]. '/image.php?type=S&id='.$current_storefront.'" alt="'.$config["Company"]["company_name"].'" /></a>';

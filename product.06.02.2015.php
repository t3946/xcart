...
*/
	        if ($new_eta_date_mm_dd_yyyy != $product_info["eta_date_mm_dd_yyyy"] || $product_info["r_avail"] != $new_r_avail || $product_info["cost_to_us"] != $new_cost_to_us || $new_discount_table != $product_info["discount_table"] || $new_new_map_price != $product_info["new_map_price"] || $new_min_amount != $product_info["min_amount"] || $new_list_price != $product_info["list_price"]){

...
elseif ($option == "Attention_tags_invoices") {
    include "./attention_tags_invoices.php";
}
elseif ($option == "Product_classification") {
    include "./product_classification.php";
}
elseif ($option == "Related_objects_collector_cron") {
    include "./related_objects_collector_cron.php";
}
elseif ($option == "Checks_deposited_options") {
    include "./checks_deposited_options.php";
}
elseif ($option == "Order_page_permissions") {
    include "./order_page_permissions.php";
}
elseif ($option == "Inquiries_options") {
    include "./inquiries_options.php";
}
...
elseif ($option == "Supplier_feeds") {
    include $xcart_dir . '/modules/Supplier_feeds/supplier_feeds_options.php';
}
...
if ($option == 'Purchase_Order' || $option == 'RMA_options'){

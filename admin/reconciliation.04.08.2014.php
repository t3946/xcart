			...
			if (!empty($orderids)){
				...
				if (!empty($found_orders)){
					...
					if ($total_order_amounts > 0 && $reconciliations[$k]["amount_csv_abs"] > 0 && $total_order_amounts != $reconciliations[$k]["amount_csv_abs"]){
						...
						$reconciliations[$k]["total_order_amounts_amount_csv_abs_diff_abs"] = $total_order_amounts_amount_csv_abs_diff_abs;
						$reconciliations[$k]["total_order_amounts_amount_csv_abs_diff"] = $total_order_amounts_amount_csv_abs_diff;

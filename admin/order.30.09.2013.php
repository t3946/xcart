...
# END: random:20341 [2010 Jul 29 14:46] 
				...
				if (!empty($products) && is_array($products)){
				        ...
				        $cidev_items_table = "";
				        $cidev_items_table .= "<table border='1'>\r\n";
				...
				$d_message_body_14 = str_replace("{{orderid}}", $orderid, $d_message_body_14);
				$mnfs[$m_id]['d_message_body_14'] = $d_message_body_14;
                                ...
                                $d_email_subject_14 = str_replace("{{orderid}}", $orderid, $d_email_subject_14);

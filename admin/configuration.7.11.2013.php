...
$trusted_post_variables = array("gpg_key", "pgp_key", "xpc_private_key_password", "xpc_private_key", "xpc_public_key", 'code_below_thumb', 'search_products_box_code', 'search_products_result_code', 'cidev_tracking_code', 'cidev_main_page_code', 'cidev_footer_code', 'cidev_keywords', 'cidev_description', 'cidev_header_code', 'cidev_top_header_code', 'cidev_yandex_code_number', 'cidev_ga_code_number', 'cidev_google_adwords', 'ssl_seal');

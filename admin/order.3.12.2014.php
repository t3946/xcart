...
//		if ($vs == "all_in_stock") continue;
				...
				$current_avail = func_query_first_cell("SELECT avail FROM $sql_tbl[products] WHERE productid='$productid'");
					...
					$offer_backorder = $offer_backorder[$productid];
					if (empty($offer_backorder)){
						$offer_backorder = "N";
					}

					db_query("UPDATE $sql_tbl[order_details] SET offer_backorder='$offer_backorder' WHERE productid='$productid' AND orderid='$orderid'");

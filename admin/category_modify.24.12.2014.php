...
*/
		...
		#
		db_query("UPDATE $sql_tbl[categories] SET category='$category_name', description='$description', meta_descr='$meta_descr', meta_keywords='$meta_keywords', avail='$avail', order_by='$order_by', is_bold='$is_bold', pc_ready_to_classify='$pc_ready_to_classify', title_tag='$title_tag' WHERE categoryid='$cat'");

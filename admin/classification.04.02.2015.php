...
##
		if (!empty($product["pc_most_relevant_categories"])){
			...
			$relevant_cats[0]["score"] = $pc_most_relevant_categories_arr_0[0];
			...
			if (!empty($pc_most_relevant_categories_arr[1])){
                	        ...
                	        $relevant_cats[1]["score"] = $pc_most_relevant_categories_arr_1[0];
...
//func_print_r($products_minimum_number_of_autoclassify_product_per_turn);

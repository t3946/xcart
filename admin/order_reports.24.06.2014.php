...
//				    $DATA[1][]= ($max_time_to_dispatch_in_hours-$min_time_to_dispatch_in_hours)/$count_found_orders;
				    $DATA[1][]= $total_time_to_dispatch_in_hours/$count_found_orders;



				    $DATA[2][]=$total_time_to_dispatch_in_hours/$count_found_orders - $sigma;
				    $DATA[3][]=$total_time_to_dispatch_in_hours/$count_found_orders + $sigma;
//				    $DATA[1][]=rand(0,100)/2;
//				    $DATA[2][]=rand(0,100)/3;
				    $DATA["x"][]=$i;
				}
...
$bar[3]=imagecolorallocate($im,191,65,170);

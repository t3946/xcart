...
/*
		...
		$count_category_not_ready_to_classification = count($category_not_ready_to_classification);

		$condition = $correct_categoryid_counter/$count_products;
		if ($condition <= 0.2){
...
*/
	        ...
	        func_header_location("categorization.php");
	}

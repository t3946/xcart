...
*/
		...
		#
		db_query("UPDATE $sql_tbl[categories] SET category='$category_name', description='$description', meta_descr='$meta_descr', meta_keywords='$meta_keywords', avail='$avail', order_by='$order_by', is_bold='$is_bold', title_tag='$title_tag' WHERE categoryid='$cat'");
...
//func_print_r($linked_out_category_id, $linked_out_category_id_parentid, "---", $cat, $current_category);
//die();

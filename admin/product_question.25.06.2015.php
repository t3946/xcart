...
$product_question_subject_line_to_distr = str_replace("{{customer_name}}", $product_question["firstname"], $product_question_subject_line_to_distr);
...
$product_question_message_body_to_distr = str_replace("{{customer_name}}", $product_question["firstname"], $product_question_message_body_to_distr);
...
$product_answer_subject_line = str_replace("{{customer_name}}", $product_question["firstname"], $product_answer_subject_line);
...
$product_answer_message_body = str_replace("{{customer_name}}", $product_question["firstname"], $product_answer_message_body);

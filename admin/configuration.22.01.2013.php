...
$trusted_post_variables = array("gpg_key", "pgp_key", "xpc_private_key_password", "xpc_private_key", "xpc_public_key", 'code_below_thumb', 'search_products_box_code', 'search_products_result_code', 'cidev_tracking_code', 'cidev_main_page_code', 'cidev_footer_code');
...
elseif ($option == "Search_products") {
	...
	if (
		$option == 'Appearance' &&
		!isset($HTTP_POST_VARS['display_productcode_in_list']) &&
		$config['Appearance']['display_productcode_in_list'] == 'Y' &&
		$HTTP_POST_VARS['products_order'] == 'productcode'
	) {

...
//func_print_r($filter_selected_brands, $filter_selected_and_found_brands);

//func_print_r($show_N_brands);
...
/*
func_print_r($cat);
func_print_r($filter_selected_cat);
if ($filter_selected_cat != $cat){
	$filter_selected_cat = $cat;
	x_session_save("filter_selected_cat");
	$filter_prices = "";
...
/*
###
	$search_query_prices_arr = explode("xcart_products.forsale = 'Y'", $search_query_prices);
	$count_search_query_prices_arr = count($search_query_prices_arr);
	$last_key_search_query_prices_arr = $count_search_query_prices_arr - 1;
	unset($search_query_prices_arr[$last_key_search_query_prices_arr]);
	$search_query_prices = implode("xcart_products.forsale = 'Y'", $search_query_prices_arr);
	$search_query_prices .= "xcart_products.forsale = 'Y' GROUP BY $sql_tbl[products].productid";
###
*/
	...
	if ($filter_max_price > 0){
		$filter_range_price = $filter_max_price/5;
		...
		for ($i = 0; $i < 5; $i++) {
			$min_price = $i * $filter_range_step_price;

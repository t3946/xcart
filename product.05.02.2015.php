...
#
		...
		$new_discount_table = $product_info["discount_table"];
	        ...
	        if ($new_eta_date_mm_dd_yyyy != $product_info["eta_date_mm_dd_yyyy"] || $product_info["r_avail"] != $new_r_avail || $product_info["cost_to_us"] != $new_cost_to_us || $new_discount_table != $product_info["discount_table"] || $new_new_map_price != $product_info["new_map_price"]){
	                db_query("UPDATE $sql_tbl[products] SET r_avail='$new_r_avail', eta_date_mm_dd_yyyy='$new_eta_date_mm_dd_yyyy', supplier_internal_id_last_parsed_update='".time()."', supplier_internal_id_last_parsed='".time()."', cost_to_us='$new_cost_to_us', discount_table='$new_discount_table', new_map_price='$new_new_map_price' WHERE productid='$productid'");
			$make_redirect = true;

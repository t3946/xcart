...
//                        $new_notify_in_stock_price = max($v["map_price"], $max1);
			$new_notify_in_stock_price = func_decreased_price($v["cost_to_us"], $v["taxed_price"], $v["map_price"]);
                ...
                if (!empty($config["Appearance"]["CDN_domain"]) && $config["Appearance"]["Enable_CDN"] == "Y"){
...
/*
if ($qqq == "qqq"){
func_print_r($config["Appearance"]["CDN_domain"], $config["Appearance"]["Enable_CDN"], $f_new_products);
}
*/

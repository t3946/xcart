...
{/if}
<td valign="middle">{if $smarty.get.pageid ne $top_pages_menu[top_page].pageid}<a class="top_links" href="pages.php?pageid={$top_pages_menu[top_page].pageid}">{/if}{$top_pages_menu[top_page].title}{if $smarty.get.pageid ne $top_pages_menu[top_page].pageid}</a>{/if}</td>
{* {if !%page.last%} *}
...
*}
<td valign="middle">{if $main ne "help" && $smarty.get.section ne "contactus"}<a class="top_links" href="help.php?section=contactus&mode=update">{/if}Contact us{if $main ne "help" && $smarty.get.section ne "contactus"}</a>{/if}</td>

<td valign="middle">{$lng.lbl_top_header_nbsp}</td>
</tr>
</table>
        </td>
        </tr>
...
<TD {* height="130" *} valign="bottom">
        ...
        <td width="250" {* style="background: url({$xcart_web_dir}/image.php?id={$current_storefront_info.storefrontid}&amp;type=S) no-repeat;" *} valign="bottom">
        ...
        <td width="*" {* height="100%" *} valign="bottom">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" >
                        <tr><td {* height="90" *} align="center" colspan="3">{$config.Company.cidev_header_code}</td></tr>
                        <tr>
                            <td {* height="40" *} valign="bottom" width="*">

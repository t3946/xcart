...
<td align="center"><input type="text" name="posted_data[{$pages[pg].pageid}][header_pos]" value="{$pages[pg].header_pos}" size="5" /></td>
</tr>
...
<tr class="TableHead">
	...
	<td width="50%">{$lng.lbl_page_title}</td>
	<td width="20%" colspan="2">{$lng.lbl_status}</td>
	<td width="20%">Header Pos.</td>
</tr>
...
<tr>
<td align="center" colspan="6">{$lng.txt_no_embedded_pages}</td>
</tr>
...
<tr>
<td colspan="6"><br /><br />{include file="main/subheader.tpl" title=$lng.lbl_root_level class="grey"}</td>
</tr>

{if $root}

<tr>
<td colspan="5"><div style="line-height: 170%;"><a href="javascript:mark_all_r(true);">{$lng.lbl_check_all}</a> / <a href="javascript:mark_all_r(false);">{$lng.lbl_uncheck_all}</a></div></td>
</tr>
...
<tr>
<td align="center" colspan="6">{$lng.txt_no_root_pages}</td>
</tr>

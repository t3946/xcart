...
{if $option ne "User_Profiles" && $option ne "Contact_Us" && $option ne "Search_products" && $option ne "Templates_OrderRelatedMessages" && $option ne "Request_availability_options" && $option ne "Fraud_check" && $option ne "Reconciliation" && $option ne "currently_assigned_to_statuses"}
...
<tr>
        <td colspan = "2">
<br />
The following parameters are allowed to be used both in the subject line and in the message body:<br />
{literal}{{fullname}}{/literal}<br />
{literal}{{orderid}}{/literal} = order number<br />
{literal}{{required}}{/literal} = required shipping charge<br />
{literal}{{additional}}{/literal} = additional shipping charge<br /><br />
        </td>
</tr>
...
<tr>
	...
	<td><textarea style="width: 80%" name="message_body" cols="60" rows="20">{$config.Additional_shipping_charge.message_body}</textarea></td>
</tr>
...
<tr>
        <td colspan = "2">
The following parameters are allowed to be used both in the subject line and in the message body:<br />
{literal}{{c-fullname}}{/literal} = customer's fullname<br />
{literal}{{orderid}}{/literal} = order number<br />
{literal}{{instock}}{/literal} = table of 'in stock' items<br />
{literal}{{outofstock}}{/literal} = table of 'out of stock' items<br /><br />
        </td>
</tr>
...
<table width="100%">
<tr>
        <td class='FormButton' width="30%">Name</td>
...
<tr>
        ...
        <td><textarea style="width: 80%" name="backorder_message_body_condition_no_stock_no_eta" cols="60" rows="20">{$config.backorder_decision_request.backorder_message_body_condition_no_stock_no_eta}</textarea></td>
</tr>
...
<tr>
        <td class='FormButton'></td>
        <td><textarea style="width: 80%" name="backorder_message_body_condition_no_stock_defined_eta" cols="60" rows="20">{$config.backorder_decision_request.backorder_message_body_condition_no_stock_defined_eta}</textarea></td>
</tr>
...
<tr>
        <td class='FormButton'></td>
        <td><textarea style="width: 80%" name="backorder_message_body_condition_partially_in_stock_no_eta" cols="60" rows="20">{$config.backorder_decision_request.backorder_message_body_condition_partially_in_stock_no_eta}</textarea></td>
</tr>
...
<tr>
        <td class='FormButton'></td>
        <td><textarea style="width: 80%" name="backorder_message_body_condition_partially_in_stock_defined_eta" cols="60" rows="20">{$config.backorder_decision_request.backorder_message_body_condition_partially_in_stock_defined_eta}</textarea></td>
</tr>
...
<tr>
        <td colspan = "2">
The following parameters are allowed to be used both in the subject line and in the message body:<br />
{literal}{{mpn}}{/literal} = product mpn<br />
{literal}{{productname}}{/literal} = product name<br />
{literal}{{brand_email}}{/literal} = brands customer service email<br />
{literal}{{brand_phone}}{/literal} = brands customer service phone<br />
{literal}{{customer_phone}}{/literal} = customer contact phone<br />
{literal}{{customer_email}}{/literal} = customer email<br />
{literal}{{product_link}}{/literal} = product link<br />
{literal}{{question}}{/literal} = customers question<br /><br />
        </td>
</tr>
...
<tr>
        ...
        <td><textarea style="width: 80%" name="product_question_message_body_to_brand" cols="60" rows="20">{$config.product_question_email.product_question_message_body_to_brand}</textarea></td>
</tr>

<tr>
        <td class='FormButton'>Message body to customer</td>
        <td><textarea style="width: 80%" name="product_question_message_body_to_customer" cols="60" rows="20">{$config.product_question_email.product_question_message_body_to_customer}</textarea></td>
</tr>

<tr>
        <td class='FormButton'>Email product question to brand</td>
        <td>
<input type="checkbox" name="product_question_send_to_band" {if $config.product_question_email.product_question_send_to_band eq "Y"} checked="checked"{/if} />
	</td>
</tr>

<tr>
        <td class='FormButton'>Email product question to supplier</td>
        <td>
...
{if $configuration[cat_num].name ne "po_sep" && $configuration[cat_num].name ne "sep6"}
<br /><br />
{/if}

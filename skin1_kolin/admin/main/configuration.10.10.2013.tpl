...
<tr>
	<td class='TableSubHead'>Credit card processing fees: </td>
...
{literal}{{additional}}{/literal} = additional shipping charge
        </td>
</tr>

<tr>
        <td class='TableSubHead'>'Copy to' email</td>
        <td class='TableSubHead'><input type="text" style="width: 98%" name="copy_to_email" value="{$config.Additional_shipping_charge.copy_to_email}" /></td>  
</tr>

<tr>
        <td class='TableSubHead'>Subject line</td>
        <td class='TableSubHead'><input type="text" style="width: 98%" name="subject_line" value="{$config.Additional_shipping_charge.subject_line}" /></td>   
</tr>

<tr>
	<td class='TableSubHead'>Message body</td>
	<td class='TableSubHead'><textarea style="width: 98%" name="message_body" cols="71" rows="5">{$config.Additional_shipping_charge.message_body}</textarea></td>
</tr>

...
//]]>
    ...
    {/foreach}
        ...
        <tr><td colspan="2"></td><td align="center"><B>{if $expense_report_sum_total_amount_with_abs gt 0}({$expense_report_sum_total_amount_with_abs|price_format}){else}{$expense_report_sum_total_amount|price_format}{/if}</B></td></tr>
...
<table>
<tr>
<td align="right"><B>Transaction dates</B></td>
<td>
from
<script type="text/javascript" language="JavaScript 1.2">
<!--
...
<tr>
<td align="right"><B>Order dates</B></td>
<td>
from
<script type="text/javascript" language="JavaScript 1.2">
<!--

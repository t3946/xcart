...
<tr>
        <td class='FormButton'>Subject line</td>
        <td><input type="text" style="width: 80%" name="backorder_subject_line" value="{$config.backorder_decision_request.backorder_subject_line}" /></td>
</tr>

<tr>
        <td class='FormButton'>Message body</td>
        <td><textarea style="width: 80%" name="backorder_message_body" cols="60" rows="20">{$config.backorder_decision_request.backorder_message_body}</textarea></td>
</tr>
...
<tr>
        <td class='FormButton'>Message body to brand</td>
...
<tr>
        <td class='FormButton'>Distributor</td>
        <td>
...
<tr>
        <td class='FormButton'>Customer service</td>
        <td>

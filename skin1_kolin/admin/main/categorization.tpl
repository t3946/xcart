...
{if $v.relevant_cats.1.product_count gt 0}<B>{/if}
{/if}
{$vv}{if $kk eq ($v.relevant_cats.1.categoryid_path_arr_count - 1)}{if $v.relevant_cats.1.product_count gt 0}</B>{/if}</a>{/if}{if $kk < ($v.relevant_cats.1.categoryid_path_arr_count - 1)} <B>></B> {/if} {if $v.relevant_cats.1.product_count gt 0 && $kk eq ($v.relevant_cats.1.categoryid_path_arr_count - 1)}({$v.relevant_cats.1.count_pc_products} / {$v.relevant_cats.1.categoryid}){/if}

...
<br />
<a href="classification_log.php?mode=search">Classification log</a><br />
...
<B>Categories containing classified products:</B> {$count_pc_cats_with_pr} / {$count_all_pc_cats}<br />

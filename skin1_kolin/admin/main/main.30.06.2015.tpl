...
<td align="right" valign="top">
 ...
 <td>US$</td>
 <td align="right">{$today_totals.Average_daily_S3_Stores_sales|default:0}</td>
 </tr>

 <tr>
 <td>Average Amazon daily sales</td>
 <td>US$</td>
 <td align="right">{$today_totals.Average_Amazon_daily_sales|default:0}</td>
 </tr>

 <tr>
 <td>Average Amazon FBS daily sales</td>
 <td>US$</td>
 <td align="right">{$today_totals.Average_Amazon_FBS_daily_sales|default:0}</td>
 </tr>

 <tr>
 <td>Average Amazon FBA daily sales</td>
 <td>US$</td>
 <td align="right">{$today_totals.Average_Amazon_FBA_daily_sales|default:0}</td>
 </tr>

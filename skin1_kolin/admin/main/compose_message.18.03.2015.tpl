...
<br />
  ...
  <INPUT type="button" value="Send" onclick="tinyMCE.triggerSave(); document.compose_message_form.submit();" {if $order.amazonorderid ne ""}disabled="disabled" style="border: 1px solid #ff0000" {/if}>

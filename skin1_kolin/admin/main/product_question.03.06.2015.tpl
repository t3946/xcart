...
*}
 ...
 <tr>
 <td>
	{if $product_info.distributor_email ne ""}<input type="radio" name="to" value="{$product_info.distributor_email}" checked="checked">{/if}
 </td>
 <td>
	{if $product_info.distributor_email ne ""}{$product_info.distributor_email}{else}<span style="color: red;">not specified</span>{/if}&nbsp;
 </td>
 <td>
 ...
 <tr>
 <td>
	{if $product_info.brand_email ne ""}<input type="radio" name="to" value="{$product_info.brand_email}" {if $product_info.distributor_email eq ""}checked="checked"{/if}>{/if}
 </td>
 <td>
 	{if $product_info.brand_email ne ""}{$product_info.brand_email}{else}<span style="color: red;">not specified</span>{/if}&nbsp;
 </td>
 <td>

...
<table width="100%" class="filter_preset_edit">
    ...
    <tr>
        <td width="15%" class="preset_bold">StoreFronts:</td>
        <td width="85%">
            <select name="storefronts_filter[]" multiple="multiple" class="select" size="10">
            {foreach from=$storefronts_filter item=status key=k}

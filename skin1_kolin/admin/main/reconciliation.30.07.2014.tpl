...
<td width="50" valign="top" align="center">{if $v.amount_csv_abs ne ""}({$v.amount_csv_abs|price_format}){else}{$v.amount_csv|price_format}{/if}</td>
...
<td width="90" valign="top" align="center">{$v.current_total_gross_accounting_1_2|price_format}</td>
</tr>
{/foreach}
<tr>
<td colspan="5">&nbsp;</td>
<td width="100" valign="top" align="center"><B>{$total_gross_accounting_1_2|price_format}</B></td>
</tr>
</table>
{else}
Empty
...
//]]>
    ...
    {foreach from=$all_manufacturers_orders item=item key=key}
     {if $item.orders ne "" }
        ...
        <td width="100" valign="top" align="center">
                <B><a href="javascript: void(0);" onclick="javascript: func_show_full_orders_info('{$item.manufacturerid}');">{$item.total_gross_accounting_1_2|price_format}</a></B>
        </td>
        </tr>

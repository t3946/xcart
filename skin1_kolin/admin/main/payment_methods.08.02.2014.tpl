...
<tr class="TableHead">
	<td width="13px">&nbsp;</td>
	<td>{$lng.lbl_pos}</td>
	<td width="20%">{$lng.lbl_methods}</td>
	<td width="35%" nowrap="nowrap">{$lng.lbl_special_instructions}</td>
	<td width="5%">{$lng.lbl_protocol}</td>
{if $active_modules.Anti_Fraud}
	<td width="10%" nowrap="nowrap">{$lng.lbl_check}*</td>
{/if}
	<td width="40px">{$lng.lbl_acc_proc}</td>
	<td width="40px">{$lng.lbl_acc_percent}</td>
	<td width="40px">{$lng.lbl_acc_per_trans}</td>
	<td width="40px">{$lng.lbl_percent_ref}</td>
	<td width="40px">{$lng.lbl_per_ref}</td>
</tr>
...
{/if}
	...
	<textarea name="posted_data[{$payment_methods[method].paymentid}][payment_details]" cols="55" rows="3">{$payment_methods[method].payment_details|escape:"html"}</textarea>
	</td>
	<td valign="top">
...
<tr{$trcolor}>
	<td colspan="{if $active_modules.Anti_Fraud}10{else}9{/if}" valign="bottom">
...
<tr>
	<td align="center" colspan="{if $active_modules.Anti_Fraud}11{else}10{/if}" class="SubmitBox"><input type="submit" value="{$lng.lbl_update|strip_tags:false|escape}" /></td>
</tr>

...
{if $tab eq "unreconciled"}
	<td style="background-color: #D9EAD3;" width="10">Clear<br />orders</td>
{/if}
...
{if $tab eq "unreconciled"}
<INPUT type="button" value="Clear orders for selected" onclick="document.r_form.mode.value='clear_orders'; document.r_form.submit();"></TD>
{/if}

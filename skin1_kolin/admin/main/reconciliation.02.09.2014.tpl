...
<td width="90" valign="top" align="center">
  ...
  ($v.orders ne "" &&
	...
	$v.d_bulk_or_individual_order_payments eq "distributor_charges_for_each_order_twice_one_charge_for_products_and_one_charge_for_shipping" && 
		($v.amount_csv_abs|price_format eq $v.orders.0.accounting.1.gross|price_format || $v.amount_csv_abs|price_format eq $v.orders.0.accounting.2.gross|price_format)
	)
    )
  )
  }

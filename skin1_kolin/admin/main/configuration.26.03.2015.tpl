...
{literal}{{question}}{/literal} = customers question<br />
{literal}{{product_answer}}{/literal} = answer<br /><br />
        </td>
</tr>
...
<tr>
        <td class='FormButton'>Subject line to distributor</td>
...
<tr>
        <td class='FormButton'>Message body to distributor</td>

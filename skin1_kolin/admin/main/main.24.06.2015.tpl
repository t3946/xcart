...
<td align="right" valign="top">
 ...
 <td>{include file="currency.tpl" value=$today_totals.Average_daily_S3_Stores_sales|default:0}</td>
 </tr>

 <tr>
 <td>Average Amazon daily sales</td>
 <td>{include file="currency.tpl" value=$today_totals.Average_Amazon_daily_sales|default:0}</td>
 </tr>

 <tr>
 <td>Average Amazon FBS daily sales</td>
 <td>{include file="currency.tpl" value=$today_totals.Average_Amazon_FBS_daily_sales|default:0}</td>
 </tr>

 <tr>
 <td>Average Amazon FBA daily sales</td>
 <td>{include file="currency.tpl" value=$today_totals.Average_Amazon_FBA_daily_sales|default:0}</td>
 </tr>

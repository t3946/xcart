...
<td width="90" valign="top" align="center">{$v.current_total_gross_accounting_0|price_format}</td>
</tr>
{/foreach}
<tr>
<td colspan="5">&nbsp;</td>
<td width="100" valign="top" align="center"><B>{$total_gross_accounting_0|price_format}</B></td>
</tr>
</table>
{else}
Empty
...
//]]>
    ...
    {/foreach}
        ...
        <tr><td colspan="2"></td><td align="center"><B>{$expense_report_sum_total_amount_with_abs|price_format}</B></td></tr>

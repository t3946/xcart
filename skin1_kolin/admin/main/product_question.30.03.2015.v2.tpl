...
<td valign="top" width="48%">
	...
	<table border="0" width="100%" cellpadding="3" cellspacing="1">
        ...
        <td>
<a href="product_modify.php?productid={$product_info.productid}" target="_blank">
...
<div id="question_tabs-container">
  ...
  <div id="question_tabs-answer">
   ...
   <B>{$lng.lbl_to}:</B><br />
   <input type="text" name="to" value="{$product_question.email},{$config.product_question_email.product_question_bc_email}" style="width: 80%;" /><br /><br />
   <B>Subject line:</B><br />
  ...
  <div id="question_tabs-question">
   ...
   <B>{$lng.lbl_to}:</B>
   <select name="to">
	<option value="{$product_info.distributor_email},{$config.product_question_email.product_question_bc_email}">Product distributor contact ({if $product_info.distributor_email ne ""}{$product_info.distributor_email}{else}not specified{/if}),{$config.product_question_email.product_question_bc_email}</option>
	<option value="{$product_info.brand_email},{$config.product_question_email.product_question_bc_email}">Product brand contact ({if $product_info.brand_email}{$product_info.brand_email}{else}not specified{/if}),{$config.product_question_email.product_question_bc_email}</option>
   </select>
   <br /><br />
   <B>Subject line:</B><br />

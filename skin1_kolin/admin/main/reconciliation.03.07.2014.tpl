...
<td width="100" valign="top" align="center">
  ...
  {if $v.orders ne "" || $v.action ne "" || $v.config_search_keyphrase_found eq "Y"}
	...
	<option value="R"{if $v.action eq "R"} selected="selected"{/if}>Reconcile</option>
	{/if}
...
<td colspan="5" valign="top">
 ...
 {if $v.orders ne ""}
  <table width="100%">
   ...
   <tr>
	<td align="center">
	<font style="color: red;">{$diff_amount|price_format}
	</td>
	<td colspan="4"></td>
   </tr>
   {/if}
...
//]]>
        ...
        <table cellpadding="3" cellspacing="1" {* width="100%" *}>
        <tr class="TableHead">
        <td style="background-color: #D9EAD3;" width="100">Expense account code</td>
        <td style="background-color: #D9EAD3;" width="200">Expense account name</td>
        <td style="background-color: #D9EAD3;" width="100">Total Amount</td>
        </tr>
    ...
    {foreach from=$config_reconciliation_search_keyphrases item=item key=key}
     {if $item.found_records ne "" }
        ...
        <td width="200" valign="top">{$item.search_keyphrase}</td>
        <td width="100" valign="top" align="center">

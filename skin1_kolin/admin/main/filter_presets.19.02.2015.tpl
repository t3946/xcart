...
<table width="100%" class="filter_preset_edit">
    ...
    <tr>
        <td width="15%" class="preset_bold">Orders source:</td>
        <td width="85%">
            <select name="orders_source" class="select">
                <option value="any">Any source</option>
                <option value="xcart_orders_only" {if $filter.orders_source eq "xcart_orders_only"}selected="selected"{/if}>XCart orders only</option>
                <option value="amazon_orders_only" {if $filter.orders_source eq "amazon_orders_only"}selected="selected"{/if}>Amazon orders only</option>
            </select>
        </td>
    </tr>
    <tr>

...
<td colspan="3"><B>Product question status:</B>
	{include file="admin/main/product_question_status.tpl" status=$product_question.status mode="select" name="status" extra="" empty="Y"}
</td>
</tr>
...
<td valign="top" width="48%">
	...
	<td>{$product_info.product}</td>
        ...
        <tr>
        <td><B>Product's MPN:</B></td>
        <td>{$product_info.mpn}</td>
        </tr>

        <tr>
        <td><B>Product page:</B></td>
        <td><a href="{$product_info.customer_url}" target="_blank">{$product_info.customer_url}</a></td>
        </tr>

	<tr>
	<td colspan="2">
		<B>Product question:</B>
...
<td valign="top" width="48%">
	...
	{include file="main/subheader.tpl" title="Customer information"}
	...
	<tr><td colspan="2">{include file="main/subheader.tpl" title="Shipping address"}</td></tr>
...
<br />
  ...
  <B>{$lng.lbl_from}:</B><br />
  <input type="text" name="from" value="helpdesk@s3stores.com" readonly="readonly" style="width: 80%;" /><br /><br />
  <B>Subject line:</B><br />
  ...
  <textarea rows="30" cols="60" name="product_answer_message_body" style="width: 80%;" class="new_editor">{$product_info.product_answer_message_body|replace:"\n":"<br />"}</textarea>
  <div align="center">
...
<br />
  ...
  <B>{$lng.lbl_message_body}:</B><br />
  <textarea rows="30" cols="60" name="product_question_message_body_to_distr" style="width: 80%;" class="new_editor">{$product_info.product_question_message_body_to_distr|replace:"\n":"<br />"}</textarea>
  <div align="center">
...
<br />
  ...
  {include file="main/subheader.tpl" title="Generate Queued order"}
  <B>Add Products:</B><br />
  <B>Example:</B> ALV-JKQAW=1;ALV-SRGXVZ=3<br />
  <input type="text" name="add_products" value="" style="width: 99%;" /><br /><br />
  <div align="center">

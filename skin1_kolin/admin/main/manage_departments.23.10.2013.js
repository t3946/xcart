	...
	$('#dep_' + index).after(
		'<tr id="dep_' + row_max_index + '">' +
			'<td style="padding: 2px 0px;">' +
				lbl_department + ':&nbsp;<input type="text" size="45" name="deps[' + row_max_index + '][name]" value="" />&nbsp;&nbsp;&nbsp;' +
				lbl_email + ':&nbsp;<input type="text" size="60" name="deps[' + row_max_index + '][email]" value="" onchange="javascript: checkEmailAddress(this);" />&nbsp;' +

...
<input type="checkbox" name="allow_skip_products" value="Y"{if $pc_options.allow_skip_products eq "Y"} checked="checked"{/if} />
 ...
 <tr>
  <td width="40%">Allow blank 'Google Product Category':</td>
  <td>
<input type="checkbox" name="allow_blank_google_product_category" value="Y"{if $pc_options.allow_blank_google_product_category eq "Y"} checked="checked"{/if} />
  </td>
</tr>

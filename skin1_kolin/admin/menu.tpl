...
<a href="{$catalogs.admin}/categories.php" class="VertMenuItems">{$lng.lbl_categories}{if $active_modules.Multiple_Storefronts} {$lng.lbl_sf}{/if}</a>
{/if}
...
{if !($membership_code eq "ADMIN_CUSTOMER_SERVICE")}
<a href="{$catalogs.admin}/empty_categories.php" class="VertMenuItems">Empty categories{if $active_modules.Multiple_Storefronts} {$lng.lbl_sf}{/if}</a>
{/if}
...
{/if}
{if $active_modules.Simple_Mode eq ""}<a href="{$catalogs.admin}/search.php" class="VertMenuItems">{$lng.lbl_admin_menu_products}{if $active_modules.Multiple_Storefronts} {$lng.lbl_sf}{/if}</a>{/if}
...
{*
{if !($membership_code eq "ADMIN_CUSTOMER_SERVICE")}
<a href="{$catalogs.admin}/product_reports.php" class="VertMenuItems">{$lng.lbl_product_reports}</a>
{/if}
*}
...
{if !($membership_code eq "ADMIN_CUSTOMER_SERVICE" || $membership_code eq "ADMIN_PRODUCT_MANAGER" || $membership_code eq "ADMIN_CUSTOMER_SERVICE_AND_PRODUCT_MANAGER" || $membership_code eq "ADMIN_TRACKING_NUMBER_ENTRY_OPERATOR")}
<a href="{$catalogs.admin}/order_status_notifications.php" class="VertMenuItems">{$lng.lbl_order_status_notifications}</a>
{/if}
...
{if !($membership_code eq "ADMIN_CUSTOMER_SERVICE" || $membership_code eq "ADMIN_PRODUCT_MANAGER" || $membership_code eq "ADMIN_CUSTOMER_SERVICE_AND_PRODUCT_MANAGER" || $membership_code eq "ADMIN_TRACKING_NUMBER_ENTRY_OPERATOR")}
{*
<a href="{$catalogs.admin}/order_statuses.php" class="VertMenuItems">Order statuses</a>
*}

<a href="{$catalogs.admin}/product_question_search.php?mode=search&status=all&from_dashboard=Y" class="VertMenuItems">Product questions</a>
...
{*
<a href="{$catalogs.admin}/google_content_api_test.php" class="VertMenuItems">Google Content API: test</a>
*}
...
<a href="{$catalogs.admin}/bpu.php" class="VertMenuItems">BPU{if $active_modules.Multiple_Storefronts} {$lng.lbl_sf}{/if}</a>
{/if}

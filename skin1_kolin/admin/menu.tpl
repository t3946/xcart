...
{*<a href="{$catalogs.admin}/controllers.php?path=/admin/dashboard" class="VertMenuItems">Customer Care dashboard (&#129309;)</a><br />*}
...
<a href="{$catalogs.admin}/product_question_search.php?mode=search&status=all&from_dashboard=Y" class="VertMenuItems">Product questions</a><br />
...
<a href="{$catalogs.admin}/coupons.php" class="VertMenuItems">{$lng.lbl_coupons}</a><br />
{/if}

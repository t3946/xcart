...
<td>
&nbsp; <a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_view-a-trans&id={$cidev_order_details_TransID}">Link to PayPal transaction</a>
</td>
{/if}
</tr>
</table>

...
{/if}
  ...
  {if $v.full_reconciliation_info ne ""}
    <br />
      Invoice payment in the amount of ({$v.full_reconciliation_info.amount_csv_abs}) taken on {$v.full_reconciliation_info.date_csv|date_format:"%d-%b-%G"}: {$v.full_reconciliation_info.description_csv}
  {/if}
</td>

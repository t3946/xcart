  ...
  for (var i = 0; i < form.elements.length; i++) {
    ...
    if (form.elements[i].type == "text" && (!prefix || form.elements[i].id.search(reg) == 0)){
      ...
      if (first_letter == "R" || first_letter == "r"){
       ...
       if (cb_status != "P" && cb_status != "V" && cb_status != "H" && cb_status != "R" && cb_status != "3"){
          return "N";
       }
      }
    }
...
<tr class="distributor-totals-line">
  <td>
    ...
    <tr>
      ...
      <td align="right"><a target="_blank" onmouseout="javascript: $('#d_specific_instructions_note_{$m_id}').hide();" onmouseover="javascript: cidev_showNote('d_specific_instructions_note_{$m_id}', this);" style="color: green;" href="manufacturers.php?manufacturerid={$m_id}&distributor_section=1">?</a></td>
      {/if}
    </tr>
    </table>

    <div id="d_specific_instructions_note_{$m_id}" class="cidev_NoteBox" style="display: none; width: 600px;">{$v.all_distributor_info.d_specific_instructions}<br /></div>
...
{* --- *}
  ...
  <td align="right" valign="top">{if !$static}<input type="text" size="5" id="items_amount_{$m_id}_{$product.itemid}" name="items[{$product.itemid}][amount]" value="{$product.amount}" />{else}{$product.amount}{/if}</td>
...
<tr{cycle values=", class='TableSubHead'" name="cycle_`$m_id`"}>
  ...
  <td align="right">
    {if !$static}
      ...
      <input id="groups_shipping_cost_net_{$m_id}" type="text" size="8" name="groups[{$m_id}][shipping_cost_net]" value="{$v.shipping_cost.net|price_format}" />
    {else}
...
<tr{cycle values=", class='TableSubHead'" name="cycle_totals"}>
  <td><input type="text" name="edit_additional_fee_name[{$v_f.id}][additional_fee_name]" value="{$v_f.additional_fee_name}" size="16" style="width: 96%;" /></td>
  <td colspan="5">&nbsp;</td>
  <td><input type="text" name="edit_additional_fee_name[{$v_f.id}][additional_fee_value]" value="{$v_f.additional_fee_value}" size="8" /></td>
  <td>&nbsp;</td>
...
<tr class="TableHead">
  <td width="*">additional fee / sales tax name</td>
  <td width="27%">product sku</td>
  <td width="5%">Qty</td>
  <td width="5%"></td>
...
<tr id="add_to_order_tr">
  ...
  <td align="center" id="add_to_order_box_1"><input type="text" name="add_productcode[0]" value="" size="16" style="width: 96%;" /></td>
  <td align="center" id="add_to_order_box_2"><input type="text" name="add_amount[0]" value="" size="5" /></td>
  <td>{include file="buttons/multirow_add.tpl" mark="add_to_order"}</td>
  <td align="center"></td>
  <td align="center"></td>
</tr>

<tr id="add_additional_fee_to_order_tr">
  <td align="center" id="add_additional_fee_to_order_box_0"><input type="text" name="add_additional_fee_name[0]" value="" size="16" style="width: 96%;" /></td>
  ...
  <td align="center" id="add_additional_fee_to_order_box_4"><input type="text" name="add_additional_fee_value[0]" value="" size="5" style="width: 96%;" /></td>
...
&nbsp; <B>Abbreviation: {$customer.s_state}</B>
...
&nbsp; <B>Abbreviation: {$customer.b_state}</B>

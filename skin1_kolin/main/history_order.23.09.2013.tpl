...
{if $v.submit_to_operator eq "Y" && $v.d_order_entry_operator_email ne ""}
{* ------------ *}
<input type="hidden" name="mode" value="cidev_send_email_to_operator" />
Email: {$v.d_order_entry_operator_email}<br />
Customer service instructions to order entry operator:
<br />
...
<tr>
	<td><input type="checkbox" name="mnf_shipping" value="Y" class="margin-checkbox"/></td>
	<td>{$lng.lbl_mnf_send_shipping}</td>
</tr>
<tr>
	<td><input type="checkbox" name="mnf_customer_notes" value="Y" class="margin-checkbox"/></td>
	<td>{$lng.lbl_include_customer_notes}</td>
</tr>
</table>
<br/>

...
<tr>
	<td>
		<div class="b_scroll_div">
			...
			<tr>
                <td class="b_colnames b_has_border">&nbsp;</td>
			...
			{if $new && $changes.new}
				{foreach from=$new item="nproduct"}
					<tr>
                        <td class="b_has_border p_new_style"><a href="#" onclick="bpm_row_click(this); return false;"><div class="bpm_plus"></div></a></td>
						{foreach from=$colnames item="col"}
							<td class="b_has_border p_new_style"{if $col eq 'productcode'} nowrap="nowrap"{/if}><div class="bpm_one_row pink">{if $changes.new[$col]}{$nproduct[$col]}{else}&nbsp;{/if}</div></td>
						{/foreach}
					</tr>
				{/foreach}
			{/if}
			{if $existing && $changes.existing}
				{foreach from=$existing item="eproduct" name="ecolumns"}
					<tr>
                        <td class="b_has_border"><a href="#" onclick="bpm_row_click(this); return false;"><div class="bpm_plus"></div></a></td>
						{foreach from=$colnames item="col"}
						<td class="b_has_border">
                            <div class="bpm_one_row">
			...
			{if $discontinued && ($changes.discontinued.avail neq 'N' || $changes.discontinued.forsale neq 'N' || $changes.discontinued.categoryid neq 'N')}
				{foreach from=$discontinued item="dproduct"}
					<tr>
                        <td class="b_has_border p_discont_style"><a href="#" onclick="bpm_row_click(this); return false;"><div class="bpm_plus"></div></a></td>
						{foreach from=$colnames item="col"}
							<td class="b_has_border p_discont_style"{if $col eq 'productcode'} nowrap="nowrap"{/if}>
                                <div class="bpm_one_row blue">

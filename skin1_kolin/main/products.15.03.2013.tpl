...
<tr{cycle values=', class="TableSubHead"'}>
 ...
 <td><a href="http://{if $products[prod].domain ne ""}{$products[prod].domain}{else}artistsupplysource.com{/if}/{if $current_area eq "A"}admin{else}provider{/if}/product_modify.php?productid={$products[prod].productid}{if $navpage}&page={$navpage}{/if}">{$lng.lbl_products_more}</a></td>

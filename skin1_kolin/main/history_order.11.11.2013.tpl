...
<tr>
        <td width="36%"><B><I>Compose email to customer</I></B></td>
        <td width="36%"><B><I>Compose email to distributor</I></B></td>
        <td width="*"><B><I>Compose email to our customer service</I></B></td>
</tr>
...
{*  <input type="submit" value="Send (Dispatch to distributor)" /><br /><br /> *}
  ...
  <input type="hidden" name="mnf_body" value="" />
  <br /><br />
  <input name="send_email_button" type="button" value="Send (Dispatch to distributor)" onclick="javascript: func_set_value_to_fiel(document.manuf_notifyform_{$mnf_id}, 'dispatch_to_distributor_', 'mnf_body', {$mnf_id});" /><br /><br />
  {* --- *}

...
<tr>
  ...
  <td width="100%">
  {if !$static}<input type="text" name="customer_info[phone]" value="{$customer.phone}" style="width: 30%;" />{else}{$customer.phone}{/if}
...
<tr>
  ...
  <td width="100%">
  {if !$static}<input type="text" name="customer_info[email]" value="{$customer.email}" style="width: 85%;" />{else}{$customer.email}{/if}

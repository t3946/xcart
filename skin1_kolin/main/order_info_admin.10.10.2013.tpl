...
*/
  ...
  <option value="required_shipping_charge" {if $v.shipping_value_selectbox eq "required_shipping_charge"} selected="selected"{/if}>Required shipping charge from our website shiping quote</option>
  </select>
...
{*  {else}
    <span id="cidev_required_shipping_cost_pst_{$m_id}">{include file="currency2.tpl" value=$v.actual_shipping_cost.pst|default:$default_required_shipping_charge hide_zero='Y'}</span>
  {/if}
*}
  </td>

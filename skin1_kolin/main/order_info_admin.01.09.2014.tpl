...
<tr>
  ...
  <td width="100%">
  <input type="text" name="total_shipping_charge_on_orig_po" id="total_shipping_charge_on_orig_po" value="{$order.total_shipping_charge_on_orig_po|escape}" style="width: 20%;" />
  </td>
</tr>
{* --- *}
...
<tr>
  ...
  <tr>
    ...
    <td width="76%"><input style="width: 55%;" type="text" name="name_of_purchaser" id="name_of_purchaser" value="{$order.po_details.name_of_purchaser|escape}" />&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/#q={$order.po_details.name_of_purchaser|replace:' ':'+'}" style="color: #1F08F8;">Google full name</a></td>
  </tr>

  <tr>
    <td width="24%"><b>Phone:</b> </td>
    <td width="76%">
<input type="text" name="purchase_manager_phone" id="purchase_manager_phone" value="{$order.po_details.purchase_manager_phone|escape}" style="width: 29%;" />
  ...
  <tr>
    <td nowrap="nowrap" width="24%"><b>Area code:</b></td>
  ...
  <tr>
    ...
    <td width="76%"><input type="text" name="purchase_manager_email" id="purchase_manager_email" value="{$order.po_details.purchase_manager_email|escape}" /></td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Full Name:</b> </td>
    <td width="76%"><input style="width: 55%;" type="text" name="accounts_payable_full_name" id="accounts_payable_full_name" value="{$order.po_details.accounts_payable_full_name|escape}" />&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/#q={$order.po_details.accounts_payable_full_name|replace:' ':'+'}" style="color: #1F08F8;">Google full name</a></td>
  </tr>

  <tr>
    <td width="24%"><b>Phone:</b> </td>
    <td width="76%">
      <input type="text" name="accounts_payable_phone" id="accounts_payable_phone" value="{$order.po_details.accounts_payable_phone|escape}" style="width: 29%;" />
  ...
  <tr>
    <td width="24%"><b>Fax:</b></td>
    <td width="76%"><input type="text" name="accounts_payable_fax" id="accounts_payable_fax" value="{$order.po_details.accounts_payable_fax|escape}" /></td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Email:</b></td>
    <td width="76%"><input type="text" name="accounts_payable_email" id="accounts_payable_email" value="{$order.po_details.accounts_payable_email|escape}" /></td>
  </tr>

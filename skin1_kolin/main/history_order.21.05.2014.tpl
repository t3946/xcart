 ...
 <table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
   <td width="25%" valign="top">
        ...
        <tr><td><B>Fraud check:</B></td><td><a href="fraud_page.php?orderid={$order.orderid}" target="_blank" style="color: #140BFC">{include file="main/fraud_status.tpl" fraud_status=$order.fraud_status fraud_static="Y"}</a></td></tr>
        </table>
   </td>

...
<tr>
	<td align="center" class="TopLabel">
        <span class="detail-title">{if $product.forsale neq "N"}<a href="{$product.customer_url}" title="" target="_blank">{/if}{$lng.lbl_current_product}: "{$product.product}"{if $product.forsale neq "N"}</a>{/if}</span>
	</td>
</tr>

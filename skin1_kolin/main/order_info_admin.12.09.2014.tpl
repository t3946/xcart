...
<tr>
  ...
  {if !$static}<input type="text" name="customer_info[email]" value="{$customer.email}" style="width: 55%; {if $order.po_details && $customer.email eq 'unknown@unknown.com'}background-color: #F4CCCC;{/if}" />{else}{$customer.email}{/if}
...
<tr>
  ...
  <input style="width: 0%;" type="radio" id="po_issued_to" name="po_issued_to" value="S"{if $order.po_issued_to eq "S"} checked="checked"{/if} />{$po_issued_to_arr.S}
&nbsp;&nbsp;&nbsp;
  <input style="width: 0%;" type="radio" id="po_issued_to" name="po_issued_to" value="A"{if $order.po_issued_to eq "A"} checked="checked"{/if} /><span {if $order.po_issued_to eq 'A'}style="background-color: #F4CCCC;"{/if}>{$po_issued_to_arr.A}</span>
...
<tr>
  ...
  <tr>
    ...
    <td width="76%"><input style="width: 55%; {if $order.po_details.name_of_purchaser eq 'unknown'}background-color: #F4CCCC;{/if}" type="text" name="name_of_purchaser" id="name_of_purchaser" value="{$order.po_details.name_of_purchaser|escape}" />&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/#q={$order.po_details.name_of_purchaser|replace:' ':'+'}" style="color: #1F08F8;">Google full name</a></td>
  </tr>
...
<input type="text" name="purchase_manager_phone" id="purchase_manager_phone" value="{$order.po_details.purchase_manager_phone|escape}" style="width: 29%; {if $order.po_details.purchase_manager_phone eq '(000) 000-0000'}background-color: #F4CCCC;{/if}" />
  ...
  <tr>
    ...
    <td width="76%"><input type="text" name="purchase_manager_email" id="purchase_manager_email" value="{$order.po_details.purchase_manager_email|escape}" style="{if $order.po_details.purchase_manager_email eq 'unknown@unknown.com'}background-color: #F4CCCC;{/if}" /></td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Full Name:</b> </td>
    <td width="76%"><input style="width: 55%; {if $order.po_details.accounts_payable_full_name eq 'unknown'}background-color: #F4CCCC;{/if}" type="text" name="accounts_payable_full_name" id="accounts_payable_full_name" value="{$order.po_details.accounts_payable_full_name|escape}" />&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/#q={$order.po_details.accounts_payable_full_name|replace:' ':'+'}" style="color: #1F08F8;">Google full name</a></td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Email:</b></td>
    <td width="76%"><input type="text" name="accounts_payable_email" id="accounts_payable_email" value="{$order.po_details.accounts_payable_email|escape}" style="{if $order.po_details.accounts_payable_email eq 'unknown@unknown.com'}background-color: #F4CCCC;{/if}" /></td>
  </tr>

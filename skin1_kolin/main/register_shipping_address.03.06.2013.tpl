...
{literal}
	...
	function ltrim(stringToTrim) {
		...
		var countrySelected = cidev_get_country_code(countryname_id);
                ...
                return cidev_new_check_zip_code_field(countrySelected, cidev_id$(zipcode_id));
        }
...
<tr>
<td valign="top" align="right" {if $usertype eq "C"}width="49%" class="cidev_padding_top" {/if}>{$lng.lbl_first_name}
...
<input type="text" id="s_firstname" name="s_firstname" size="32" maxlength="32" value="{$userinfo.s_firstname}" placeholder="{$lng.lbl_fill_in_examples_firstname}" onkeyup="cidev_check_field_name('s_firstname')" />
...
<td valign="top" nowrap="nowrap">
<input type="text" id="s_lastname" name="s_lastname" size="32" maxlength="32" value="{$userinfo.s_lastname}" onkeyup="cidev_check_field_name('s_lastname')" />
...
<td valign="top" nowrap="nowrap">
<input type="text" id="s_countryname" name="s_countryname" size="32" maxlength="64" value="{if $geo_litecity_location.country ne ""}{section name=country_idx loop=$countries}{if $geo_litecity_location.country eq $countries[country_idx].country_code}{$countries[country_idx].country|amp}{/if}{/section}{else}{$userinfo.s_countryname}{/if}" 
onkeyup="cidev_check_field_country('s_countryname'); cidev_check_zip();"  onchange="cidev_check_field_country('s_countryname'); cidev_check_zip();"
...
<td valign="top">{if $default_fields.s_country.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td valign="top" nowrap="nowrap">
<select name="s_country" id="s_country" size="1" onchange="cidev_new_check_zip_code(); {if $usertype ne "P" && $usertype ne "A"} check_zip_code_ship('s_zipcode', 's_countryname'); cidev_set_check_state_field(this.value, 's_state'); {/if}">
{section name=country_idx loop=$countries}
...
<td valign="top" nowrap="nowrap">
<input type="text" id="s_city" name="s_city" size="32" maxlength="64" value="{if $geo_litecity_location.country ne ""}{$geo_litecity_location.city}{else}{$userinfo.s_city}{/if}" {if $usertype ne "P" && $usertype ne "A"} onkeyup="cidev_check_field('s_city'); cidev_check_zip();" {/if} placeholder="{if $geo_litecity_location.city ne ""}{$geo_litecity_location.city}{else}{$lng.lbl_fill_in_examples_city}{/if}" />

...
{foreach from=$v.products item=group_product}

{section name=prod_num loop=$products}
{if $products[prod_num].productid eq $group_product}
...
<tr>
	...
	<td valign="top">{$products[prod_num].original_provider}</td>
</tr>
{/if}

<tr> 
	<td valign="top">{$lng.lbl_price}</td>
	<td valign="top">{include file="currency.tpl" value=$products[prod_num].display_price}</td>
</tr>

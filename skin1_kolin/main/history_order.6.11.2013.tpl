...
<td valign="top" style="font-size: 12px; font-style: italic;">

<a target="_blank" style="color: #140BFC" href="https://mail.google.com/mail/?view=cm&fs=1&to={$customer.email}&su=Regarding your order {$order.order_prefix}{$order.orderid} with S3 Stores, Inc.&body=BODY&cc=custserv@s3stores.com">Compose email to the customer</a>

<br />
<a target="_blank" style="color: #140BFC" href="https://mail.google.com/mail/?view=cm&fs=1&to=custserv@s3stores.com&su=a note regarding order {$order.order_prefix}{$order.orderid}&body=BODY&cc=custserv@s3stores.com">Write a note to our customer service</a>

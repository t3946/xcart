...
<tr class="TableHead">
  ...
  <td width="5%"><a target="_blank" onmouseout="javascript: $('#header_lbl_qty').hide();" onmouseover="javascript: cidev_showNote('header_lbl_qty', this);" href="#" style="text-decoration: none;"><font class="Star">R</font>{$lng.lbl_qty}</a>
  ...
  <td width="7%"><a target="_blank" onmouseout="javascript: $('#header_lbl_net').hide();" onmouseover="javascript: cidev_showNote('header_lbl_net', this);" href="#" style="text-decoration: none;"><font class="Star">R</font>{$lng.lbl_net}</a>
...
<tr class="TableHead">
  <td width="27%">additional fee / sales tax name</td>
  <td width="14%">product sku</td>
  <td width="10%"></td>
  <td width="7%">Qty</td>
  <td width="7%"></td>
  <td width="8%"></td>

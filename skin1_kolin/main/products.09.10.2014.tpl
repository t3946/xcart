...
{if $search_prefilled.show_product_attributes_in_search_results ne "Y"}
...
<tr{cycle values=', class="TableSubHead"'}>
 ...
 <td><a href="http://{if $products[prod].domain ne ""}{$products[prod].domain}{else}artistsupplysource.com{/if}/{if $usertype eq "A"}admin{else}provider{/if}/product_modify.php?productid={$products[prod].productid}{if $navpage}&page={$navpage}{/if}">{$lng.lbl_products_more}</a></td>

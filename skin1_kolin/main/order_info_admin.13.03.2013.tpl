...
<tr class="distributor-totals-line">
  <td>{$v.group_name} {$lng.lbl_items}</td>
  <td>{$v.code}</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
...
<tr{cycle values=", class='TableSubHead'" name="cycle_`$m_id`"}>
  <td><a href="{$product.links.customer}&cat={$cats[$product.productid]}" title="" target="_blank">{$product.product}</a></td>
  <td>
  ...
  <td align="right">{if !$static}<input type="text" size="8" name="items[{$product.itemid}][price]" value="{$product.price|price_format}" />{else}{include file="currency2.tpl" value=$product.price|price_format}{/if}</td>
  <td align="right">{if !$static}<input type="text" size="5" name="items[{$product.itemid}][amount]" value="{$product.amount}" />{else}{$product.amount}{/if}</td>
  <td align="right">{if !$static}<input type="text" size="5" name="items[{$product.itemid}][back]" value="{$product.back}" />{else}{$product.back}{/if}</td>
  <td align="right">{include file="currency2.tpl" value=$product.price*$product.amount}</td>
  ...
  <td align="right">{include file="currency2.tpl" value=$product.display_subtotal}</td>
  ...
  <td colspan="{$colspan}">
    ...
    <tr>
      ...
      <td style="vertical-align: top; padding-right: 10px; padding-bottom: 4px;">
        ...
        {include file="main/order_status.tpl" status=$v.dc_status mode="select" name="groups[`$m_id`][dc_status]" status_type="DC"}
      </td>
      <td style="vertical-align: top; padding-right: 10px; padding-bottom: 4px;">
...
<tr id="track_{$m_id}_tr">
	...
	<option value=""></option>
{foreach from=$tracking_links item=v key=linkid}
	<option value="{$linkid}">{$v.shipping}</option>
{/foreach}
	</select>
	</td>
...
<tr{cycle values=", class='TableSubHead'" name="cycle_totals"}>
  <td>{$lng.lbl_total_product_cost}</td>
  <td colspan="4">&nbsp;</td>
  <td align="right">{include file="currency2.tpl" value=$order.extra.product_total.net}</td>
  ...
  <td align="right">{include file="currency2.tpl" value=$order.display_subtotal}</td>
  <td>&nbsp;</td>
</tr>
...
<tr{cycle values=", class='TableSubHead'" name="cycle_totals"} style="font-weight: bold;">
  <td>{$lng.lbl_grand_total}</td>
  <td colspan="4">&nbsp;</td>
  <td align="right">{include file="currency2.tpl" value=$order.extra.total.net}</td>
  <td align="right">{include file="currency2.tpl" value=$order.extra.total.gst hide_zero='Y'}</td>
  <td align="right">{include file="currency2.tpl" value=$order.extra.total.pst hide_zero='Y'}</td>
  <td align="right">{include file="currency2.tpl" value=$order.total}</td>
  <td>&nbsp;</td>
</tr>
...
<tr>
  ...
  <td width="5%">&nbsp;</td>
  <td width="47%" height="25">{if $order.po_details}<b>{$lng.lbl_po_info}</b>{/if}</td>
</tr>
<tr>
...
<tr>
  ...
  <td width="100%">{if !$static}<input type="text" name="customer_info[phone]" value="{$customer.phone}" />{else}{$customer.phone}{/if}</td>
</tr>
{/if}
...
<tr>
  ...
  <td width="100%">{if !$static}<input type="text" name="customer_info[email]" value="{$customer.email}" />{else}{$customer.email}{/if}</td>
</tr>
{/if}
...
{/foreach}
  ...
  <tr>
    <td width="24%"><b>{$lng.lbl_position}:</b> </td>
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
<tr>
  <td width="47%" height="25"><b>{$lng.lbl_billing_address}</b></td>
  <td width="5%">&nbsp;</td>
  <td width="47%" height="25"><b>{$lng.lbl_shipping_address}</b></td>
</tr>
<tr>
  <td bgcolor="#000000" height="2"><img height="2" src="{$ImagesDir}/spacer_black.gif" width="100%" alt="" /></td>
  <td><img height="2" src="{$ImagesDir}/spacer.gif" width="1" alt="" /></td>
...
{if $customer.default_fields.b_address}
  ...
  <tr>
    <td nowrap="nowrap"><b>{$lng.lbl_address_2}:</b> </td>

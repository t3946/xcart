...
{* {include file="buttons/button.tpl" button_title=$lng.lbl_print_order target="_blank" href="order.php?orderid=`$order.orderid`&mode=printable"} *}
...
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
{* {include file="buttons/button.tpl" button_title=$lng.lbl_create_return href="#returns"} *}
...
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
{* {include file="buttons/button.tpl" button_title=$lng.lbl_order_returns href="returns.php?mode=search&search[orderid]=`$order.orderid`"} *}
...
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
{* {include file="buttons/button.tpl" button_title=$lng.lbl_shipping_label href="generator.php?orderid=`$order.orderid`"} *}
...
{/if}
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
{* {include file="buttons/button.tpl" button_title="Print incorrect invoice" target="_blank" href="order.php?orderid=`$order.orderid`&mode=invoice&action=incorrect"} *}
...
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
{* {include file="buttons/button.tpl" button_title=$lng.lbl_modify href="order.php?orderid=`$order.orderid`&mode=edit"} *}

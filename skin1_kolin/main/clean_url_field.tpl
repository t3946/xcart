...
{$clean_url|escape:"html"}
<input type="hidden" name="clean_url" id="clean_url" value="{$clean_url|escape:"html"}" />

{*
    <div>
      <input type="text" name="clean_url" id="clean_url" size="45" maxlength="250" value="{$clean_url|escape:"html"}" {if $config.SEO.clean_urls_enabled eq "Y"} onchange="javascript: checkCleanUrl(this, 'Y', 'Y');"{else}class="ReadOnlyField" readonly="readonly"{/if} style="width: 100%;" />&nbsp;

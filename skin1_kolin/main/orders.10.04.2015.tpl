...
{else}
	{if $page_name eq "dashboard"}
		{assign var="order_page_title" value="Order dashboard"}
...
<table align="center" width="100%">
 <tr>
 {if $page_name eq "dashboard"}
 <td width="33%" style="font-size: 15px;"><a target="_blank" style="color: #140BFC;{* text-decoration: none;*}" href="orders.php?mode=search&date=7">Most recent orders</a></td>
 {/if}
 ...
 <td align="right" style="font-size: 15px;" width="33%" >
	<a target="_blank" style="color: #140BFC;{* text-decoration: none;*}" href="create_new_inquiry.php">Create new inquiry</a>
 </td>
 {/if}
 </tr>
</table>
...
{/capture}
{include file="dialog.tpl" title="Inquiries dashboard" content=$smarty.capture.dialog extra='width="100%"'}
<br />
...
<a target="_blank" href="product_question_search.php?mode=search&status={$v.status}&from_dashboard=Y">{$product_question_statuses[$v.status]} ({$v.count})</a><br />
{/foreach}
{/if}
  </td>
</tr>

...
<td nowrap="nowrap">
<input type="text" name="b_firstname" id="b_firstname" size="32" maxlength="32" value="{$userinfo.b_firstname}" />
...
<td nowrap="nowrap">
<input type="text" id="b_zipcode" name="b_zipcode" size="32" maxlength="32" value="{$userinfo.b_zipcode}" onchange="if ($('#ship2diff').attr('checked') )check_zip_code(); {if $usertype ne "P" && $usertype ne "A"} check_zip_code_ship_b(); {/if}" {if $usertype ne "P" && $usertype ne "A"} onkeyup="cidev_check_address_b()" {/if} autocomplete="off" />
...
<td nowrap="nowrap">
<input type="text" id="b_city" name="b_city" size="32" maxlength="64" value="{$userinfo.b_city}" onkeyup="cidev_check_zip_b()" />

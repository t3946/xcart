...
{if ($c.productid eq $product.productid && $product.productid ne "") || ($product.productid eq '')}
...
<tr>
	{if $geid ne ''}<td width="15" class="TableSubHead">&nbsp;</td>{/if}
	<td nowrap="nowrap">{$lng.lbl_additional_categories_ids}:</td>
	<td class="ProductDetails">
...
<tr>
        ...
        <td class="ProductDetails"><input type="text" name="discount_slope" size="18" value="{$product.discount_slope|formatprice|default:$zero}" /></td>
</tr>
...
<tr>
        ...
        <td class="ProductDetails"><input type="text" name="discount_table" size="45" class="InputWidth" value="{$product.discount_table|escape}" /></td>
</tr>
...
<tr>
	...
	<input type="button" value=" {$lng.lbl_clone_product|strip_tags:false|escape} " onclick="javascript: document.cloneproductform.submit();" />&nbsp;&nbsp;&nbsp;
	<input type="button" value=" {$lng.lbl_clone_detailed_images|strip_tags:false|escape} " onclick="javascript: document.cloneproductform.clone_detailed.value='Y'; document.cloneproductform.submit();" />
	</span>
	</td>
</tr>

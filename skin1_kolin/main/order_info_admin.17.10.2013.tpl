...
{*  <td width="7%">{$lng.lbl_pst}</td> *}
  ...
  <td width="5%"><img src="{$SkinDir}/images/loupe.png" alt="" width="20" /></td>
</tr>
...
{* --- *}
  ...
  <td>
{assign var="search_productcode" value=`$product.search_productcode`}
<a href='{if $order_manufacturers[$m_id].d_website_search_for_sku_url ne ""}{$order_manufacturers[$m_id].d_website_search_for_sku_url|replace:"---SKU---":"$search_productcode"}{else}{$order_manufacturers[$m_id].url}{/if}' target="_blank"><img src="{$SkinDir}/images/loupe.png" alt="" width="20" /></a>
  </td>
</tr>
{/foreach}
<tr{cycle values=", class='TableSubHead'" name="cycle_`$m_id`"}>
...
<tr id="add_to_order_tr">
  ...
  <td colspan="7">{include file="buttons/multirow_add.tpl" mark="add_to_order"}</td>
</tr>
{/if}

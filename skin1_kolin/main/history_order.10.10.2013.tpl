...
*}
 ...
 {if $show_request_additional_shipping_charge eq "Y"} 
  ...
  <br />
  Estimated profit after additional payment = {if $v.estimated_profit_margin_after_additional_payment_abs ne ""}<span style="color: #FF0000;">({$v.estimated_profit_margin_after_additional_payment_abs})</span>{else}{$v.estimated_profit_margin_after_additional_payment}{/if} = {if $v.estimated_profit_margin_after_additional_payment_percent_abs ne ""}<span style="color: #FF0000;">({$v.estimated_profit_margin_after_additional_payment_percent_abs}%)</span>{else}{$v.estimated_profit_margin_after_additional_payment_percent}%{/if}
  <br /><br />
  <B>{$lng.lbl_from}:</B><br />
  <input type="text" name="mnf_from" value="{$config.Company.orders_department}" readonly="readonly" style="width: 80%;" /><br /><br />
  <B>{$lng.lbl_to}:</B><br />

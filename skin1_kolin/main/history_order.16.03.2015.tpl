 ...
 <table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
   ...
   <td width="*" valign="top">
	...
	{if $order.amazonorderid ne ""}
<a style="color: #1411FF;" href="https://sellercentral.amazon.com/gp/orders-v2/details/ref=ag_orddet_cont_myo?ie=UTF8&orderID={$order.amazonorderid}" target="_blank">Amazon order # {$order.amazonorderid}</a>
	{/if}
   </td>
...
{/if}
  ...
  <td>
   ...
   {if $v.good_time_to_send_email_to_distributor eq "N" && $allowed_elements.send_dispatch_to_distributor_btn ne "N" && 1==2}
...
&nbsp;Requested shipping method: <span style="color: red;">{$order.shipping_groups.$mnf_id.shipping}</span>
  </td>
  </tr>
  </table>
  <br />

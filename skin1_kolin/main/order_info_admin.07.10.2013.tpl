...
<tr{cycle values=", class='TableSubHead'" name="cycle_`$m_id`"} style="BACKGROUND-COLOR: #FFD44C;">
  <td>Actual shipping cost (include drop-ship fee):</td>
  <td colspan="4">
  </td>
  <td align="right">
      <input type="text" size="8" name="groups[{$m_id}][actual_shipping_cost_net]" value="{$v.actual_shipping_cost.net|price_format}" />
  </td>
  <td align="right">{include file="currency2.tpl" value=$v.actual_shipping_cost.gst hide_zero='Y'}</td>
  <td align="right">{include file="currency2.tpl" value=$v.actual_shipping_cost.pst hide_zero='Y'}</td>
  <td align="right">{include file="currency2.tpl" value=$v.actual_shipping_cost.gross}</td>
  <td>&nbsp;</td>
</tr>
{* ----------------------- *}
...
{if $order_manufacturers[$m_id].submit_to_operator eq "Y"}
...
<tr>
  ...
  <td width="100%">
  {if !$static}<input type="text" name="customer_info[email]" value="{$customer.email}" style="width: 60%;" />{else}{$customer.email}{/if}
...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
<tr>
  <td width="47%" height="25"><b>{$lng.lbl_shipping_address}</b> &nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/#q={$google_shipping_address}" style="color: #1F08F8;">Google this address</a></td>
  <td width="5%">&nbsp;</td>
  <td width="47%" height="25"><b>{$lng.lbl_billing_address}</b> &nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/#q={$google_billing_address}" style="color: #1F08F8;">Google this address</a></td>
</tr>
<tr>
  <td bgcolor="#000000" height="2"><img height="2" src="{$ImagesDir}/spacer_black.gif" width="100%" alt="" /></td>
  <td><img height="2" src="{$ImagesDir}/spacer.gif" width="1" alt="" /></td>

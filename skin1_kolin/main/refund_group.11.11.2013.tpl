...
<tr>
  <td colspan="{$colspan}">
    ...
    <input type="hidden" name="ref_notify_do_not_send_email" value="" id="ref_notify_do_not_send_email" />

    <input type="button" value="Update per refund issued" onclick="javascript: $('#ref_notify_do_not_send_email').val('Y'); $('#ordereditform_mode').val('ref_notify'); $('#ordereditform_mid').val('{$mid}'); this.form.submit();" />&nbsp;&nbsp;

    <input type="button" value="Update per refund issued and Send refund notification" onclick="javascript: $('#ordereditform_mode').val('ref_notify'); $('#ordereditform_mid').val('{$mid}'); this.form.submit();" />&nbsp;&nbsp;

...
<tr class="OrderSheetCell">
  ...
  <td style="background-color: #D9EAD3;">{include file="currency2.tpl" value=$data.real_net}</td>
</tr>
<tr class="OrderSheetCell">
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  ...
  <td style="background-color: #D9EAD3;">{include file="currency2.tpl" value=$data.real_pm}%</td>
</tr>
<tr class="OrderSheetCell OrderSheetFirst">
<td colspan="12">&nbsp;</td>
</tr>

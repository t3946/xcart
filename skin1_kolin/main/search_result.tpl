...
<tr>
        <td>
	<input type="checkbox" value='Y' id="show_product_attributes_in_search_results" name="posted_data[show_product_attributes_in_search_results]" {if $search_prefilled.show_product_attributes_in_search_results eq "Y"} checked="checked"{/if} />
	</td>
        <td>&nbsp;</td>
        <td class="FormButton" nowrap="nowrap"><label for="show_product_attributes_in_search_results">Show product attributes in search results</label></td>
</tr>
</table>
        </td>
</tr>
...
<tr>
        <td>
        <input type="checkbox" value='Y' id="show_product_descriptions_and_thumbnails_in_search_results" name="posted_data[show_product_descriptions_and_thumbnails_in_search_results]" {if $search_prefilled.show_product_descriptions_and_thumbnails_in_search_results eq "Y"} checked="checked"{/if} />
        </td>
        <td>&nbsp;</td>
        <td class="FormButton" nowrap="nowrap"><label for="show_product_descriptions_and_thumbnails_in_search_results">Show product descriptions and thumbnails in search results</label></td>
</tr>
</table>
        </td>
</tr>
...
<tr>
	...
	<td height="10"></td> 
	<td height="10">
	<select id="manufacturers" name="posted_data[manufacturers][]" style="width:70%" multiple="multiple" size="{if $smarty.section.mnf.total gt 5}5{else}{$smarty.section.mnf.total}{/if}">
...
<tr>
	...
	<td height="10"></td> 
	<td height="10">
	<select id="brands" name="posted_data[brands][]" style="width:70%" multiple="multiple" size="{if $smarty.section.mnf.total gt 5}5{else}{$smarty.section.mnf.total}{/if}">
...
<tr>
	...
	<td width="10" height="10">&nbsp;</td>
	<td height="10" width="80%">
        <select id="providers" name="posted_data[providers][]" multiple="multiple" size="5">
...
//        new_cloned_row.find("#div_minus_filter_"+i).css("float","left");
...
<input type="hidden" name="froogle_titles" value="{$froogle_titles}" />
...
{if $froogle_titles ne 'Y'}
    {include file="main/products.tpl" products=$products}
{else}
    {include file="main/products_froogle_titles.tpl" products=$products}
{/if}
...
{include file="main/subheader.tpl" title=$lng.lbl_bulk_manage_all_fount_dbsr_products}

<form action="bulk_management.php" method="post" name="bulkform" enctype="multipart/form-data">
<input type="hidden" name="mode" value="compare" />

<div id="close1">
	<a onclick="javascript: visibleBox('1');" href="javascript: void(0);"><b>{$lng.lbl_instructions}</b></a>&nbsp;<a onclick="javascript: visibleBox('1');" href="javascript: void(0);"><img alt="Click to open" src="{$ImagesDir}/plus.gif"></a>
</div>
<div id="open1" style="display: none">
	<a onclick="javascript: visibleBox('1');" href="javascript: void(0);"><b>{$lng.lbl_instructions}</b></a>&nbsp;<a onclick="javascript: visibleBox('1');" href="javascript: void(0);"><img alt="Click to open" src="{$ImagesDir}/minus.gif"></a>
</div>
<div id="box1" style="display: none">
	{$lng.lbl_txt_bulk_manage_text}
</div>
<br />
<div>
	{$lng.lbl_csv_delimiter|cat:":"}&nbsp;
	<select name="bulk_delimiter">
		<option value=",">{$lng.lbl_comma}</option>
		<option value="tab">{$lng.lbl_tab}</option>
		<option value=";">{$lng.lbl_semicolon}</option>
	</select>
	<br />
	{$lng.lbl_select_product_updation}:&nbsp;<input type="file" size="70" name="userfile" />

...
<td nowrap="nowrap">
<input type="text" id="s_zipcode" name="s_zipcode" size="32" maxlength="32" value="{$userinfo.s_zipcode}" {if $usertype ne "P" && $usertype ne "A"} onkeyup="cidev_check_address()" {/if} onchange="check_zip_code(); {if $usertype ne "P" && $usertype ne "A"} check_zip_code_ship(); {/if}" autocomplete="off" />
...
<td nowrap="nowrap">
<input type="text" id="s_city" name="s_city" size="32" maxlength="64" value="{$userinfo.s_city}" onkeyup="cidev_check_zip()" />

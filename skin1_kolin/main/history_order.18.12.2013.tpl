 ...
 <table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
   ...
   <td style="font-size: 12px;" width="25%" valign="top">
    <a target="_blank" style="color: #140BFC" href="https://mail.google.com/mail/u/0/#search/{$order.order_prefix}{$order.orderid}+OR+%22Invoice+ID%3A+{$order.orderid}%22">Gmail communication</a>
   </td>
...
{*  <input type="submit" value="Send (Dispatch to distributor)" /><br /><br /> *}
  ...
  <table>
  <tr>
  {if $v.d_shipping_options_count gt "1" && $v.d_shipping_options_arr ne ""}
  <td>
	<select name="d_shipping_options_name">
{*	<option value="">The least expensive shipping method</option> *}

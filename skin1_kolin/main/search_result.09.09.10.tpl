...
{foreach from=$item item=item_fv_id}
  <tr id="cidev_add_filter_row_{$tmp_filter_id}">
	...
	{/if}
        <div {if $tmp_filter_id eq "0"}style="display: none;"{/if} id="div_minus_filter_{$tmp_filter_id}"><input type="button" value="&nbsp;&nbsp;&#822;" id="minus_filter_{$tmp_filter_id}" onclick="func_minus_filter(this);" /></div>
    </td>
  </tr>

...
<div id="div_post_message2" style="display: none; float: left;">
<input type="button" value="Post to Gmail only" id="post_message2" onclick="javascript: document.ordernotesformnew.submit();" />
</div>

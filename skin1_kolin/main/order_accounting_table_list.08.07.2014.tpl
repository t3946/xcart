...
<tr class="OrderSheetCell{$cycle_class} OrderSheetLast" style="font-weight: bold;">
...
<tr class="OrderSheetCell{$cycle_class}">
  ...
  <td>{if $order.ca_status ne ""}{include file="main/order_status.tpl" status=$order.ca_status mode="static" status_type="CA"}{/if}{*{$order.lastname}*}</td>
  <td></td>
...
<tr class="OrderSheetCell{$cycle_class}{* OrderSheetLast *}">
  ...
  <td><b>{include file="main/order_status.tpl" status=$v.bd_status mode="static" status_type="BD"}</b>{*{$fraud_statuses[$order.fraud_status]} / {if $order.ca_status ne ""}{include file="main/order_status.tpl" status=$order.ca_status mode="static" status_type="CA"}{/if}*}</td>

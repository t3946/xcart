	...
	<td>
        ...
        <td id="td_third_party_department" nowrap="nowrap" style="display: none;">
                ...
                <form name="third_party_form" action="#" method="POST">
                    ...
                    <input type="button" name="Compose" value="Compose" onclick="javascript: window.open('compose_message.php?orderid={$order.orderid}&department=third_party&template_id='+$('#third_party_department').val());">
                </form>
                {/if}
        </td>
</tr>
...
*}
   ...
   <td style="font-size: 12px;" width="33%" valign="top">

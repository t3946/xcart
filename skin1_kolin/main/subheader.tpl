...
<a target="_blank" style="color: blue; font-weight: bold;" href="order.php?orderid={$order.orderid}&mode=printable">{$lng.lbl_print_order}</a>
</td>
...
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
<a target="_blank" style="color: blue; font-weight: bold;" href="#returns">{$lng.lbl_create_return}</a>
</td>
{/if}
{if ($usertype eq 'A' || ($usertype eq 'P' && $active_modules.Simple_Mode)) && $order.is_returns}
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
<a target="_blank" style="color: blue; font-weight: bold;" href="returns.php?mode=search&search[orderid]={$order.orderid}">{$lng.lbl_order_returns}</a>
</td>
{/if}
{/if}
{if $active_modules.Shipping_Label_Generator ne '' && ($usertype eq 'A' || $usertype eq 'P')}
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
<a target="_blank" style="color: blue; font-weight: bold;" href="generator.php?orderid={$order.orderid}">{$lng.lbl_shipping_label}</a>
</td>
{/if}

{if $order.refund_groups ne ""}
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
<a target="_blank" style="color: blue; font-weight: bold;" href="order.php?orderid={$order.orderid}&mode=invoice&action=incorrect">Print incorrect invoice</a>
</td>
{/if}
...
<td class="ButtonsRow" align="right" style="padding-right: 0px; padding-left: 12px;">
<a target="_blank" style="color: blue; font-weight: bold;" href="order.php?orderid={$order.orderid}&mode=edit">{$lng.lbl_modify}</a>
</td>
{/if}
...
{*	<a style="color: blue; font-weight: bold;" href="javascript: void(0);" onclick="javascript: if (confirm('Would you really like to clone this order?')) document.clone_order.submit();">Clone this order</a>*}
	<a style="color: blue; font-weight: bold;" href="javascript: void(0);" onclick="javascript: if (confirm('Would you really like to clone this order?')) window.open('order.php?orderid={$orderid}&mode=clone_order');">Clone this order</a>
</form>
</td>
{/if}

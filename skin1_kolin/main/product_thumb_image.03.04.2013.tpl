...
<tr> 
	...
	<td class="ProductDetails" valign="top" {if !$geid ne ''}colspan="3"{/if}>{* <font class="FormButton">*}<font style="color: #550000">{$config.Appearance.thumbnail_width}x{$config.Appearance.thumbnail_width} pixels thumbnail{*{$lng.lbl_thumbnail}*} </font>  {* <br />{$lng.lbl_thumbnail_msg|replace:"N":$config.Appearance.thumbnail_width} *}</td>
</tr>
<tr>
...
<tr>
        ...
        <td class="ProductDetails" valign="top" {if !$geid ne ''}colspan="2"{/if}>
                {* <font class="FormButton">*}<font style="color: #550000">{$config.Appearance.max_width_prod_img}x{$config.Appearance.max_width_prod_img} pixels thumbnail </font>{* <br /> *}
{*
...
*}
{*		{$lng.lbl_thumbnail_msg|replace:"N":$config.Appearance.max_width_prod_img} *}
        </td>
</tr>
<tr>
...
{include file="dialog.tpl" title="Product thumbnails" content=$smarty.capture.dialog extra='width="100%"'}
{/if}

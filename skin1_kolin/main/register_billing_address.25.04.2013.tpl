...
<tr>
<td colspan="3">{$lng.txt_newbie_registration_bottom_small_billing}</td>
</tr>
...
<td nowrap="nowrap">
<input type="text" id="b_zipcode" name="b_zipcode" size="32" maxlength="32" value="{$userinfo.b_zipcode}" onchange="if ($('#ship2diff').attr('checked') )check_zip_code()" />

...
<tr>
<td colspan="2"></td>
<td align="center"><label for="shippingid{$s.shippingid}"><div class="cidev_checkout_descr">{$lng.lbl_use_my_account_number_under}</div></label></td>
<td></td>
<td align="center"><label for="shippingid{$s.shippingid}"><div class="cidev_checkout_descr">{$lng.lbl_ship_by_shipping_method_under}</div></label></td>
</tr>

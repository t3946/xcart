...
<td><img src="{$ImagesDir}/null.gif" width="5" height="1" alt="" /><br /></td>
<td nowrap="nowrap" align="right"><B>{include file="currency.tpl" value=$tax.tax_cost_no_shipping}</B></td>
...
{if $hidden_manufacturerid ne ""}
<input type="hidden" id="cidev_hidden_deliv_subt_{$hidden_manufacturerid}" name="cidev_hidden_deliv_subt_{$hidden_manufacturerid}" value='{include file="currency.tpl" value=$cidev_hidden_deliv_subt}' />

<input type="hidden" id="cidev_hidden_allow_to_checkout" name="cidev_hidden_allow_to_checkout" value='{$hidden_allow_to_checkout}' />

<input type="hidden" id="cidev_hidden_need_add_more_{$hidden_manufacturerid}" name="cidev_hidden_need_add_more_{$hidden_manufacturerid}" value='{$hidden_need_add_more}' />

<input type="hidden" id="cidev_hidden_display_price_{$hidden_cartid}" name="cidev_hidden_display_price_{$hidden_cartid}" value='{include file="currency.tpl" value=$cidev_hidden_display_price}' />
<input type="hidden" id="cidev_hidden_price_on_amount_{$hidden_cartid}" name="cidev_hidden_price_on_amount_{$hidden_cartid}" value='{include file="currency.tpl" value=$cidev_hidden_price_on_amount}' />

  {if $cidev_hidden_set_new_amount ne ""}
    <input type="hidden" id="cidev_hidden_set_new_amount_{$hidden_cartid}" name="cidev_hidden_set_new_amount_{$hidden_cartid}" value="{$cidev_hidden_set_new_amount}" />
  {/if}
{/if}

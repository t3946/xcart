...
<td class="{if $is_antibot eq 'Y'}FLCDialogCellAntibot{else}FLCDialogCell{/if}" valign="top">
<table border="0" align="center"><tr><td>
{capture name=dialog}

<img src="{$ImagesDir}/spacer.gif" width="1" height="4">
...
{/if}
{if $top_message.reg_error ne '' or $av_error eq 1 or $smarty.get.toreg eq 1}
<script type="text/javascript">
<!--

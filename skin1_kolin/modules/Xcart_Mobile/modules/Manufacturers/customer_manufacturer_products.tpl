{*
$Id: customer_manufacturer_products.tpl 63 2012-10-30 11:56:13Z skot $
...
{if $manufacturer.is_image eq 'Y' or $manufacturer.descr ne '' or $manufacturer.url ne ''}
  {if $manufacturer.is_image eq 'Y'}
    ...
    {/if}
    <img src="{if $manufacturer.image_url ne ''}{$manufacturer.image_url|amp}{else}{$xcart_web_dir}/image.php?id={$manufacturer.manufacturerid}&amp;type=M{/if}" alt="{$manufacturer.manufacturer|escape}" class="mobile-image" />
    {if $manufacturer.url ne ''}
      </a>
    {/if}

{*
$Id: modify_return.tpl 63 2012-10-30 11:56:13Z skot $
vim: set ts=2 sw=2 sts=2 et:
*}
<h1>{$lng.lbl_modify}</h1>
{capture name=dialog}
  <div class="right-box">
    {include file="customer/buttons/button.tpl" button_title=$lng.lbl_returns_list href="returns.php" style="link" target="_top"}
  </div>

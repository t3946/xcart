{*
$Id: add_returns.tpl 63 2012-10-30 11:56:13Z skot $
...
{if $return_products ne '' and not $rma_disable_form}
  {capture name=dialog}
    <form action="order.php" method="post" name="addreturnform">
      ...
      <table cellspacing="1" class="form-table width-100" summary="{$lng.lbl_create_return_request|escape}">
        <tr class="head-row">
        ...
        {foreach from=$return_products item=v name=returns}
          <tr{interline name=returns}>
            <td>
              <label class="rma-product-options-box">

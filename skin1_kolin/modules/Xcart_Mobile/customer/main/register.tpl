...
function check_registerform_fields() {ldelim}
  ...
  {if $usertype ne "P" && $usertype ne "A"}
	...
	if($('#ship2diff').attr('checked')) {ldelim}
...
{* {include file="buttons/submit.tpl" type="input" style="button" href="javascript: return check_registerform_fields();" b="1" button_type="submit"} *}
{*
<input type="submit" value="Submit" />
*}

{include file="customer/buttons/button.tpl" button_title=$lng.lbl_submit type="input" data_theme="b"}

{else}
{*
<input type="submit" value=" {$lng.lbl_save|strip_tags:false|escape} " />
*}
{include file="customer/buttons/button.tpl" button_title=$lng.lbl_save type="input" data_theme="b"}
{/if}


<br />
<font style="color: #000000"><I>{$lng.lbl_continue_checkout_1}</I></font>

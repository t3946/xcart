...
<a href="{$pages_menu[pg].new_link}" class="VertMenuItems" style="font-size: 16px;">{$pages_menu[pg].title}</a>
{else}
{if $smarty.get.pageid ne $pages_menu[pg].pageid}<a href="/pages.php?pageid={$pages_menu[pg].pageid}" class="VertMenuItems" style="font-size: 16px;">{else}<font class="VertMenuItems" style="font-size: 16px;">{/if}{$pages_menu[pg].title}{if $smarty.get.pageid ne $pages_menu[pg].pageid}</a>{else}</font>{/if}
{/if}
<br />

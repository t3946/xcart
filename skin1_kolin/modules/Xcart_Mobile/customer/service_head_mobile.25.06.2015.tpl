...
<link rel="apple-touch-icon-precomposed" href="{$current_location}/touch-icon-iphone-retina.png" />
<link rel="apple-touch-icon" href="{$current_location}/touch-icon-iphone.png" />
<link rel="apple-touch-icon" sizes="72x72" href="{$current_location}/touch-icon-ipad.png" />
<link rel="apple-touch-icon" sizes="114x114" href="{$current_location}/touch-icon-iphone-retina.png" />
<link rel="apple-touch-icon" sizes="144x144" href="{$current_location}/touch-icon-ipad-retina.png" />
{if $canonical_url}

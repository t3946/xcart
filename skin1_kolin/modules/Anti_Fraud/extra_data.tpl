{* $Id: extra_data.tpl,v 1.18.2.1 2006/07/11 08:39:28 svowl Exp $ *}
...
<tr>
	...
	<td>{if $data eq ''}{$lng.txt_not_available}{else}{if $data.total_trust_score > $config.Anti_Fraud.anti_fraud_limit}<font color="#dd0000">{/if}{$data.total_trust_score}{if $data.total_trust_score > $config.Anti_Fraud.anti_fraud_limit}</font>{/if}{/if}</td>
</tr>
<tr>

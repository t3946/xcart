...
<table cellspacing="0" cellpadding="0" width="100%" class="NavDialogBox" style="BORDER: #FFCC33 1px solid;">
 <tr><td colspan="2" class="NavDialogBorder" height="15"><B>Distributor sections:</B></td></tr>
 <tr>
   ...
   {if $distributor_sections ne ""}
	...
	{assign var=cell_counter value=$cell_counter+1}
        <tr>
         ...
         <td class="NavDialogCell"><a href="manufacturers.php?manufacturerid={$manufacturer.manufacturerid}&distributor_section={$item.distributor_section}&page={$page}">{$item.title}</a></td>
	</tr>
...
<tr>
	...
	<td><font class="Star">*</font></td>
	<td width="80%"><input type="text" name="code" size="10" maxlength="5" value="{$manufacturer.code}" style="width:80%"{$disabled} /></td>
</tr>
...
<tr>
        <td width="20%" class="FormButton">{$lng.lbl_catalog_sku}</td>
        <td>&nbsp;</td>
        <td width="80%"><input type="text" size="50" name="catalog_sku" value="{$manufacturer.catalog_sku}" style="width:80%" /></td>
</tr>
...
<td><input type="text" name="distributor_contacts[{$key}][distributor_field_name]" value="{$item.distributor_field_name}" /></td>
<td><input type="text" name="distributor_contacts[{$key}][contact_name]" value="{$item.contact_name}" /></td>
<td><input type="text" name="distributor_contacts[{$key}][email]" value="{$item.email}" /></td>
...
<tr>
        ...
        <td>&nbsp;</td>
        <td width="80%">
<select name="d_preferred_way_submit_orders" id="d_preferred_way_submit_orders">
<option value="through_distributor_website"{if $manufacturer.d_preferred_way_submit_orders eq "through_distributor_website"} selected="selected"{/if}>through distributor website</option>
<option value="by_email_or_and_fax"{if $manufacturer.d_preferred_way_submit_orders eq "by_email_or_and_fax"} selected="selected"{/if}>by email or/and fax</option>
</select>
        </td>
</tr>

<tr><td colspan="3" align="center"><B>Order submission through distributor website</B></td></tr>

<tr>
<td width="20%">URL to login to distributor website</td>
<td>&nbsp;</td>
<td width="80%"><input type="text"  name="d_url_to_login_to_distributor_website" value="{$manufacturer.d_url_to_login_to_distributor_website}" size="50" maxlength="128" style="width: 80%;" /></td>
</tr>

<tr>
<td width="20%">Login/username</td>
<td>&nbsp;</td>
<td width="80%"><input type="text"  name="d_login" value="{$manufacturer.d_login}" size="50" maxlength="128" style="width: 80%;" /></td>
</tr>

<tr>
<td width="20%">Password</td>
<td>&nbsp;</td>
<td width="80%"><input type="text"  name="d_password" value="{$manufacturer.d_password}" size="50" maxlength="128" style="width: 80%;" /></td>
</tr>

<tr>
<td>{$lng.lbl_submit_order_entry_operator}</td>
<td>&nbsp;</td>
<td><input type="checkbox" name="submit_to_operator" value="Y"{if $manufacturer.submit_to_operator eq 'Y'}checked="checked"{/if} 
onclick="javasript:{literal} if (this.checked){$('#tr_d_order_entry_operator_email').show(); $('#tr_d_instructions_to_order_entry_operator').show();}else{$('#tr_d_order_entry_operator_email').hide(); $('#tr_d_instructions_to_order_entry_operator').hide();}{/literal}"
/></td>
</tr>

{*
<tr>
<td>Submit to order entry operator</td>
<td>&nbsp;</td>
<td><input type="checkbox" name="d_submit_to_order_entry_operator" value="Y"{if $manufacturer.d_submit_to_order_entry_operator eq 'Y'}checked="checked"{/if} 
onclick="javasript:{literal} if (this.checked){$('#tr_d_order_entry_operator_email').show(); $('#tr_d_instructions_to_order_entry_operator').show();}else{$('#tr_d_order_entry_operator_email').hide(); $('#tr_d_instructions_to_order_entry_operator').hide();}{/literal}"
/></td>
</tr>
*}

<tr id="tr_d_order_entry_operator_email" {if $manufacturer.submit_to_operator ne 'Y'}style="display: none;"{/if}>
...
<tr id="tr_d_instructions_to_order_entry_operator" {if $manufacturer.submit_to_operator ne 'Y'}style="display: none;"{/if}>
<td width="20%">Instructions to order entry operator</td>
<td>&nbsp;</td>
<td width="80%"><textarea name="d_instructions_to_order_entry_operator" rows="15" cols="60" style="width: 80%;">{$manufacturer.d_instructions_to_order_entry_operator}</textarea></td>
</tr>

<tr><td colspan="3" align="center"><B>Order submission by e-mail or/and fax</B></td></tr>

<tr>
<td width="20%">{$lng.lbl_email}</td>
<td>&nbsp;</td>
<td width="80%"><input type="text"  name="email" value="{$manufacturer.email}" size="50" maxlength="128" style="width: 80%;" /></td>
</tr>
...
<tr>
 ...
 <table>
 <tr>
 <td><input type="checkbox" name="d_shipping_methods_usps" value="Y"{if $manufacturer.d_shipping_methods_usps eq 'Y'} checked="checked"{/if} />USPS</td>
 <td><input type="checkbox" name="d_shipping_methods_ups" value="Y"{if $manufacturer.d_shipping_methods_ups eq 'Y'} checked="checked"{/if} />UPS</td>
 <td><input type="checkbox" name="d_shipping_methods_fedex" value="Y"{if $manufacturer.d_shipping_methods_fedex eq 'Y'} checked="checked"{/if} />FedEx</td>
 <td><input type="checkbox" name="d_shipping_methods_trucking_company" value="Y"{if $manufacturer.d_shipping_methods_trucking_company eq 'Y'} checked="checked"{/if} />Trucking company</td>
 </tr>
 <tr>
 <td>other methods used</td>
 <td colspan="3"><input type="text" size="50" name="d_shipping_methods_other" value="{$manufacturer.d_shipping_methods_other}" style="width:80%" /></td>
 </tr>
 </table>
...
<tr>
        <td width="20%" class="FormButton">Product catalog</td>
        <td>&nbsp;</td>
        <td width="80%"><input type="text" size="50" name="d_product_catalog" value="{$manufacturer.d_product_catalog}" style="width:80%" /></td>
</tr>

<tr>
        <td width="20%" class="FormButton">Distributors website "search for SKU" URL</td>
        <td>&nbsp;</td>
...
<tr>
        <td width="20%" class="FormButton">Price-list</td>
        <td>&nbsp;</td>
        <td width="80%"><input type="text" size="50" name="d_price_list" value="{$manufacturer.d_price_list}" style="width:80%" /></td>
</tr>
...
<tr id="tr_d_map_prices" {if $manufacturer.d_map_policy eq ""}style="display: none;"{/if}>
        <td width="20%" class="FormButton">MAP prices</td>
        <td>&nbsp;</td>
        <td width="80%"><input type="text" size="50" name="d_map_prices" value="{$manufacturer.d_map_prices}" style="width:80%" /></td>
</tr>
...
<tr>
	<td width="20%" class="FormButton">&nbsp;</td>
	<td>&nbsp;</td>
	<td width="80%"><input type="submit" value=" {$lng.lbl_save|strip_tags:false|escape} "{$disabled} /></td>
</tr>
</table>
...
{/capture}
{include file="dialog.tpl" title=$distributor_sections.$distributor_section.title content=$smarty.capture.dialog extra='width="100%"'}

...
<tr id="tr_d_webpage_properties" {if $manufacturer.d_availability_must_be_checked ne 'Y'}style="display: none;"{/if}>
	...
	<tr><td colspan="2" style="color: #000000;"><B>{literal}{{webpagebutton}}{/literal} webpage properties</B></td></tr>
	<tr><td colspan="2" class="SubHeaderBlackLine"><img alt="" class="Spc" src="{$SkinDir}/images/spacer.gif"></td></tr>
	<tr><td colspan="2">&nbsp;</td></tr>

	<tr>
	<td width="21%" class="FormButton">Show header</td>
	<td width="*"><input type="checkbox" name="d_sec14_show_header" value="Y" {if $manufacturer.d_sec14_show_header eq 'Y'} checked="checked"{/if} /></td>
	</tr>

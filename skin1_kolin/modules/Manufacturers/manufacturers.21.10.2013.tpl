...
<a href="manufacturers.php?word=num" style="color: #0101F7;">
...
<tr {if $manufacturer.submit_to_operator eq 'Y'}style="display: none;"{/if} id="order_submission_by_email_or_and_fax1"><td colspan="3" align="center"><B>Order submission by e-mail or/and fax</B></td></tr>

<tr {if $manufacturer.submit_to_operator eq 'Y'}style="display: none;"{/if} id="order_submission_by_email_or_and_fax2">
<td width="20%">{* {$lng.lbl_email} *} Distributor email</td>
<td>&nbsp;</td>
<td width="80%"><input type="text"  name="email" value="{$manufacturer.email}" size="50" maxlength="128" style="width: 80%;" /></td>
</tr>

<tr {if $manufacturer.submit_to_operator eq 'Y'}style="display: none;"{/if} id="order_submission_by_email_or_and_fax3">
        <td colspan="3">{$lng.txt_distributor_section_8}</td>
</tr>

<tr {if $manufacturer.submit_to_operator eq 'Y'}style="display: none;"{/if} id="order_submission_by_email_or_and_fax4">
...
<tr>
        ...
        <td>&nbsp;</td>
        <td width="80%"><input type="text" size="50" name="d_website_search_for_sku_url" value="{$manufacturer.d_website_search_for_sku_url}" style="width:40%" /></td>
</tr>
...
onclick="javasript:{literal} if (this.checked){$('#tr_d_send_to_email_14').show(); $('#tr_d_message_body_14').show(); $('#tr_d_email_subject_14').show(); $('#tr_info_14').show();}else{$('#tr_d_send_to_email_14').hide(); $('#tr_d_message_body_14').hide(); $('#tr_d_email_subject_14').hide(); $('#tr_info_14').hide();}{/literal}"
/>
	</td>
</tr>
...
<tr id="tr_d_message_body_14" {if $manufacturer.d_availability_must_be_checked ne 'Y'}style="display: none;"{/if}>
	...
	<td>&nbsp;</td>
	<td><textarea name="d_message_body_14" rows="20" cols="60" style="width:80%">{$manufacturer.d_message_body_14|default:$lng.txt_distributor_section_14_email_body}</textarea></td>
</tr>
</table>
...
<td colspan="3" align="center">
	...
	<td ><input type="button" value=" Add new line " onclick="javascript: {literal}$('#mode').val('add_new_line'); document.manufacturer.submit();"{/literal} /></td>
	{/if}

...
{if $smarty.get.distributor_section ne "19"}
...
{elseif $d_section.distributor_section eq "19"}
...
<tr>
        <td colspan="3" class="FormButton">Supplier products quantity behavior</td>
</tr>

<tr>
	<td colspan="3" class="FormButton"><input type="radio" name="products_quantity_behavior" value="R"{if $manufacturer.products_quantity_behavior eq "R"} checked="checked"{/if} /> use real quantity on storefront
	</td>
</tr>
        <td colspan="3" class="FormButton"><input type="radio" name="products_quantity_behavior" value="D"{if $manufacturer.products_quantity_behavior eq "D"} checked="checked"{/if} /> use display quantity of

        <input type="text" size="5" name="display_quantity_of" value="{$manufacturer.display_quantity_of}" /> if product in stock</td>
</tr>

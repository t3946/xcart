...
<tr>
        ...
        <td>&nbsp;</td>
        <td width="80%"><input readonly="readonly" type="text" size="50" name="d_most_recent_feed_updation_date" value="{$manufacturer.d_most_recent_feed_updation_date}" style="width:80%" /></td>
</tr>

...
<tr id="tr_d_send_to_email_14" {if $manufacturer.d_availability_must_be_checked ne 'Y'}style="display: none;"{/if}>
        ...
        <td>&nbsp;</td>
        <td width="80%" class="FormButton"><input type="text" name="d_send_to_email_14" value="{$manufacturer.d_send_to_email_14|default:'essv50@gmail.com'}" style="width:40%" /></td>
</tr>
...
<tr id="tr_d_email_subject_14" {if $manufacturer.d_availability_must_be_checked ne 'Y'}style="display: none;"{/if}>
        ...
        <td>&nbsp;</td>
        <td width="80%" class="FormButton"><input type="text" name="d_email_subject_14" value="{$manufacturer.d_email_subject_14}" style="width:40%" /></td>
</tr>

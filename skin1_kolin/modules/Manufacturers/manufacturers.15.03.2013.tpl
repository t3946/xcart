...
<tr>
	<td width="20%" class="FormButton">{$lng.lbl_distributor_code}:</td>
	<td><font class="Star">*</font></td>
...
<tr>
	<td class="FormButton">{$lng.lbl_cost_to_us}&nbsp;=</td>
	<td>&nbsp;</td>
	<td><input type="text" size="9" name="cost_to_us_coef_x" value="{$manufacturer.cost_to_us_coef_x}" />&nbsp;*&nbsp;{$lng.lbl_list_price}</td>
</tr>
...
{* ----------------------- *}
<tr>
        <td class="FormButton">{$lng.lbl_map_price}&nbsp;=</td>
        <td>&nbsp;</td>
...
<tr>
	<td class="FormButton">{$lng.lbl_catalog_sku}:</td>
	<td>&nbsp;</td>
	<td><input type="text" size="50" name="catalog_sku" value="{$manufacturer.catalog_sku}" style="width:80%" /></td>
</tr>
...
<tr>
<td class="FormButton">{$lng.lbl_cart_manufact_text_displayed}:</td>
<td>&nbsp;</td>
<td><textarea name="cart_manufact_text_displayed" rows="5" cols="60">{$manufacturer.cart_manufact_text_displayed}</textarea></td>
</tr>


<tr>
<td class="FormButton">{$lng.lbl_manufact_text_displayed}:</td>
<td>&nbsp;</td>
<td><textarea name="manufact_text_displayed" rows="5" cols="60">{$manufacturer.manufact_text_displayed}</textarea></td>
</tr>
...
{* --------------------- *}
  ...
  {include file="modules/Manufacturers/shipping_address.tpl"}

{if $administrate eq "Y"}
<tr>
	<td class="FormButton">{$lng.lbl_orderby}:</td>
	<td>&nbsp;</td>
	<td><input type="text" name="orderby" size="5" value="{$manufacturer.orderby|default:"10"}" /></td>
</tr>

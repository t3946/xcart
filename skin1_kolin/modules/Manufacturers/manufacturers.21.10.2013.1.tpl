...
<tr>
        <td width="20%" class="FormButton">Link to product on distributor's websit (use {literal}{{mpn}}{/literal})</td>
        <td>&nbsp;</td>
...
<tr>
        <td width="20%" class="FormButton">Link to order on distributor's websit (use {literal}{{orderid}}{/literal})</td>
        <td>&nbsp;</td>

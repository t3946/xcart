...
//<![CDATA[
var txt_delete_new_list_text = "{$lng.txt_delete_new_list_text|escape:javascript}";
//]]>
</script>
...
<td>{include file="main/language_selector.tpl" script="mailchimp_news.php?"}</td>
</tr>
</table>

{/if}

<form action="mailchimp_news.php" method="post" name="selectlistsform">
...
<tr class="TableHead">
  <td width="15">&nbsp;</td>
  <td width="50%">{$lng.lbl_list_name}</td>
  <td width="50" align="center">{$lng.lbl_active}</td>
  <td width="40%" align="center">Storefront</td>
</tr>
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td><b><a href="mailchimp_news.php?mode=modify&amp;targetlist={$lists[idx].listid}" title="Click for details">{$lists[idx].name}</a></b></td>
  ...
  <td align="center">{$lists[idx].storefrontid}</td>  
</tr>

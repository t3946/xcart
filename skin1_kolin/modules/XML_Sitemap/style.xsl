...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template name="siteindexTable">
    <h3>This sitemap index file was created by <a href="http://x-cart.com/">'X-SEO: XML Sitemap' generator</a>.</h3>          
  ...
  <xsl:template name="sitemapTable">
    <h3>This sitemap file was created by <a href="http://x-cart.com/">'X-SEO: XML Sitemap' generator</a>.</h3>          

{* $Id: ups_access_license_2.tpl,v 1.9 2006/02/01 14:26:44 max Exp $ *}
{capture name=dialog}
...
<tr>
	...
	<td>&nbsp;</td>
	<td width="100%">
<iframe src="ups.php?mode=showlicense&amp;raw=1" width="100%" height="400" scrolling="auto" frameborder="1" align="center" name="license"></iframe>
...
<tr>
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_print style="button" href="ups.php?mode=showlicense" target="printable"}</td>
	<td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_next style="button" href="javascript: document.upsstep2form.submit();"}</td>
	<td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>

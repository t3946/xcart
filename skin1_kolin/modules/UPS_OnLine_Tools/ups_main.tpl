{* $Id: ups_main.tpl,v 1.8 2006/02/01 14:26:44 max Exp $ *}
{capture name=dialog}
...
<tr>
{if $have_account ne ""}
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_configure style="button" href="ups.php?mode=rss"}</td>
	<td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>
{/if}
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_register style="button" href="javascript: document.upsstep0form.submit()"}</td>
	<td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>
</tr>

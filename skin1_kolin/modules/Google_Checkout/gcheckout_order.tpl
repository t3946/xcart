{* $Id: gcheckout_order.tpl,v 1.1.2.8 2007/01/17 07:14:40 svowl Exp $ *}
{capture name=dialog}
...
{math equation="x-y" x=$order.gcheckout_data.total y=$order.gcheckout_data.refunded_amount assign="order_total_cost"}

<b>{$lng.lbl_gcheckout_order}: #{$order.gcheckout_data.goid}</b><br />
{$lng.lbl_total_amount}: {include file="currency.tpl" value=$order_total_cost}
...
<b>{$order.gcheckout_data.linked_orders[oids].order_prefix}{$order.gcheckout_data.linked_orders[oids].orderid} ({include file="currency.tpl" value=$order.gcheckout_data.linked_orders[oids].total})</b>
{else}
<a href="order.php?orderid={$order.gcheckout_data.linked_orders[oids].orderid}">{$order.gcheckout_data.linked_orders[oids].order_prefix}{$order.gcheckout_data.linked_orders[oids].orderid} ({include file="currency.tpl" value=$order.gcheckout_data.linked_orders[oids].total})</a>
{/if}
...
{$lng.lbl_refunded_amount}: {include file="currency.tpl" value=$order.gcheckout_data.refunded_amount}
<br />
({$lng.lbl_initial_total_cost}: {include file="currency.tpl" value=$order.gcheckout_data.total})
<br />
{/if}
...
{include file="currency.tpl" value=$order.gcheckout_data.total plain_text_message='Y'}
{/capture}

<input type="button" value="{$lng.lbl_gcheckout_charge_order}: {$smarty.capture.currency|escape}" onclick="javascript: document.gcheckoutform.gcmode.value='charge'; document.gcheckoutform.submit();" style="FONT-SIZE: 11px; FONT-WEIGHT: bold;" />
<br />
<br />
<br />
{/if}
...
<tr>
	...
	<td><input type="text" name="refund_amount" size="10" maxlength="15" value="{$order_total_cost}" /></td>
</tr>
<tr>
...
<tr>
	<td>&nbsp;</td>
	<td><input type="button" value="{$lng.lbl_gcheckout_refund_order}" onclick="javascript: document.gcheckoutform.gcmode.value='refund'; document.gcheckoutform.submit();" /></td>
</tr>
...
<tr>
	<td>&nbsp;</td>
	<td><input type="button" value="{$lng.lbl_gcheckout_cancel_order}" onclick="javascript: document.gcheckoutform.gcmode.value='cancel'; document.gcheckoutform.submit();" /></td>
</tr>
...
<input type="button" value="{$lng.lbl_gcheckout_process_order}" onclick="javascript: document.gcheckoutform.gcmode.value='process'; document.gcheckoutform.submit();" />
<br />
<br />
<br />
{/if}
...
<input type="button" value="{$lng.lbl_gcheckout_add_tracking_data}"{if $order.tracking eq ""} disabled="disabled"{/if} onclick="javascript: document.gcheckoutform.gcmode.value='add_tracking'; document.gcheckoutform.submit();" />
...
<input type="button" value="{$lng.lbl_gcheckout_deliver_order}"{if $order.gcheckout_data.fulfillment_state eq "DELIVERED"} disabled="disabled"{/if} onclick="javascript: document.gcheckoutform.gcmode.value='deliver'; document.gcheckoutform.submit();" />
<br />
...
<input type="button" value="{$lng.lbl_gcheckout_send_message}" onclick="javascript: document.gcheckoutform.gcmode.value='send_message'; document.gcheckoutform.submit();" />
...
<input type="button" value="{$lng.lbl_gcheckout_archive_order}" onclick="javascript: document.gcheckoutform.gcmode.value='archive'; document.gcheckoutform.submit();" />
{else}
<input type="button" value="{$lng.lbl_gcheckout_unarchive_order}" onclick="javascript: document.gcheckoutform.gcmode.value='unarchive'; document.gcheckoutform.submit();" />
{/if}

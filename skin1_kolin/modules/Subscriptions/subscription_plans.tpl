{* $Id: subscription_plans.tpl,v 1.15.2.2 2006/07/11 08:39:34 svowl Exp $ *}
...
{/foreach}
	...
	<td valign="top" class="DataTable"><input type="text" name="subscription[price_period]" value="{$subscription.price_period}" size="15" style="width:100%" /></td>
	<td valign="top" class="DataTable"><input type="text" name="subscription[oneday_price]" value="{$subscription.oneday_price}" size="15" style="width:100%" /></td>
...
<tr>
	{if $geid ne ''}<td width="15" class="TableSubHead">&nbsp;</td>{/if}
	<td nowrap="nowrap"><input type="text" name="pay_period" size="12" value="{$pay_period}"{if $subscription.pay_period_type ne "By Period"} disabled="disabled"{/if} style="width:80%" />&nbsp;{$lng.lbl_days}</td>
	<td colspan="3">&nbsp;</td>
</tr>

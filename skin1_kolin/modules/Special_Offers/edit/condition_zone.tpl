{* $Id: condition_zone.tpl,v 1.9.2.2 2006/07/11 08:39:34 svowl Exp $ *}
...
<input type="button" value="{$lng.lbl_delete_selected|strip_tags:false|escape}" onclick="javascript: document.wizardform.action.value='delete';document.wizardform.submit();" />
&nbsp;&nbsp;&nbsp;&nbsp;

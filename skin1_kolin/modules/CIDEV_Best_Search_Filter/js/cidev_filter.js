...
function func_cidev_fv_checkbox_is_clicked(cidev_number_active_fv, fv_id){

        var full_id_value = "cidev_id_fv_" + cidev_number_active_fv;
        ...
        if (className == "cidev_checkbox"){
                ...
                cidev_id$('cidev_fv_' + cidev_number_active_fv).value = fv_id;
                ...
                cidev_id$('cidev_fv_' + cidev_number_active_fv).value = "";
        }
                ...
                cidev_xmlHttp.onreadystatechange=function(){
                        if(cidev_xmlHttp.readyState==4){
                                if(cidev_xmlHttp.status==200){
                                        cidev_id$("cidev_narrowed_result").innerHTML=cidev_xmlHttp.responseText;
		...
		if (cidev_id$('cidev_selected_manuf_str')){
			...
			cidev_parameters += '&cidev_selected_manuf_str=' + cidev_selected_manuf_str;
                ...
                cidev_xmlHttp.onreadystatechange=function(){
                        if(cidev_xmlHttp.readyState==4){
                                if(cidev_xmlHttp.status==200){
                                        cidev_id$("cidev_filter_menu").innerHTML=cidev_xmlHttp.responseText;
...
function func_cidev_recalc_total_items(){
    ...
    if (cidev_id$("cidev_recalc_total_items")){
        ...
        if (cidev_xmlHttp.readyState==4 || cidev_xmlHttp.readyState==0){
                ...
                cidev_xmlHttp.onreadystatechange=function(){
                        if(cidev_xmlHttp.readyState==4){
                                if(cidev_xmlHttp.status==200){
                                        cidev_id$("cidev_recalc_total_items").innerHTML=cidev_xmlHttp.responseText;

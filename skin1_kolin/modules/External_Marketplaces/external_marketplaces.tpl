                                ...
                                <tr data-marketplace-id="{$oMarketPlace->getMarketPlaceId()}">
                                    <td align="center">
                                        <select autocomplete="off" class="external_storefront_storefrontid"  style="width:98%;" name="external_storefront_marketplace[{$oMarketPlace->getMarketPlaceId()}][0][storefront_id]">
                                            <option value=""></option>
                                            {html_options options=$external_storefronts->getStoreFrontsSelect()}
                                        </select>
                                    </td>
                                    <td align="center">
...
{literal}
    <script>
        ...
        function setRowMarketplaceAndStorefront(change_row, marketplace_id, storefront_id){
            ...
            $('.external_storefront_update_expired_before', change_row).attr('name',"external_storefront_marketplace["+marketplace_id+"]["+storefront_id+"][external_storefront_update_expired_before]");
            $('.external_storefront_update_max_expired_products', change_row).attr('name',"external_storefront_marketplace["+marketplace_id+"]["+storefront_id+"][external_storefront_update_max_expired_products]");

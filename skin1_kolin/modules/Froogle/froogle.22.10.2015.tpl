...
<br />
MerchantID: <input type="text" name="MerchantID" value="{$froogle_options.MerchantID}" /><br />
ClientID: <input type="text" name="ClientID" value="{$froogle_options.ClientID}" />
<br />

...
<td colspan="6">
<br />
{include file="main/subheader.tpl" title="Add product file(s)"}
...
<input type="radio" name="additional_operation[1]" value="gt" id="additional_operation_gt_1" />Generate thumbnail
<input type="radio" name="additional_operation[1]" value="gt_del_img" id="additional_operation_gt_del_img_1" />Generate thumbnail & Delete this image

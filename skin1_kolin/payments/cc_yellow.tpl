{* $Id: cc_yellow.tpl,v 1.7.2.3 2006/07/17 11:15:52 max Exp $ *}
<h3>YellowPay</h3>
{$lng.txt_cc_configure_top_text}
<p />
{$lng.txt_cc_yellow_note|substitute:"http_location":$http_location}
<p />
{capture name=dialog}
...
<tr>
<td>{$lng.lbl_yellow_id}:</td>
<td><input type="text" name="param01" size="32" value="{$module_data.param01|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_yellow_url}:</td>
<td><input type="text" name="param02" size="32" value="{$module_data.param02|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_yellow_language}:</td>
<td>
<select name="param04">
<option value="2057"{if $module_data.param04 eq "2057"} selected="selected"{/if}>English
<option value="2055"{if $module_data.param04 eq "2055"} selected="selected"{/if}>German 
<option value="4108"{if $module_data.param04 eq "4108"} selected="selected"{/if}>French
<option value="2064"{if $module_data.param04 eq "2064"} selected="selected"{/if}>Italian
</select>
</td>
</tr>

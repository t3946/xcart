{* $Id: cc_multicard.tpl,v 1.6.2.2 2006/07/11 08:39:36 svowl Exp $ *}
<h3>MultiCards</h3>
{$lng.txt_cc_configure_top_text}
<p />
{$lng.txt_cc_multicard_note|substitute:"http_location":$http_location}
<p />
{capture name=dialog}
...
<tr>
<td>{$lng.lbl_cc_multicard_merchantid}:</td>
<td><input type="text" name="param01" size="32" value="{$module_data.param01|escape}" /></td>
</tr>

<tr>
<td>{$lng.lbl_cc_multicard_pageid}:</td>
<td><input type="text" name="param02" size="32" value="{$module_data.param02|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_cc_multicard_language}:</td>
<td><select name="param03">
<option value=""{if $module_data.param03 eq ""} selected="selected"{/if}>English</option>

{* $Id: cc_authorizenet_sim.tpl,v 1.9.2.2 2006/07/11 08:39:36 svowl Exp $ *}
<h3>Authorize.Net: SIM</h3>
...
<tr>
<td>{$lng.lbl_asim_timezone_offset_in_hours}:</td>
<td><input type="text" name="param06" size="3" maxlength="3" value="{$module_data.param06|escape}" /><br />
{$lng.lbl_asim_value_according_server}: {$timezone_offset}</td>
</tr>

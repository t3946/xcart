...
$(function(){
 document.onkeydown = function(e) {
        if (e.keyCode == "17"){
			...
			$('#s3_logo').attr('onclick', '');
			$('#s3_logo').attr('onclick', "window.open('/popup_shipquote.php?short=Y','popup_shipquote','width=800,height=600,toolbar=no,status=no,scrollbars=yes,menubar=no,location=no,direction=no');");
                }
        }
 }
...
{if $main eq "fast_lane_checkout" || $main eq "order_message"}
        <td width="*" valign="middle" align="center">
	        <img id="s3_logo" src="{$ImagesDir}/S3-Stores-Logo-S2.png" alt="" />
        </td>

...
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain}{else}www.artistsupplysource.com{/if}/product.php?productid={$product.productid}"/>
{/if}
{elseif $main eq "catalog" && $current_category.categoryid gt 0}
{if $smarty.get.page eq "" || $smarty.get.page eq "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain}{else}www.artistsupplysource.com{/if}/home.php?cat={$current_category.categoryid}"/>
{/if}
{elseif $smarty.get.page gt "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain}{else}www.artistsupplysource.com{/if}/home.php?cat={$current_category.categoryid}&page={$smarty.get.page}"/>
{/if}
{/if}
{elseif $main eq "brand_products" && $brandid gt 0}
{if $smarty.get.page eq "" || $smarty.get.page eq "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain}{else}www.artistsupplysource.com{/if}/brands.php?brandid={$brandid}"/>
{/if}
{elseif $smarty.get.page gt "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain}{else}www.artistsupplysource.com{/if}/brands.php?brandid={$brandid}&page={$smarty.get.page}"/>
{/if}
{/if}
...
{* ------------------- *}
{if $cidev_tracking_code_modified ne ""}
{$cidev_tracking_code_modified}
{else}
{$config.Company.cidev_tracking_code|replace:"var cidev_tracking_code_add;":$cidev_tracking_code_add|replace:"var cidev_tracking_code_add2;":$cidev_tracking_code_add2}
{/if}
{* ------------------- *}

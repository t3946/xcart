...
*}
            <div class="nav-searchfield-width">
              <div id="nav-iss-attach">
                <input type="text" autocomplete="off" name="e_posted_data[substring]" value="{if $e_search_data.substring ne ""}{$e_search_data.substring|stripslashes|escape}{else}{* {$e_search_data_previous_substring} *}{/if}" title="Search For" id="twotabsearchtextbox" placeholder="{$config.Company.cidev_header_code}" />
              </div>
            </div>
...
{$e_search_data.total} {if $e_search_data.total eq "1"}product{else}products{/if} found for "{$e_search_data.substring}"

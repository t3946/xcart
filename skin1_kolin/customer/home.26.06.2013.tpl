...
{* --- *}
{if $main eq "product" && $product.productid ne ""}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain|lower}{else}www.artistsupplysource.com{/if}/product.php?productid={$product.productid}"/>
{/if}
{elseif $main eq "catalog" && $current_category.categoryid gt 0}
{if $smarty.get.page eq "" || $smarty.get.page eq "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain|lower}{else}www.artistsupplysource.com{/if}/home.php?cat={$current_category.categoryid}"/>
{/if}
{elseif $smarty.get.page gt "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain|lower}{else}www.artistsupplysource.com{/if}/home.php?cat={$current_category.categoryid}&page={$smarty.get.page}"/>
{/if}
{/if}
{elseif $main eq "brand_products" && $brandid gt 0}
{if $smarty.get.page eq "" || $smarty.get.page eq "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain|lower}{else}www.artistsupplysource.com{/if}/brands.php?brandid={$brandid}"/>
{/if}
{elseif $smarty.get.page gt "1"}
{if $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain|lower}{else}www.artistsupplysource.com{/if}/brands.php?brandid={$brandid}&page={$smarty.get.page}"/>
{/if}
{/if}
{elseif $main eq "catalog" && $current_category.category eq "" && $canonical_page eq "Y"}
<link rel="canonical" href="http://{if $cidev_store_domain ne ""}{$cidev_store_domain|lower}{else}www.artistsupplysource.com{/if}/"/>
{/if}
{* --- *}
...
<tr>
<td {* bgcolor="#fbfbf3" *} bgcolor="#ffffff" colspan=3 {* style="padding-left: 10px; padding-right: 10px;" *} >
...
{/if}
{if $active_modules.Multiple_Storefronts ne "" and $sf_links ne '' and $main ne "sitemap_customer"}
...
{if $main eq "catalog" || $main eq "product" || $main eq "brand_products" || $main eq "cart" || $main eq "pages" }

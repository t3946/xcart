...
<tr {if $minicart_total_items gt 0}onclick="javascript: self.location='/cart.php';" style="cursor: pointer;"{/if}>
	...
	{if $minicart_total_items gt 0}
        <td class="cidev_minicart_r"><a href="/cart.php"><img src="{$ImagesDir}/spacer.gif" width="1" height="1" alt="View Cart" /></a></td>
	{else}

...
{if $smarty.get.cat ne "" || $smarty.get.path ne "" || $smarty.get.page ne ""}
...
{if $smarty.get.path ne "" || $smarty.get.sort ne "" || $smarty.get.sort_direction ne "" || $smarty.get.page eq "1"}
...
{if $smarty.get.path ne "" || $smarty.get.sort ne "" || $smarty.get.sort_direction ne ""}
...
<div class="bottom-block" style="margin: 20px 10px 0px 10px; padding: 8px;">{include file="modules/Brands/menu_brands_footer.tpl"}</div>
{/if}

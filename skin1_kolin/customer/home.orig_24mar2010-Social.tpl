...
new TWTR.Widget({ldelim}
  ...
  features: {ldelim}
    ...
    behavior: 'all'
  {rdelim}
{rdelim}).render().setUser('ArtistSupply').start();
</script>
{* END. Twitter code *}
{* Youtube and Facebook code *}
<br />
<center>
<a href="http://www.youtube.com/user/artistsupplysource" target="_blank"><img src="{$ImagesDir}/yt-badge.gif" alt="Artist Supply Source on Youtube" /></a>
<br />
<br />
<a href="http://www.facebook.com/pages/Artist-Supply-Source-Inc/314310045653" target="_blank"><img src="{$ImagesDir}/facebook-badge.gif" alt="Artist Supply Source on Facebook" /></a>
</center>
{* END. Youtube and Facebook code *}

...
<tr><td height="10" width="9"><img src="{$ImagesDir}/top-left.jpg"></td>
<td bgcolor="#fbfbf3" height="10" width="100%"><img src="{$ImagesDir}/spacer.gif" height="10"></td>
<td height="10" width="9"><img src="{$ImagesDir}/top-right.jpg"></td></tr>
<tr>
<td bgcolor="#fbfbf3" colspan=3 style="padding-left: 10px; padding-right: 10px;">{include file="customer/home_main.tpl"}</td>
</tr>
<tr><td height="10" width="9"><img src="{$ImagesDir}/bottom-left.jpg"></td>
<td bgcolor="#fbfbf3" width="100%"><img src="{$ImagesDir}/spacer.gif" height="10"></td>
<td height="10" width="9"><img src="{$ImagesDir}/bottom-right.jpg"></td></tr>
</table>

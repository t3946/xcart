...
<table width="100%">
<tr>
<td align="left" width="100" nowrap="nowrap">{include file="buttons/button.tpl" button_title=$lng.lbl_print_invoice href="order.php?mode=invoice&orderid=`$orderids`" target="preview_invoice"}</td>

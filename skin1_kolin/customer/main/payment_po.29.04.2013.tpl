...
<td><font class="Star">*</font></td>
<td nowrap="nowrap">
<input type="text" size="32" id="Company_name" name="Company_name" value="{foreach from=$userinfo.additional_fields item=v}{if $v.section eq 'B' && $v.title eq "Company"}{$v.value}{/if}{/foreach}" />
</td>
</tr>
...
<td><font class="Star">*</font></td>
<td nowrap="nowrap">
<input type="text" size="32" id="Name_of_purchaser" name="Name_of_purchaser" value="{$userinfo.b_firstname} {$userinfo.b_lastname}" />
</td>
</tr>

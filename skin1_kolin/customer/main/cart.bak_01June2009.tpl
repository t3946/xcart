...
{if ($products[product].manufacturerid eq $k and $products[product].shipping_freight ne '0') or ($k eq '0' and $products[product].shipping_freight eq '0')}
...
<tr>
<td nowrap="nowrap">
<font color="ProductTitle"><b>{$v.group_name}&nbsp;{$lng.lbl_subtotal_sg}:</b></font>
</td>
...
<tr>
	...
	<td class="ButtonsRow"><b>{include file="buttons/button.tpl" button_title=$lng.lbl_update_qty type="input" href="javascript: document.cartform.submit()" js_to_href="Y"}</b></td>

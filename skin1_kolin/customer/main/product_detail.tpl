    ...
    {capture name=dialog}
        ...
        <form name="orderform" method="post" action="cart.php?mode=add" onsubmit="javascript: return FormValidation();">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td {* class="PImgBox" *} rowspan="3" height="300" width="300"
                                            ...
                                            <table cellpadding="1" cellspacing="1" class="discount_class2">
                                                <tr>
                                                    ...
                                                    <td class="discount_class">
                                                        <SPAN id="save_percent">{include file="currency.tpl" value=$discount_save plain_text_message=true price_type="product_price"} OFF</SPAN>&nbsp;
                                                    </td>
                                                </tr>
                                            </table>
                                        </TD>
                                    ...
                                    {if $config.General.unlimited_products eq "Y" or ($product.avail gt 0 and $product.avail ge $product.min_amount)}
                                        ...
                                        <br/>
                                            <font class="Message"><b>{$lng.lbl_note}
                                                    :</b> {$lng.lbl_pconf_slot_out_of_stock_note}</font>
                                        <br/>
                                        {/if}
                                        <br/>

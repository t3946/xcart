...
<tr>
	...
	<tr>
		...
		<tr id="tr_s_city">
			...
			<td>&nbsp;</td>
			<td nowrap="nowrap" align="left">
			<input type="text" id="s_city" name="s_city" size="27" maxlength="64" value="{$userinfo.s_city}" {* onchange="cidev_check_zip()"*} onkeyup="cidev_check_zip()" placeholder="{if $geo_litecity_location.city ne ""}{$geo_litecity_location.city}{else}{$lng.lbl_fill_in_examples_city}{/if}" />
			</td>
		</tr>

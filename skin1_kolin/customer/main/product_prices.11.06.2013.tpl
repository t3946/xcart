...
<TD nowrap="nowrap" id="wp_dt_l{%wi.index%}" style="font-weight: normal; color: #006500; border-right: 1px solid black; border-bottom: 1px solid black; font-size: 13px;" align="center">&nbsp;{$product_wholesale[wi].quantity}{if $smarty.section.wi.last && $product_wholesale[wi].next_quantity eq "0"}{if $product.avail gt $product_wholesale[wi].quantity}+{/if}{else}{if $product.mult_order_quantity eq "Y" && $product.min_amount gt 1}{else}{if $product_wholesale[wi].quantity ne $product_wholesale[wi].next_quantity}-{$product_wholesale[wi].next_quantity}{/if}{/if}{/if}&nbsp;</TD>

...
<TABLE align="center" border="0" cellpadding="2" cellspacing="0" style="border-top: 1px solid black; border-left: 1px solid black;" {if $mobile_skin ne "Y"}width="100%"{else}width="50%"{/if}>
...
<tr bgcolor="#ffffff">
<td align="center" {if $mobile_skin ne "Y"}width="30%"{else}width="50%"{/if} style="color: #006500; border-right: 1px solid black; border-bottom: 1px solid black; font-size: 13px;" nowrap="nowrap">Qty</td>
<td align="center" {if $mobile_skin ne "Y"}width="70%"{else}width="50%"{/if} style="color: #CD3335; border-right: 1px solid #000000; border-bottom: 1px solid black; font-size: 13px;" nowrap="nowrap">{$lng.lbl_price}</td>
</tr>

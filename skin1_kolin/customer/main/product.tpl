...
<td><font style="{* FONT-FAMILY: strickeout; *} font-size: 12px; color: #848C84;"><strike>{include file="currency.tpl" value=$product.list_price plain_text_message=true price_type="list_price" product=$product}</strike></font></td>
</tr>
{/if}
...
<font class="ProductPriceConverting"><span id="product_price" style="white-space: nowrap;">{include file="currency.tpl" value=$current_price plain_text_message=true price_type="product_price" product=$product}</span></font>
...
{/if}
<div style="font-size: 16px; color: #000000; font-weight: bold;" id="product_subtotal_value">Subtotal: {include file="currency.tpl" value=$product_subtotal_value plain_text_message=true price_type="product_subtotal_value" product=$product}</div>
{/if}

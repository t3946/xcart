...
{/capture}
{include file="dialog.tpl" title=$lng.lbl_similar_products content=$smarty.capture.dialog extra='width="100%" class="recommends no_padding_bottom"' do_not_use_h1="Y"}

...
<td>
    {if $products[prod_num].oProduct}
        {$products[prod_num].oProduct->getTitle()}
    {else}
...
{elseif $cart.groups_delivery[$k] eq "_USE_MY_TRUCKING_ACCOUNT_"}

{$cart.t_ship_by_shipping_method[$k]} (charge to trucking account # {$cart.t_use_my_account_number[$k]})

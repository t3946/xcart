...
<a href="product.php?productid={$products[product].productid}&amp;cat={$cat}&amp;page={$navigation_page}" class="ProductTitle{if $flag eq "related"}Related{/if}" style="font-weight: normal;"><font color=#0033CC>{$products[product].product}</font></a><br />

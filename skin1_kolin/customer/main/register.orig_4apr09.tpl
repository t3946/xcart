...
function check_registerform_fields() {ldelim}
	if(is_run)
		return false;
    if (!show_spam && !check_spam()) {$ldelim}
...
<a href="help.php?section=conditions" target="_blank" class="VertMenuItems"><font style="white-space: nowrap;font-size:12px;"><b>{$lng.lbl_terms_n_conditions}</b>&nbsp;</font></a>
{else}

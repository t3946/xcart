...
<tr>
	...
	<tr>
		...
		<tr>
			<td class="ButtonsRow" align="center" colspan="3" nowrap="nowrap"><br />{include file="buttons/button.tpl" button_title=$lng.lbl_calculate_shippings type="input" href="javascript: document.shipquoteform.submit()" js_to_href="Y" b="1"}</td>
		</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		<td class="ButtonsRow" align="center" nowrap="nowrap">{include file="buttons/button.tpl" button_title=$lng.lbl_calculate_grandtotal type="input" href="javascript: document.shipquoteform.submit()" js_to_href="Y" b="1"}</td>
	</tr>
	{/if}
	...
	<tr>
		<td class="ButtonsRow" align="left" nowrap="nowrap">
			{if $short eq 'Y'}
				{include file="buttons/button.tpl" button_title=$lng.lbl_shipquote_close_short type="input" href="javascript: window.close()" js_to_href="Y"}
			{else}
				{include file="buttons/button.tpl" button_title=$lng.lbl_shipquote_close type="input" href="javascript: window.close()" js_to_href="Y"}
			{/if}
		</td>
		<td class="ButtonsRow" align="right" nowrap="nowrap">{include file="buttons/button.tpl" button_title=$lng.lbl_shipquote_proceed type="input" href="javascript: document.shipquoteform.submit()" js_to_href="Y" b="1"}</td>
	</tr>

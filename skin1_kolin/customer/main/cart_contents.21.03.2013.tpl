...
<td class="Green2">{$cart.groups_delivery[$k]|trademark:$insert_trademark}</td>
{if $cart.display_cart_products_tax_rates eq "Y"}
<td align="center">

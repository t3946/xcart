...
<tr>
<td class="DialogTitle" colspan="2" valign="bottom">
{$v.manufact_text_displayed}
...
{* <tr><td colspan="2" valign="top"><hr size="1" noshade="noshade" /></td></tr> *}
...
<tr>
<td nowrap="nowrap">
<font color="#006600"><b>{*{$v.group_name}*}{$v.m_city}, {$v.m_state_code}, {if $v.m_country_code eq "US"}USA{else}{$v.m_country_code}{/if}&nbsp;warehouse&nbsp;{$lng.lbl_subtotal_sg}:</b></font>
</td>

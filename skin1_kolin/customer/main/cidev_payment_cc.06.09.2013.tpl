...
{include file="buttons/button.tpl" button_title=$lng.lbl_continue btn_to_checkout="Y" type="input" href="javascript: document.checkout_form_new.submit()" js_to_href="Y" b="1"}
...
{assign var="ecomm_totalvalue_replacement" value="ecomm_totalvalue: ''"}
        ...
        {$config.Company.cidev_google_adwords|replace:"ecomm_prodid: 'REPLACE_WITH_VALUE'":"`$ecomm_prodid_replacement`"|replace:"ecomm_pagetype: 'REPLACE_WITH_VALUE'":"`$ecomm_pagetype_replacement`"|replace:"ecomm_totalvalue: 'REPLACE_WITH_VALUE'":"`$ecomm_totalvalue_replacement`"}

...
{literal}
	...
	function check_zip_code_ship() {
		...
		document.forms["shipquoteform"].s_zipcode.value = $.trim(document.forms["shipquoteform"].s_zipcode.value);
	...
	function cidev_show_fields() {
			...
			document.getElementById("tr_i_do_not_know_zip").style.display = 'none';
                        document.getElementById("tr_s_state_s_city_table").style.display = 'none';
			if (document.forms["shipquoteform"].s_city.value == "not found"){
...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<select name="s_country" id="s_country" size="1" onchange="check_zip_code_ship(); cidev_set_check_state_field(this.value, 's_state');">
			...
			{/section}
                ...
                <tr>
                        ...
                        <input type="text" id="s_zipcode" name="s_zipcode" size="27" maxlength="32" value="{$userinfo.s_zipcode}" onkeyup="cidev_check_address()" onchange="{* cidev_check_address();*} check_zip_code_ship()" autocomplete="off" placeholder="{if $geo_litecity_location.postalCode ne ""}{$geo_litecity_location.postalCode}{else}{$lng.lbl_fill_in_examples_zip}{/if}" />
                        </td>
                </tr>
		...
		<tr id="tr_s_city">
			...
			<td>&nbsp;</td>
			<td nowrap="nowrap" align="left">
			<input type="text" id="s_city" name="s_city" size="27" maxlength="64" value="{$userinfo.s_city}" {* onchange="cidev_check_zip()"*} onkeyup="cidev_check_field('s_city'); cidev_check_zip();" placeholder="{if $geo_litecity_location.city ne ""}{$geo_litecity_location.city}{else}{$lng.lbl_fill_in_examples_city}{/if}" />
			</td>
		</tr>
...
function cidev_check_zipcode() {
	...
	if (check_zip_code_field(document.forms["shipquoteform"].s_country, document.forms["shipquoteform"].s_zipcode)){
		cidev_sqCALCULATE();
		return true;
	}

...
/*
var var_popup_shipquote = "";

function func_popup_shipquote() {

	if (var_popup_shipquote == 0){
		var_popup_shipquote = 2;
		window.open('/popup_shipquote.php?short=Y','popup_shipquote','width=800,height=600,toolbar=no,status=no,scrollbars=yes,menubar=no,location=no,direction=no');
	}
}
*/
$(function(){
 document.onkeydown = function(e) {
	...
	if (e.keyCode == "17"){
		if (document.getElementById('id_tr_minicart') && document.getElementById('id_tr_minicart_a')){
//			var_popup_shipquote = 0;

//			$('#id_tr_minicart').attr('onclick', '');
//			$('#id_tr_minicart_a').attr('onclick', '');
//			$("#id_tr_minicart_a").attr('href','javascript: void(0);');

			document.getElementById('id_tr_minicart').onclick=function () {
				window.open('/popup_shipquote.php?short=Y','popup_shipquote','width=800,height=600,toolbar=no,status=no,scrollbars=yes,menubar=no,location=no,direction=no');
...
/*
			$(function(){
			  $("#id_tr_minicart").click(function(event){
				func_popup_shipquote();
...
/*
 document.onkeyup = function(e) {
	if ((var_popup_shipquote == 0 || var_popup_shipquote == 2) && document.getElementById('id_tr_minicart') && document.getElementById('id_tr_minicart_a')){
		var_popup_shipquote = 1;
//		$("#id_tr_minicart_a").attr('href','/cart.php');
		document.getElementById('id_tr_minicart').onclick=function () {self.location='/cart.php';};
	}
 }
*/
...
{if $minicart_total_items gt 0 && $variant_id_for_point2 eq "0"}

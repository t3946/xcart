...
*}
          <form class="nav-searchbar-inner" id="nav-searchbar" method="post" action="home.php" name="productsearchform">
   	    ...
   	    {if $cat gt 0}
            <input type="hidden" name="e_current_url" value="{$action_notify_url}" />
	    {/if}
		...
		{/if}
            ...
            <div class="nav-searchfield-width">
              <div id="nav-iss-attach">
                <input type="text" autocomplete="off" name="e_posted_data[substring]" value="{$e_search_data.substring}" title="Search For" id="twotabsearchtextbox" placeholder="{$config.Company.cidev_header_code}" />
              </div>
            </div>

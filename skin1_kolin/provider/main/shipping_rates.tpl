...
<td><a href="shipping_rates.php?manufacturerid={$v.manufacturerid}{if $smarty.get.type ne ""}&type={$smarty.get.type}{/if}">{$v.manufacturer}</a></td>
</tr>
{/foreach}
</table>
{/capture}
...
{if $type eq "R"}
<tr>
<td><b>{* {$lng.lbl_shipping_cost_markup} *}Server quote multiplier:</b></td>

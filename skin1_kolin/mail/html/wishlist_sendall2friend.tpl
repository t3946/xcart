{* $Id: wishlist_sendall2friend.tpl,v 1.8 2006/03/31 05:51:44 svowl Exp $ *}
...
<b>{$lng.lbl_price}: <font color="#00AA00">{include file="currency.tpl" value=$wl_products[num].taxed_price|default:$wl_products[num].price}</font></b>
{/section}

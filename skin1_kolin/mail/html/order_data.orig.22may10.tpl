...
<th width="60" bgcolor="#cccccc">{$lng.lbl_total}<br /><img height="1" src="{$ImagesDir}/spacer.gif" width="50" border="0" alt="" style="height: 2px;max-height: 2px;" /></th>
</tr>
{foreach from=$order.shipping_groups item=v key=k}
<tr>
<td colspan="6">
<b>{$v.group_name} Items (delivery by {$v.shipping|trademark:''}, {include file="currency.tpl" value=$order.shipping_costs[$k]}):</b>
</td>
</tr>

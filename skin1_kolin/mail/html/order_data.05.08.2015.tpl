...
{if $tracking_links[$tr.linkid].link ne ""}<a href="{$tracking_links[$tr.linkid].link|substitute:"tracknum":$tr.tracknum}">{/if}{$tr.tracknum}{if $tracking_links[$tr.linkid].link ne ""}</a>{/if}
<br />
{*
...
*}
			...
			{if $tracking_links[$tr.linkid].link ne ""}
...
<td align="right">{include file="currency.tpl" value=$v_f.additional_fee_value}</td>
</tr>
{/foreach}
{/if}

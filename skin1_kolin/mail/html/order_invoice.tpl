...
{* <img src="{$SkinDir}/images/S3-Stores-Logo-M.png" alt="" /> *}

{if $site_domain ne ""}
<img src="https://{$site_domain}/skin1_kolin/images/S3-Stores-Logo-M.png" alt="" />
{elseif $current_storefront_info.domain ne ""}
<img src="https://{$current_storefront_info.domain}/skin1_kolin/images/S3-Stores-Logo-M.png" alt="" />
{else}
<img src="{$SkinDir}/images/S3-Stores-Logo-M.png" alt="" />
{/if}

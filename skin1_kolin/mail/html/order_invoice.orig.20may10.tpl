...
{/if}
	...
	<tr>
		<td bgcolor="#000000"><img height="2" src="{$ImagesDir}/spacer_black.gif" width="100%" alt="" style="height: 2px; max-height: 2px;" /></td>
	</tr>
	<tr>
...
{/foreach}
	...
	<tr>
		<td bgcolor="#000000" height="2"><img height="2" src="{$ImagesDir}/spacer_black.gif" width="100%" alt="" style="height: 2px; max-height: 2px;" /></td>
		<td><img height="2" src="{$ImagesDir}/spacer.gif" width="1" alt="" style="height: 2px; max-height: 2px;" /></td>
		<td bgcolor="#000000" height="2"><img height="2" src="{$ImagesDir}/spacer_black.gif" width="100%" alt="" style="height: 2px; max-height: 2px;" /></td>
	</tr>
	<tr>

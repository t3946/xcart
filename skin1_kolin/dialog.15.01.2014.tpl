...
<tr> 
{if $do_not_use_h1 eq "Y"}
 <td class="DialogTitle valign-top">{if $align eq 'center'}<center><b>{$title}</b></center>{else}<b>{$title}</b>{/if}</td> 
{else}
<td class="DialogTitle valign-top">{if $align eq 'center'}<center>{if $usertype eq "C"}<h1>{else}<b>{/if}{$title}{if $usertype eq "C"}</h1>{else}</b>{/if}</center>{else}{if $usertype eq "C"}<h1>{else}<b>{/if}{$title}{if $usertype eq "C"}</h1>{else}</b>{/if}{/if}</td>
{/if}

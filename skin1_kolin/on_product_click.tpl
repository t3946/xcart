...
{assign var="ga__product" value=$products[product].product|default:$product.product|escape:quotes|replace:'"':'\&#34;'}
{assign var="ga__category" value=$products[product].category|default:$product.category|escape:quotes|replace:'"':'\&#34;'}
{assign var="ga__brand" value=$products[product].brand|default:$product.brand|escape:quotes|replace:'"':'\&#34;'}

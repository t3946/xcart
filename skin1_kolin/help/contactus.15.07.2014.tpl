...
{/if}
		...
		<td valign="top" nowrap="nowrap">
                ...
                {elseif $field.field eq 'b_zipcode'}
                    <input type="text" id="b_zipcode" name="b_zipcode" size="32" maxlength="32" value="{$userinfo.b_zipcode}" onchange="javascript: check_zip_code(document.getElementById('b_country'), this);" placeholder="{$lng.lbl_contact_placeholder_b_zipcode}" />
                ...
                {elseif $field.field eq 'email'}
                    <input type="text" id="email" name="email" size="32" maxlength="128" value="{$userinfo.email}" onchange="javascript: checkEmailAddress(this);" placeholder="{$lng.lbl_contact_placeholder_email}" />
    ...
    {if $field.ftype eq 'additional' && $field.avail eq "Y"}
		...
		<td>
                ...
                {if $field.type eq 'T'}
                    <input type="text" id="additional_values_{$field.fieldid}" name="additional_values[{$field.fieldid}]" id="additional_values_{$field.fieldid}" size="32" value="{$field.value|escape}" {if $field.fieldid eq "2"}placeholder="{$lng.lbl_contact_placeholder_sku_order}"{/if} />
...
<td nowrap="nowrap">
	...
	<tr>
	<td>
	<input type="text" id="subject" name="subject" size="32" maxlength="255" value="{$userinfo.subject}" placeholder="{$lng.lbl_contact_placeholder_subject}" style="width: 85%;" />
	{if $fillerror ne "" and $userinfo.subject eq ""}<font class="Star">&lt;&lt;</font>{/if}
	</td>

	<td id="subject_verified" valign="top" nowrap="nowrap" style="display: none;">
	<img src="{$ImagesDir}/checkmark-verified.png" alt="" />
	</td>
	<td id="subject_error" valign="top" nowrap="nowrap" style="display: none;">
	<img src="{$ImagesDir}/checkmark-error.png" alt="" />
	</td>
...
<td nowrap="nowrap">
        ...
        <tr>
        <td>
	<textarea style="width: 85%;" cols="48" id="message_body" rows="12" name="body" placeholder="{$lng.lbl_contact_placeholder_message_body}">{$userinfo.body}</textarea>
	{if $fillerror ne "" and $userinfo.body eq ""}<font class="Star">&lt;&lt;</font>{/if}
	</td>

        <td id="message_body_verified" valign="top" nowrap="nowrap" style="display: none;">
        <img src="{$ImagesDir}/checkmark-verified.png" alt="" />
        </td>
        <td id="message_body_error" valign="top" nowrap="nowrap" style="display: none;">
        <img src="{$ImagesDir}/checkmark-error.png" alt="" />
        </td>

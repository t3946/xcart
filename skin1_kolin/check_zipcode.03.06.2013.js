...
function cidev_new_check_zip_code() {
	...
	var countrySelected = cidev_get_country_code("s_countryname");
		...
		var countrySelected_b = cidev_get_country_code("b_countryname");
	        ...
	        return cidev_new_check_zip_code_field(countrySelected_b, document.forms["registerform"].b_zipcode) && cidev_new_check_zip_code_field(countrySelected, document.forms["registerform"].s_zipcode);
        } else {
                return cidev_new_check_zip_code_field(countrySelected, document.forms["registerform"].s_zipcode);
        }
}

function cidev_new_check_zip_code_field(cnt, zip) {
        var c_code;
        var zip_error = false;

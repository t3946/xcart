...
if (!$url) {
    ...
    $url = "https://www.amazon.com/s/ref=nb_sb_noss?url=search-alias%3Daps&field-keywords=795721107878";
...
if (stripos($contentType, "text/html") !== false) {
    $contents = preg_replace('/(?<=href=(\\"|\'))[^\\"\']+(?=(\\"|\'))/', PROXY_PREFIX . 'mode=native&url=$0', $contents);

...
###
	...
	$product_info_arr = func_query_first("SELECT productid, productcode, forsale, avail, r_avail, eta_date_mm_dd_yyyy, cost_to_us, update_search_index, discount_table, new_map_price FROM $sql_tbl[products] WHERE productcode='".addslashes($productcode)."'");
...
#
	...
	if ($new_forsale != $current_forsale || $new_eta_date_mm_dd_yyyy != $current_eta_date_mm_dd_yyyy || $current_r_avail != $new_r_avail || $current_cost_to_us != $new_cost_to_us || $current_discount_table != $new_discount_table || $new_new_map_price != $current_new_map_price){

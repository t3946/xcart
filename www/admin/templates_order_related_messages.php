...
//			db_query("INSERT INTO $sql_tbl[templates_for_communication] (template_name, pos, subject_line, send_to_email, message_body, department, active, ca_status) VALUES ('$v[template_name]', '$v[pos]', '$v[subject_line]', '$v[send_to_email]', '$v[message_body]', '$department', '$v[active]', '$v[ca_status]')");
			db_query("INSERT INTO $sql_tbl[templates_for_communication] (template_name, pos, subject_line, send_to_email, message_body, department, active, status_id, attach_pdf_invoice) VALUES ('$v[template_name]', '$v[pos]', '$v[subject_line]', '$v[send_to_email]', '$v[message_body]', '$department', '$v[active]', '$v[status_id]', '$v[attach_pdf_invoice]')");
		}
	}

...
//		                                                if (strpos($description_csv, $v["d_search_keyphrase_for_reconciliation"]) !== false){
        ...
        $_filter = [
            'date_csv__gte' => $search_data["reconciliation_tab_calculation"]["date_csv"]["start_date"],
            'date_csv__lte' => $search_data["reconciliation_tab_calculation"]["date_csv"]["end_date"],
            'action' => ''
        ];

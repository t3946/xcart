...
require '/var/www/stores/admin/xhprof/xhprof_lib/config.php';
...
if (extension_loaded('xhprof') && $_xhprof['doprofile'] === true) {
    include_once '/var/www/stores/admin/xhprof/xhprof_lib/utils/xhprof_lib.php';
    include_once '/var/www/stores/admin/xhprof/xhprof_lib/utils/xhprof_runs.php';
...
function xhprof_shutdown_function() {
    global $_xhprof;
    require '/var/www/stores/admin/xhprof/external/footer.php';
}

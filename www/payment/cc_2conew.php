...
##
###
        $cidev_first_last_name = func_get_first_last_name($userinfo["s_firstname"]);
        $userinfo["s_firstname"] = $cidev_first_last_name["first_name"];
        $userinfo["s_lastname"] = $cidev_first_last_name["last_name"];
###
##
# 
...
<body onLoad="document.process.submit();">
  <form action="https://www.2checkout.com/checkout/spurchase" method="POST" name="process">
	...
	<input type=hidden name=street_address2 value="<?php echo htmlspecialchars($userinfo["b_address_2"]); ?>">
	...
	<input type=hidden name=ship_street_address2 value="<?php echo htmlspecialchars($userinfo["s_address_2"]); ?>">

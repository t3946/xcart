...
if ($REQUEST_METHOD == 'GET' && !empty($_GET['status']) && !empty($_GET['oid'])) {
	require "./auth.php";
...
} elseif ($REQUEST_METHOD == 'POST' && !empty($_POST['status']) && !empty($_POST['transaction_id']) && !empty($_POST['merchant_id']) && !empty($_POST['mb_transaction_id'])) {
#  'status' => '2',

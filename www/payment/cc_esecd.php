...
#
# $Id: cc_esecd.php,v 1.10 2006/01/11 06:56:22 mclap Exp $
#
...
else
{
	...
	$userinfo["card_number"]=($module_params["testmode"]=="A" ? "testcuccess" : "testfailure");
}
...
$resp = preg_split("/\n/",$return);
foreach($resp as $v)
	if($v){ list($a,$b) = explode("=",$v,2); $ret[$a] = trim($b); }


#    [ref-id] => xcart562
#    [auth-id] => 005122
#    [message] => 200 success
#    [signature] => cvficvVcKquB92ylH8UcfmE3ALHRUr50Bniv674BoP1b/3E09pgI4wrhpUT10MNzvGMob/z+jD2hZc64fV9YTr9hi/qO30F4PEiJrbX5TtW9oKN55UdK8sZce2d+cRidVvrtRU2oTlolke5tfZsILtepcLo62I2RKm0XnXSM068=
#    [txn-id] => 005122
#    [eft-response] => 00
#    [settlement-date] => 20030424
...
if($ret["signature"])
	$bill_output["billmes"].= " (Signature: ".$ret["signature"].")";

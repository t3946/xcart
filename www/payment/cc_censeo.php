...
if ($REQUEST_METHOD == 'GET' && $_GET['R_Code'] && $_GET['Checksum']) {
	require "./auth.php";

	$bill_output['sessid'] = func_query_first_cell("SELECT sessionid FROM $sql_tbl[cc_pp3_data] WHERE ref='" . $_GET['T_Info'] . "'");

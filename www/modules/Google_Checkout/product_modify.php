...
#
# $Id: product_modify.php,v 1.1.2.1 2006/10/13 10:41:19 svowl Exp $
#
...
if ($REQUEST_METHOD == "POST" && !empty($productid)) {
	...
	$_product_in_restrictions = func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[gcheckout_restrictions] WHERE productid='$product[productid]' LIMIT 1");

...
#
# $Id: usps_test.php,v 1.1.2.3 2006/12/25 14:26:25 svowl Exp $
#
# U.S.P.S module (test)
#
...
func_rm_dir_files($xcart_dir."/var/tmp/usps_test_labels/");
...
foreach ($usps_methods as $method=>$data) {
	...
	foreach ($data['xml_requests'] as $xml_id => $xml_data) {
		...
		$response = func_usps_parce_result($return, $data['xml_head'], $xml_data['file_type']);

...
# Export data	
	...
	while (($id = func_export_get_row($data)) !== false) {
		...
		if (!empty($active_modules['Multiple_Storefronts'])) {
			$mrow = db_query("SELECT $sql_tbl[classes].* FROM $sql_tbl[classes], $sql_tbl[products]"
				. " LEFT JOIN $sql_tbl[products_sf] ON $sql_tbl[products].productid=$sql_tbl[products_sf].productid"
				. " WHERE $sql_tbl[classes].productid = $sql_tbl[products].productid AND $sql_tbl[products_sf].sfid=$current_storefront"
				. " AND $sql_tbl[classes].productid = '$id'"

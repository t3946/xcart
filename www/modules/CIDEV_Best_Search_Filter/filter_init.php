...
//        $brand_clean_url = func_query_first_cell("SELECT clean_url FROM  $sql_tbl[clean_urls] WHERE resource_type='M' AND resource_id='$b_id'", \Modules\Core\Helpers\Cache::CACHE_DAY);
...
//    $filter_selected_brands = func_query("SELECT brandid, brand FROM $sql_tbl[brands] WHERE brandid IN ($imploded_brandids) ORDER BY brand", \Modules\Core\Helpers\Cache::CACHE_DAY);
//

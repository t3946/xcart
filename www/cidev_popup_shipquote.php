...
### additional check ###
                        if (empty($show_zip)){
							...
							$count_show_zip = func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[zip_code_info] WHERE state='".addslashes($s_state_in_shipquoteform)."' AND acceptable_cities LIKE '%".addslashes($s_city_in_shipquoteform)."%'");
				...
				if (!empty($acceptable_cities_arr)){
					...
					foreach ($acceptable_cities_arr as $k => $v){
						if ($v == addslashes($s_city_in_registerform)){
                                                        ...
                                                        $count_show_zip = func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[zip_code_info] WHERE state='".addslashes($s_state_in_registerform)."' AND acceptable_cities LIKE '%".addslashes($s_city_in_registerform)."%'");
...
### additional check ###
                        if (empty($show_zip)){
							...
							$count_show_zip = func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[zip_code_info] WHERE state='".addslashes($b_state_in_registerform)."' AND acceptable_cities LIKE '%".addslashes($b_city_in_registerform)."%'");

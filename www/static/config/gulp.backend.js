...
module.exports = {
  ...
  src: {
    ...
    js: [
      ...
      modules.map(function (dir) {
        return dir + "/static/js/**/*.*";
      })
    ),
    scss: ["backend/scss/**/*.scss"].concat(
      modules.map(function (dir) {
    ...
    css: ["backend/css/*", "temp/backend/css/**/*"].concat(
      modules.map(function (dir) {
  ...
  vendors: {
    ...
    "jquery-ui": {
      js: ["node_modules/jquery-ui/jquery-ui.js"],
      css: [
    ...
    "jquery.shapeshift": {
      js: ["node_modules/jquery.shapeshift/core/jquery.shapeshift.js"],
    },

    "jquery.cookie": {
      js: ["node_modules/jquery.cookie/jquery.cookie.js"],
    },
    "jquery-form": {
      js: ["node_modules/jquery-form/dist/jquery.form.min.js"],
    },
    font_icons: {
      css: ["backend/fonts/icons/css/style.css"],
      fonts: ["backend/fonts/icons/fonts/*"],
    },

    mmodal: {
      js: ["node_modules/mmodal/js/jquery.mindy.modal.js"],
      // scss: [
    ...
    mouse_wheel: {
      js: ["node_modules/jquery-mousewheel/jquery.mousewheel.js"],
      // scss: [
      //     'node_modules/mmodal/scss/jquery.mmodal.scss'
      // ]
    },
    underscore: {
      js: ["node_modules/underscore/underscore.js"],
    },
    confirm: {
      js: ["components/confirm/jquery.confirm.js"],
    },
    ui_custom: {
      js: ["components/ui-custom/jquery-ui.min.js"],
      css: ["components/ui-custom/jquery-ui.min.css"],
    },
    deparam: {
      js: ["components/deparam/jquery.deparam.js"],
    },
    flow: {
      js: ["node_modules/flow-js/dist/flow.js"],
    },
    files_field: {
      js: ["components/fields/js/filesfield.js"],
    },
    select2: {
      js: [
    ...
    "air-datepicker": {
      ...
      css: ["components/air-datepicker/dist/css/datepicker.css"],
    },
    ...
    cds: {
      scss_include: ["components/cds"],
    },

    "compass-mixins": {
      scss_include: ["node_modules/compass-mixins/lib/"],
    },
    "mindy-sass": {
      scss_include: ["node_modules/mindy-sass/"],
    },
  },
};

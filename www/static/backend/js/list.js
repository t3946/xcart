...
$(function () {
  var list = {
    ...
    getPkList: function () {
      var pkList = [];
      this.$listBlock
        .find('input[type=checkbox][name="pk_list[]"]:checked')
        .each(function () {
          var $checkbox = $(this);
    ...
    saveColumns: function () {
      ...
      this.$listBlock
        .find('[name="columns_list[]"]:checked')
        .each(function () {
  ...
  function showPopup($this) {
    ...
    var hndl = window.open(
      list.extendUrl($this.attr("href"), "popup", true),
      document.title,
      "width=" +
        w +
        ", height=" +
  ...
  $(document).on(
    "change",
    ".list-block .pagination-block [data-pagesize]",
    function (e) {
      var $this = $(this);
      var url = $this.val();
      var list = getList($this);

...
import RemoveHeader from "@client/jsx/modules/icon/components/header/RemoveHeader";
import Magnifier from "@client/jsx/modules/icon/components/common/magnifier/Light";
import SuggestionsListForAll from "@client/jsx/components/SuggestionsListForAll";
import {
  getSuggestionsAction,
  setSuggestionsAction as setSuggests,
} from "@client/jsx/redux/actions/SuggestionActions";

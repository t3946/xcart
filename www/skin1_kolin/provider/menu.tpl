...
{* <a href="{$catalogs.provider}/manufacturers.php?word=num" class="VertMenuItems">{$lng.lbl_manufacturers}</a><br /> *}
{/if}
{if $active_modules.Brands}
<a href="{$catalogs.provider}/brands.php?word=num" class="VertMenuItems">{$lng.lbl_brands}</a><br />
{/if}
...
{/if}
{if $category_staff eq 'Y'}<a href="{$catalogs.provider}/categories.php" class="VertMenuItems">{$lng.lbl_categories} {$lng.lbl_sf}</a><br />{/if}
<a href="{$catalogs.provider}/categories.php?mode=info" class="VertMenuItems">{$lng.lbl_info_pages}{if $active_modules.Multiple_Storefronts} {$lng.lbl_sf}{/if}</a><br />
<a href="{$catalogs.provider}/search.php" class="VertMenuItems">{$lng.lbl_search_products} {$lng.lbl_sf}</a><br />
<a href="{$catalogs.provider}/grandfathered_products.php" class="VertMenuItems">{$lng.lbl_grandfathered_products}</a><br />


 <a onclick='javascript: window.open("cidev_popup_add_product.php","selectimage","width=500,height=200,toolbar=no,status=no,scrollbars=yes,resizable=no,menubar=no,location=no,direction=no");' href="javascript: void(0);" class="VertMenuItems">{$lng.lbl_add_new_product}</a> 


{* <a href="{$catalogs.provider}/product_modify.php" class="VertMenuItems">{$lng.lbl_add_new_product}</a> *}
<br />
{*

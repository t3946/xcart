...
{include file="main/include_js.tpl" src="change_all_checkboxes.js"}
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td>
				<div style="line-height:170%"><a href="javascript:change_all(true);">{$lng.lbl_check_all}</a> / <a
							href="javascript:change_all(false);">{$lng.lbl_uncheck_all}</a></div>
			</td>
			<td align="right">
									...
									<table cellpadding="0" cellspacing="3" width="100%" border="0">
										{section name=rate loop=$shipping_method.rates}
											...
											<tr>
												...
												<td nowrap="nowrap">
													<input type="text"
														   name="posted_data[{$shipping_rate.rateid}][mintotal]"
														   size="9"
														   value="{$shipping_rate.mintotal|default:0|formatprice}"/>
													-
													<input type="text"
											...
											<tr>
												...
												<td nowrap="nowrap">
													{if $type eq "R"}
														<input type="text"
															   name="posted_data[{$shipping_rate.rateid}][cost_marcup]"

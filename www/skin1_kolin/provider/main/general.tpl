{* $Id: general.tpl,v 1.18.2.1 2006/06/16 10:47:51 max Exp $ *}
...
{if $config.Shipping.realtime_shipping ne "Y" and $shipping_rates_count le "0" && $config.Shipping.disable_shipping ne "Y"}
<tr>
	<td colspan="2">

{* $Id: discounts.tpl,v 1.28.2.2 2006/07/11 08:39:37 svowl Exp $ *}
...
checkboxes = new Array({foreach from=$discounts item=v key=k}{if $k > 0},{/if}'posted_data[{$v.discountid}][to_delete]'{/foreach});
...
<tr>
	...
	<td>{include file="main/membership_selector.tpl" field="discount_membershipids_new[]" data="" is_short='Y'}</td>
</tr>

<tr>
	<td colspan="5" class="SubmitBox"><input type="button" value="{$lng.lbl_add_update|strip_tags:false|escape}" onclick="javascript: submitForm(this, 'add');" /></td>
</tr>

...
{elseif $main eq "brands_list"}
{include file="modules/Brands/customer_brands_list.tpl"}

{elseif $main eq "brand_products"}
{include file="modules/Brands/customer_brand_products.tpl"}
...
{elseif $main eq "catalog" && $current_category.category eq "" && $keyphrase eq ''}
...
{elseif $main eq "retrieve_orders"}
{include file="customer/main/retrieve_orders.tpl"}

{elseif $main eq "new_products"}

...
popupLayer.prototype.setDim = function(x, y, w, h) {
  ...
  var sl = (localIsStrict && localBrowser != 'Chrome' && localBrowser != 'Safari') ? document.documentElement.scrollLeft : document.body.scrollLeft;
  var st = (localIsStrict && localBrowser != 'Chrome' && localBrowser != 'Safari') ? document.documentElement.scrollTop : document.body.scrollTop;

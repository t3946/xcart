...
jQuery.extend({
	...
	//	console.log('elem, name, data: ' + elem +' : ' + name +' : ' + data);
...
jQuery.fn.extend({
	...
	triggerHandler: function( type, data ) {
	    //alert('0-debug-triggerHandler-(1.4)2323 - : ' + type + ' : ' + data);
		if ( this[0] ) {
			var event = jQuery.Event( type );
			event.preventDefault();
			event.stopPropagation();
			jQuery.event.trigger( event, data, this[0] );
		//	console.log('1-debug-triggerHandler-(1.4)2323 -: ' + jQuery.event.trigger( event, data, this[0] ) + ' :-- event.result: ' + event.result);
			return event.result;
			//return  this[0] && event.result;

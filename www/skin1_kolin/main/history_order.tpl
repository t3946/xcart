...
{if $usertype ne "C"}
    {capture name=order_progress}
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr><td><B>Fraud Check v.2:</B></td><td><a href="/admin/order/fraud_check_v2/{$order.orderid}" target="_blank" style="color: #140BFC">{include file="main/fraud_status.tpl" fraud_status=$order.fraud_status fraud_static="Y"} ({$order.overall_fraud_score})</a></td></tr>

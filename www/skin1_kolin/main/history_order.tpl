...
{if $usertype ne "C"}
    {capture name=order_progress}
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr><td><B>Fraud Check 2.0:</B></td><td><a href="/admin/order/fraud_check_v2/{$order.orderid}" target="_blank" style="color: #140BFC">{include file="main/fraud_status.tpl" fraud_status=$order.fraud_status fraud_static="Y"} ({$order.bare_fraud_score_v2})</a></td></tr>

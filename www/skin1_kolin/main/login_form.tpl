...
<table>
<tr> 
	<td height="10" width="176" align="right" class="FormButton">{*{$lng.lbl_login}*}Username</td>
...
{include file="buttons/submit.tpl" href="javascript:document.errorform.submit()" js_to_href="Y" type="input" style="button" b="1" new_button_name="Login" b_size="12"} 
{else}

...
<tr>
<td valign="top" nowrap="nowrap">
<input required autocomplete="shipping name" type="text" id="firstname" name="firstname" size="32" maxlength="32" value="{$userinfo.firstname|replace:"&amp;#039;":"'"}" placeholder="{$lng.lbl_fill_in_examples_firstname}" onkeyup="cidev_check_field_name('firstname')" />
</td>
{if $usertype eq "C"}
...
<tr>
<td valign="top" nowrap="nowrap">
<input required autocomplete="shipping tel" type="text" id="phone" name="phone" size="32" maxlength="32" value="{if $userinfo.phone eq "" && ($new_login_type eq "P" || $new_login_type eq "A") && $main eq "user_add"}{$config.Company.company_phone_2}{else}{$userinfo.phone}{/if}" placeholder="{$lng.lbl_fill_in_examples_phone}" onkeyup="cidev_check_field_phone('phone')" />
</td>
...
<tr>
<td valign="top" nowrap="nowrap">
<input required autocomplete="shipping email" type="email" id="email" name="email" size="32" maxlength="128" value="{if $userinfo.email eq "" && ($new_login_type eq "P" || $new_login_type eq "A") && $main eq "user_add"}{$config.Company.users_department}{else}{$userinfo.email}{/if}" placeholder="{$lng.lbl_fill_in_examples_email}" {* onblur="javascript: $('#email_note').hide();" onfocus="javascript: cidev_showNote('email_note', this);" *} />
</td>
...
{if $default_fields.pbx_extension.avail eq 'Y'}
<tr>
<td valign="top" align="right">PBX extension</td>
<td valign="top">{if $default_fields.pbx_extension.required eq 'Y'}<font class="Star">*</font>{else}&nbsp;{/if}</td>
<td valign="top" nowrap="nowrap">
<input type="text" id="pbx_extension" name="pbx_extension" size="32" maxlength="128" value="{$userinfo.pbx_extension}" {if $membership_code ne ""}readonly="readonly"{/if} />
{if $reg_error ne "" and $userinfo.pbx_extension eq "" and $default_fields.pbx_extension.required eq 'Y'}<font class="Star">&lt;&lt;</font>{/if}
</td>
</tr>
{/if}

          ...
          <table cellspacing="0" cellpadding="0" class="customer-info-edit" width="100%">
              ...
              <tr>
                  ...
                  <td width="76%"><input type="text" name="organization_name" id="po_company_name"
                                         value="{$order.po_details.organization_name|stripcslashes|escape}"/></td>
              </tr>
...
{assign var=order_extra_purchase value=$oOrder->extra_model->purchase_order}
...
<tr>
  ...
  <tr>
    ...
    <td width="76%"><input style="width: 55%; {if $order.po_details.name_of_purchaser|lower eq 'unknown'}background-color: #F4CCCC;{/if}" type="text" name="name_of_purchaser" id="name_of_purchaser" value="{$order_extra_purchase.name_of_purchaser|stripcslashes|escape}" />&nbsp;<a target="_blank" href="https://www.google.com/search?q={$order_extra_purchase.name_of_purchaser|replace:' ':'+'}" style="color: #1F08F8;">Google FN</a></td>
  </tr>

  <tr>
    <td width="24%"><b>Phone:</b> </td>
    <td width="76%">
        <input type="text" name="purchase_manager_phone" id="purchase_manager_phone" value="{$order_extra_purchase.purchase_manager_phone|escape}" style="width: 29%; {if $order.po_details.purchase_manager_phone eq '(000) 000-0000'}background-color: #F4CCCC;{/if}" />

        <b>{$lng.lbl_phone_ext}</b> <input type="text" name="purchase_manager_phone_ext" id="purchase_manager_phone_ext" value="{$order_extra_purchase.purchase_manager_phone_ext|escape}" style="width: 10%;" maxlength="6" />&nbsp;<a target="_blank" href="https://www.google.com/search?q={$google_purchase_manager_phone}" style="color: #1F08F8;">Google phone</a>
  ...
  <tr>
    ...
    <td width="76%"><input type="text" name="purchase_manager_fax" id="po_fax" value="{$order_extra_purchase.purchase_manager_fax|escape}" style="{if $order.po_details.purchase_manager_fax eq '(000) 000-0000'}background-color: #F4CCCC;{/if}" /></td>
  </tr>
  ...
  <tr>
    ...
    <td width="76%"><input type="text" name="purchase_manager_email" id="purchase_manager_email" value="{$order_extra_purchase.purchase_manager_email|escape}" style="{if $order.po_details.purchase_manager_email|lower eq 'unknown@unknown.com'}background-color: #F4CCCC;{/if}" /></td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Full Name:</b> </td>
    <td width="76%"><input style="width: 55%; {if $order.po_details.accounts_payable_full_name|lower eq 'unknown'}background-color: #F4CCCC;{/if}" type="text" name="accounts_payable_full_name" id="accounts_payable_full_name" value="{$order_extra_purchase.accounts_payable_full_name|stripcslashes|escape}" />&nbsp;&nbsp;<a target="_blank" href="https://www.google.com/search?q={$order.po_details.accounts_payable_full_name|replace:' ':'+'}" style="color: #1F08F8;">Google FN</a></td>
  </tr>

  <tr>
    <td width="24%"><b>Phone:</b> </td>
    <td width="76%">
      <input type="text" name="accounts_payable_phone" id="accounts_payable_phone" value="{$order_extra_purchase.accounts_payable_phone|escape}" style="width: 29%; {if $order.po_details.accounts_payable_phone eq '(000) 000-0000'}background-color: #F4CCCC;{/if}" />
  <b>{$lng.lbl_phone_ext}</b> <input type="text" name="accounts_payable_phone_ext" id="accounts_payable_phone_ext" value="{$order_extra_purchase.accounts_payable_phone_ext|escape}" style="width: 10%;" maxlength="6" />&nbsp;<a target="_blank" href="https://www.google.com/search?q={$google_accounts_payable_phone}" style="color: #1F08F8;">Google phone</a>
    </td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Fax:</b></td>
    <td width="76%"><input type="text" name="accounts_payable_fax" id="accounts_payable_fax" value="{$order_extra_purchase.accounts_payable_fax|escape}" style="{if $order.po_details.accounts_payable_fax eq '(000) 000-0000'}background-color: #F4CCCC;{/if}" /></td>
  </tr>
  ...
  <tr>
    <td width="24%"><b>Email:</b></td>
    <td width="76%"><input type="text" name="accounts_payable_email" id="accounts_payable_email" value="{$order_extra_purchase.accounts_payable_email|escape}" style="{if $order.po_details.accounts_payable_email|lower eq 'unknown@unknown.com'}background-color: #F4CCCC;{/if}" /></td>
  </tr>
...
{if $customer.default_fields.s_firstname}
  <tr>
    ...
    <td width="100%" nowrap="nowrap">{if !$static}<input style="width: 55%;" type="text" name="customer_info[s_firstname]" value="{$oOrder->s_firstname}" />{else}{$oOrder->s_firstname}{/if}
&nbsp;<a target="_blank" href="https://www.google.com/search?q={$oOrder->s_firstname|replace:' ':'+'}+{$oOrder->s_zipcode|replace:' ':'+'}" style="color: #1F08F8;">Google FN + zip code</a>
    </td>
  </tr>
{/if}
{if $customer.default_fields.s_lastname}
  <tr>
    ...
    <td width="100%">{if !$static}<input type="text" name="customer_info[s_lastname]" value="{$oOrder->s_lastname}" />{else}{$oOrder->s_lastname}{/if}</td>
  </tr>
{/if}
  <tr>
    <td>Company:</td>
        <td width="100%" nowrap="nowrap">{if !$static}<input style="width: 55%;" type="text" name="additional_fields[2]" value="{$oOrder->s_company}" />{else}{$oOrder->s_company}{/if}
&nbsp;<a target="_blank" href="https://www.google.com/search?q={$oOrder->s_company|escape:"url"}" style="color: #1F08F8;">Google company</a>
        </td>
  </tr>
...
{if $current_membership_flag ne 'FS'}
  &nbsp;&nbsp;&nbsp;&nbsp;
  <input type="button" value="{$lng.lbl_apply_changes_send_email|escape}" onclick="$('#send_email2').val('Y'); this.form.submit();" {if $order.amazonorderid ne "" || $order.allow_dispatch_off_working_hours_functionality_enabled_found eq "Y"}disabled="disabled" style="border: 1px solid #ff0000" {/if} />
{/if}
{/if}

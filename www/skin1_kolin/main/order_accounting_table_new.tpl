...
<span style="color: #f00000; line-height:25px; position: absolute; right: 21px; font-size: 13px; font-weight: bold;">
    Clicking Update button will generate another invoice because distributor charges for each order twice: one charge for products and one charge for shipping
</span>
{/if}
</div>
{/if}

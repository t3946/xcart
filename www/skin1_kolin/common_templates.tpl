{* $Id: common_templates.tpl,v 1.46.2.6 2006/10/13 10:41:20 svowl Exp $ *}
...
{include file="modules/Mailchimp_Subscription/customer/news_archive.tpl" }

{elseif $main eq "mc_news_lists"}
{include file="modules/Mailchimp_Subscription/customer/news_lists.tpl"}
...
{elseif $main eq "sitemap_customer"}
{include file="modules/Sitemap/main.tpl"}

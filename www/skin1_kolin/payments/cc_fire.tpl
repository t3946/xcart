{* $Id: cc_fire.tpl,v 1.7.2.3 2006/07/17 11:15:52 max Exp $ *}
<h3>FirePay</h3>
...
<tr>
<td>{$lng.lbl_cc_fire_merchantid}:</td>
<td><input type="text" name="param01" size="24" value="{$module_data.param01|escape}" /></td>
</tr>
<tr>
<td>{$lng.lbl_cc_fire_password}:</td>
<td><input type="password" name="param03" size="24" value="{$module_data.param03|escape}" /></td>
</tr>

<tr>
<td>{$lng.lbl_cc_fire_acc}:</td>

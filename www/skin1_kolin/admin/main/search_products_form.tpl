...
<table cellpadding="3" cellspacing="1" width="100%">
  <tr>
      <td width="25%">{$lng.lbl_search_by_sku_from_all_sf}:</td>
      <td>
        <input type="checkbox" value="Y" name="search_by_sku_from_all_sf"{if $config.Search_products.search_by_sku_from_all_sf eq "Y"} checked="checked"{/if} />
      </td>
  </tr>
</table>

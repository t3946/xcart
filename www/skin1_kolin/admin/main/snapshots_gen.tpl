{* $Id: snapshots_gen.tpl,v 1.6.2.3 2006/07/11 08:39:27 svowl Exp $ *}
{*
...
<tr>
	<td colspan="3" align="right" class="SubmitBox"><input type="submit" value="{$lng.lbl_delete_selected|strip_tags:false|escape}" /></td>
</tr>

    ...
    <form action="manufacturers.php" method="post" name="manufacturer_locked_fields">
        ...
        <table align="center" cellpadding="3" cellspacing="1" align="center">
            ...
            <tr>
                ...
                <td><B>Locked <br/> by admin</B></td>
                <td><B>Filled <br/> by feed</B></td>
                <td><B>Feed name</B></td>
            </tr>
            ...
            {foreach from=$manufacturer_feed_fields item=feed_field key=k_feed_field}
                <tr>
                    ...
                    <td align="center">
                        <input type="checkbox" name="admin_lock[{$k_feed_field}]"
                               value="Y"{if $feed_field.admin_lock eq "Y"} checked="checked"{/if} />
            ...
            <tr>
                <td colspan="4" align="left"><input type="submit" value="Apply changes"/></td>
            </tr>

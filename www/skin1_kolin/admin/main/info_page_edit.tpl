...
<div align="right">{include file="buttons/button.tpl" button_title=$lng.lbl_pages_list href="info_pages.php?cat={$smarty.get.cat}"}</div>

<form action="info_page.php" method="post" name="pagesform" onsubmit="javascript: return formSubmit();">

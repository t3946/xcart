...
<td><B>OUR minimum price</B></td>
    <td><B>FBA last order price</B></td>
    <td><B>Discounted product</B></td>
...
{foreach from=$fba_report item=p key=k}
   ...
   <tr {cycle values=", class='TableSubHead'"}>
	...
	<td>{$p.our_min_price}</td>
       <td>{$p.last_order_price}</td>
       <td>{$p.discounted_product}</td>
...
<tr>
<td colspan="15" align="right">Total cost to us</td>

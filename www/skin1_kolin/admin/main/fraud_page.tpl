                                ...
                                <div id="div_{$item->question_code}" style="display: none;">
                                    <table>
                                        ...
                                        {if $item->question_code eq "CHECK_OK_ORDERS_FOR_EMAIL"}
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    <tr>
                                                        <td>
                                            ...
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {$v->date|date_format:'%d-%b-%Y&nbsp; %H:%M:%S'} {$v->firstname}
                                                        </td>
                                                    </tr>
                                                {/foreach}
                                            {/if}
                                        {elseif $item->question_code eq "CHECK_DIFFERENT_SHIPPINGS_FOR_IP"}
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    {assign var=order_address value=$v->getAddressInfo()}
                                                    <tr>
                                                        <td>
                                                            <a href="{$v->getAdminUrl()}" target="_blank">{$v->getOrderNumber()}</a>
                                                        </td>
                                        ...
                                        {elseif $item->question_code eq "CHECK_DIFFERENT_BILLINGS_FOR_IP"}
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="{$v->getAdminUrl()}" target="_blank">{$v->getOrderNumber()}</a></td>
                                                        <td>{$v->date|date_format:'%d-%b-%Y&nbsp; %H:%M:%S'} {$order_address.1.address.0},
                                                            {if $order_address.1.address.1}{$order_address.1.address.1},{/if} {$v->b_city},
                                                            {$v->b_state}, {$v->b_country}, {$v->b_zipcode}
                                                        </td>
                                                    </tr>
                                                {/foreach}
                                            {/if}
                                        {elseif $item->question_code eq "CHECK_DIFFERENT_SHIPPINGS_FOR_PHONE"}
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    {assign var=order_address value=$v->getAddressInfo()}
                                                    <tr>
                                                        <td><a href="{$v->getAdminUrl()}" target="_blank">{$v->getOrderNumber()}</a></td>
                                                        <td>{$v->date|date_format:'%d-%b-%Y&nbsp; %H:%M:%S'} {$order_address.0.address.0},
                                                            {if $order_address.0.address.1}{$order_address.0.address.1},{/if} {$v->s_city},
                                                            {$v->s_state}, {$v->s_country}, {$v->s_zipcode}
                                                        </td>
                                                    </tr>
                                            ...
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    ...
                                                    <tr>
                                                        <td><a href="{$v->getAdminUrl()}" target="_blank">{$v->getOrderNumber()}</a></td>
                                                        <td>
                                                            {$v->date|date_format:'%d-%b-%Y&nbsp; %H:%M:%S'} {$order_address.1.address.0},
                                                            {if $order_address.1.address.1}{$order_address.1.address.1},{/if} {$v->b_city},
                                                            {$v->b_state}, {$v->b_country}, {$v->b_zipcode}
                                                        </td>
                                                    </tr>
                                            ...
                                            {if $fraud_result[2]}
                                                {foreach from=$fraud_result[2] key=k item=v}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {$v->date|date_format:'%d-%b-%Y&nbsp; %H:%M:%S'} {$order_address.1.address.0} ,
                                                            {if $order_address.0.address.1}{$order_address.0.address.1},{/if} {$v->b_city},
                                                            {$v->b_state}, {$v->b_country}, {$v->b_zipcode}
                                                        </td>
                                                    </tr>
                                                {/foreach}

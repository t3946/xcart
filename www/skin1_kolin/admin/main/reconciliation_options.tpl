...
You can use &lt;OR&gt; separator if the same expense account goes under more than one keyphrase.
<br />
<br />
...
<tr>
	<td valign="top" nowrap="nowrap" align="left"><b>Code</b></td>
        <td valign="top" nowrap="nowrap" width="48%" align="left"><b>Search keyphrase for expense account</b></td>
        <td valign="top" nowrap="nowrap" width="48%"><b>Expense description</b></td>
...
<td valign="top">
<input type="text"  name="Reconciliations[{$r_item.id}][code]" value="{$r_item.code}" size="5" maxlength="8" />
</td>
...
<td valign="top">
<input type="text"  name="Reconciliations[{$r_item.id}][expense_description]" value="{$r_item.expense_description}" style="width: 98%;" />
</td>

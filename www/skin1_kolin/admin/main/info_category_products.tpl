{* $Id: category_products.tpl,v 1.5.2.3 2006/07/11 08:39:26 svowl Exp $ *}
{include file="page_title.tpl" title=$lng.lbl_category_pages}
...
<tr>
<td align="right"><br />
<input type="button" value="{$lng.lbl_modify_category|strip_tags:false|escape}" onclick="javascript: self.location='info_pages.php?cat={$cat}'" />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="{$lng.lbl_delete_category|strip_tags:false|escape}" onclick="javascript: self.location='process_info_category.php?cat={$cat}&amp;mode=delete'" />
</td>
</tr>
...
{include file="main/subheader.tpl" title=$lng.lbl_category_pages}
...
<form action="process_info_pages.php" method="post" name="processproductform">
...
{include file="admin/main/info_.tpl" products=$products}
...
<input type="button" value="{$lng.lbl_delete_selected|strip_tags:false|escape}" onclick="javascript: if (checkMarks(this.form, new RegExp('productids\[[0-9]+\]', 'gi'))) if (confirm('{$lng.txt_delete_products_warning|strip_tags}')) submitForm(this, 'delete');" />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="{$lng.lbl_update|strip_tags:false|escape}" />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="{$lng.lbl_modify_selected|strip_tags:false|escape}" onclick="javascript: if (checkMarks(this.form, new RegExp('productids\[[0-9]+\]', 'gi'))) {ldelim} document.processproductform.action = 'info_page.php'; submitForm(this, 'list'); {rdelim}" />
<br /><br /><br />
...
<input type="button" value="{$lng.lbl_add_new_|strip_tags:false|escape}" onclick="javascript: self.location = 'info_page.php?categoryid={$cat}&level=E&pageid=';" />

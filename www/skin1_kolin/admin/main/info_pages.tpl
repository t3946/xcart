...
<input type="button" value="{$lng.lbl_modify_category|strip_tags:false|escape}" onclick="javascript: self.location='info_category_modify.php?cat={$cat}'" />
<input type="button" value="{$lng.lbl_category_products|strip_tags:false|escape}" onclick="javascript: self.location='info_category_products.php?cat={$cat}'" />
...
<form action="process_info_category.php" method="post" name="processcategoryform">
...
<tr class="TableHead">
	<td>{$lng.lbl_pos}</td>
	<td colspan="2">{$lng.lbl_info_page}</td>
...
<tr>
	<td colspan="6" class="SubmitBox"><input type="button" value="{$lng.lbl_add_new_|strip_tags:false|escape}" onclick="self.location='info_category_modify.php?mode=add&amp;cat={$cat}'" /></td>
</tr>

{* $Id: tax_edit.tpl,v 1.14.2.1 2006/07/11 08:39:27 svowl Exp $ *}
...
<tr>
	...
	<td width="80%"><input type="text" size="15" maxlength="10" name="tax_service_name" value="{$tax_details.tax_name}" /></td>
</tr>

<tr>
	<td class="FormButton">{$lng.lbl_tax_display_name}:</td>
	<td>&nbsp;</td>
	<td><input type="text" size="45" name="tax_display_name" value="{$tax_details.tax_display_name}" /></td>
</tr>

<tr>
	<td class="FormButton">{$lng.lbl_tax_regnumber}:</td>
	<td>&nbsp;</td>
	<td><input type="text" size="45" name="tax_regnumber" value="{$tax_details.regnumber}" /></td>
</tr>

<tr>
	<td class="FormButton">{$lng.lbl_tax_priority}:</td>
	<td>&nbsp;</td>
	<td><input type="text" size="10" name="tax_priority" value="{$tax_details.priority}" /></td>
</tr>

{* $Id: category_offers_short_list.tpl,v 1.9 2006/01/12 14:23:10 max Exp $ *}
{if $category_offers}
{math equation="floor(100/x)" x=$config.Special_Offers.offers_per_row assign="tmp_width"}
<div align="center">
<table cellpadding="5" cellspacing="0" width="95%">
{foreach name=offers from=$category_offers item=offer}
...
<tr>
	<td><a class="NavigationPath" href="offers.php?mode=cat&amp;cat={$cat}">{$lng.lbl_sp_more_info}</a></td>
	<td><a class="NavigationPath" href="offers.php?mode=cat&amp;cat={$cat}"><img src="{$ImagesDir}/offerbox_arrow.gif" alt="" /></a></td>
</tr>
</table>
&nbsp;
	</td>

...
Google and Bing content API options
<hr />
<form action="froogle.php" method="post" name="froogleform2">
<input type="hidden" name="mode" value="f_update_options" />

Enable incremental feed updates: <input type="checkbox" name="enable_incremental_feed_updates" value="Y" {if $froogle_options.enable_incremental_feed_updates eq "Y"}checked="checked"{/if} />
<br />
<table border=0 cellpadding=0 cellspacing=0>
<tr><td width=200>GoogleMerchantID:</td><td><input type="text" name="MerchantID" value="{$froogle_options.MerchantID}" /></td></tr>
<tr><td width=200>GoogleClientID:</td><td><input type="text" name="ClientID" value="{$froogle_options.ClientID}" /></td></tr>
<tr><td width=200>BingMerchantID:</td><td><input type="text" name="BingMerchantID" value="{$froogle_options.BingMerchantID}" /></td></tr>
<tr><td width=200>BingCatalogID:</td><td><input type="text" name="BingCatalogID" value="{$froogle_options.BingCatalogID}" /></td></tr>
</table>
<br />

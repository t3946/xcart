{* $Id: giftcert.tpl,v 1.52.2.3 2006/07/11 08:39:30 svowl Exp $ *}
...
<tr>
<td colspan="3"><b><font class="Green2">1. {$lng.lbl_gc_whom_sending}<br /></font></b>
...
<td align="left"><input type="text" name="purchaser" size="30" value="{if $usertype eq "A" && $smarty.get.mode eq 'add_gc'}{$config.Company.company_name}{else}{if $giftcert.purchaser}{$giftcert.purchaser|escape:"html"}{else}{$userinfo.firstname}{if $userinfo.firstname ne ''} {/if}{$userinfo.lastname}{/if}{/if}" /></td>
</tr>
...
<tr>
<td colspan="3"><b><font class="Green2"><br />2. {$lng.lbl_gc_add_message}<br /></font></b>
...
<tr>
<td colspan="3"><b><font class="Green2"><br />3. {$lng.lbl_gc_choose_amount}<br /></font></b>
...
<tr><td colspan="3"><b><font class="Green2"><br />4. {$lng.lbl_gc_choose_delivery_method}<br /><br /></font></b></td>
</tr>
...
<td><font class="Star">*</font></td>
<td align="left"><input type="text" name="recipient_firstname" size="30" value="{$giftcert.recipient_firstname}" /></td>
</tr>

<tr>
<td nowrap="nowrap" align="right">{$lng.lbl_last_name}</td>
<td><font class="Star">*</font></td>
<td align="left"><input type="text" name="recipient_lastname" size="30" value="{$giftcert.recipient_lastname}" /></td>
</tr>

<tr>
<td nowrap="nowrap" align="right">{$lng.lbl_address}</td>
<td><font class="Star">*</font></td>
<td align="left"><input type="text" name="recipient_address" size="40" value="{$giftcert.recipient_address}" /></td>
</tr>

<tr>
<td nowrap="nowrap" align="right">{$lng.lbl_city}</td>
<td><font class="Star">*</font></td>
<td align="left"><input type="text" name="recipient_city" size="30" value="{$giftcert.recipient_city}" /></td>
</tr>
...
<td><font class="Star">*</font></td>
<td align="left"><input type="text" name="recipient_zipcode" size="30" value="{$giftcert.recipient_zipcode}" onchange="javascript: check_zip_code_field(document.forms['gccreate'].recipient_country, document.forms['gccreate'].recipient_zipcode);" /></td>
</tr>

<tr>
<td nowrap="nowrap" align="right">{$lng.lbl_phone}</td>
<td></td>
<td align="left"><input type="text" name="recipient_phone" size="30" value="{$giftcert.recipient_phone}" /></td>
</tr>
...
<tr>
{if $allow_tpl}
<td id="preview_button" {if $giftcert.send_via ne "P"}style="display: none;"{/if}>{include file="buttons/button.tpl" button_title=$lng.lbl_preview href="javascript: void(formPreview());" js_to_href="Y"}</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
{/if}

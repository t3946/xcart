{*$Id: ups_import.tpl,v 1.1.2.1 2006/11/08 14:38:27 svowl Exp $*}
...
<tr{cycle values=", class='TableSubHead'"}>
	<td align="center">{if $log_item.status}<a href="order.php?orderid={$log_item.orderid}">{$log_item.order_prefix}{$log_item.orderid}</a>{else}{$log_item.order_prefix}{$log_item.orderid}{/if}</td>

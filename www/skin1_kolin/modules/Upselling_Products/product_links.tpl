...
<table>
<tr>
<td>{$lng.lbl_sku_skus}</td>
<td><input type="text" size="40" value="" name="selected_sku"></td>
</tr>

<tr>
<td>{$lng.lbl_bidirectional_link}</td>
<td><input type="checkbox" checked="checked" name="bi_directional" /></td>
</tr>
</table>
</td>

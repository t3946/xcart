...
{if $geid ne ''}<td width="15" class="TableSubHead">&nbsp;</td>{/if}
	...
	<td width="10%" class="DataTable">{$lng.lbl_pos}</td>
	<td width="30%" class="DataTable">{$lng.lbl_sku}&nbsp;&nbsp;&nbsp;</td>
	<td width="50%">{$lng.lbl_product}</td>
...
<tr{cycle values=", class='TableSubHead'"}>
	...
	<td class="DataTable"><a href="product.php?productid={ $product_links[cat_num].productid }" class="ItemsList">{ $product_links[cat_num].product|escape|truncate:70:"...":false}</a></td>
	<td class="DataTable" align="center"><input type="checkbox" name="fields[_temp]" /></td>
</tr>
{/section}

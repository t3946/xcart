...
{elseif $is_link}
  ...
  {/if}
  <div class="cidev_button{if $additional_button_class} {$additional_button_class}{/if}" title="{$title|default:$button_title|escape}" onclick="{$div_link}"{if $button_id} id="{$button_id|escape}"{/if}>
...
{elseif $style eq 'dropout'}
  ...
  <div class="dropout-wrapper">
    <div class="dropout-container">
      <div class="cidev_button{if $additional_button_class} {$additional_button_class}{/if}" title="{$title|default:$button_title|escape}" id="dropout_btn_{$prefix|default:'dropout'}_{$dropout_id}">
...
{elseif $style eq 'div_button'}
  ...
  <div class="cidev_button{if $additional_button_class} {$additional_button_class}{/if}" title="{$title|default:$button_title|escape}"{if $js_link} onclick="{$js_link}"{/if}{if $button_id} id="{$button_id|escape}"{/if}>
    <div{$reading_direction_tag}>{$button_title|amp}</div>
  </div>

{else}

  <button class="cidev_button{if $additional_button_class} {$additional_button_class}{/if}" type="{if $type eq 'input'}submit{else}button{/if}" title="{$title|default:$button_title|escape}"{if $js_link} onclick="{$js_link}"{/if}{if $button_id} id="{$button_id|escape}"{/if}>
  {strip}
    <span class="cidev_button-right">
      <span class="cidev_button-left"{$reading_direction_tag}>{$button_title|amp}</span>
    </span>
  {/strip}
  </button>

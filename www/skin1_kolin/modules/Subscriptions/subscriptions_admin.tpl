{* $Id: subscriptions_admin.tpl,v 1.21.2.3 2006/07/20 05:43:09 max Exp $ *}
...
<tr>
	...
	<td height="10"><input type="text" name="search_productid" size="10" value="{$smarty.get.search_productid}" /></td>
</tr>

<tr>
	<td height="10" class="FormButton" nowrap="nowrap">{$lng.lbl_product_title}:</td>
	<td width="10" height="10"></td>
	<td height="10"><input type="text" name="search_producttitle" size="40" value="{$smarty.get.search_producttitle}" /></td>
</tr>

<tr>
	<td height="10" class="FormButton" nowrap="nowrap">{$lng.lbl_customer_login}:</td>
	<td width="10" height="10"></td>
	<td height="10"><input type="text" name="search_customerlogin" size="20" value="{$smarty.get.search_customerlogin}" /></td>
</tr>
...
<tr>
	...
	(<a href="javascript: void(0);" onclick="javascript: window.open('calendar.php?productid={$subscriptions_info[sub].productid}','calendar','width=600,height=500,toolbar=no,status=no,scrollbars=yes,resizable=no,menubar=no,location=no,direction=no');">{$subscriptions_info[sub].next_pay_date}</a>): 
...
<a href="{$catalogs.admin}/process_user.php?mode=update&user={$subscriptions_info[sub].customers[sub1].login}&usertype=C">{$subscriptions_info[sub].customers[sub1].login}</a>
	</td>

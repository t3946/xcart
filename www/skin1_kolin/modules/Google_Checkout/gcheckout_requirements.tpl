{* $Id: gcheckout_requirements.tpl,v 1.1.2.3 2007/01/12 09:17:48 svowl Exp $ *}
...
<input type="button" name="test_callback_url" value="{$lng.lbl_gcheckout_test_callback_url}" onclick="javascript: self.location='test_gcheckout.php?mode=test_callback'"  />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" name="test_gc" value="{$lng.lbl_gcheckout_test_gc}" onclick="javascript: self.location='test_gcheckout.php?mode=test_gc'"  />

{* $Id: extra_fields.tpl,v 1.28.2.3 2006/07/11 08:39:30 svowl Exp $ *}
...
<tr{cycle values=", class='TableSubHead'"}>
	...
	<td><input type="text" name="posted_data[{$id}][service_name]" maxlength="32" size="15" value="{$field.service_name}" /></td>
...
{if $count_extra_fields lt $config.Extra_Fields.extra_fields_limit}

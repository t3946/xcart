...
{* <br> *}
{*
<h3><center>{$lng.lbl_place_order}</center></h3>
*}
{*
{capture name=dialog}
*}
...
<div align="left">{include file="customer/buttons/button.tpl" button_title=$lng.lbl_change_payment_method href="cart.php?mode=checkout"}</div>
<br />
{/if}
...
{include file="customer/main/subheader.tpl" title="`$payment_data.payment_method` details"}
...
<div align="left">{include file="customer/buttons/button.tpl" href="register.php?mode=update&amp;action=cart&amp;paymentid=`$smarty.get.paymentid`" button_title="Modify"}</div>


{* --- *}
{if $payment_data.payment_template ne "customer/main/payment_giftcert.tpl" && $payment_data.payment_template ne "customer/main/payment_po.tpl"}
<br /><br />
{include file="customer/main/subheader.tpl" title="`$lng.lbl_payment_method`: `$payment_data.payment_method`"}
{if $ignore_payment_method_selection eq ""}
<div align="left">{include file="customer/buttons/button.tpl" button_title=$lng.lbl_change_payment_method href="cart.php?mode=checkout"}</div>
...
<br />
<br />
{include file="customer/main/subheader.tpl" title=$lng.lbl_customer_notes}
<table cellspacing="0" cellpadding="0" width="100%">
<tr>
{* <td width="20"><img src="{$ImagesDir}/spacer.gif" width="20" height="1" alt="" /></td> *}
<td>
...
<input type="hidden" name="is_mobile_checkout" value="Y" />
<center>
...
{else}
{include file="customer/buttons/button.tpl" button_title=$lng.lbl_submit_order style="button" href=$button_href b=1 button_type="submit_order" data_theme="b"}
<br /><font style="color: #000000"><I>{$lng.lbl_continue_checkout_3}</I></font>
{/if}
...
{else}
{include file="submit_wo_js.tpl" value=$lng.lbl_submit_order b=1}
{/if}

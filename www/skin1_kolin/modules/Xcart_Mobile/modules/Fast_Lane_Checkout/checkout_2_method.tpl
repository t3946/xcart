...
<div align="center">
{include file="customer/buttons/button.tpl" button_title="Continue" type="input" data_theme="b"}
</div>
...
<br />
	...
	<div align="center" id="continue_btn_able">
		{include file="customer/buttons/button.tpl" button_title="continue" style="button" href="javascript: document.cartform.submit()" b=1 button_type="continue"}

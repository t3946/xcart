...
{if $featured eq "Y"}
<font style="font-size: 20px; font-weight: bold;">Pages:</font>&nbsp;&nbsp;&nbsp;&nbsp;
{/if}
...
{if $navigation_page gt 1}
	...
	{include file="customer/buttons/button.tpl" href=$cidev_navigation_script_1 button_title="previous" data_theme="b"}
...
{*	<span class="b-paginator-item g-current js-paginator-page-current">{%page.index%}</span> *}

{include file="customer/buttons/button.tpl" button_title=%page.index% }
...
{*	<a class="b-paginator-item" href="{$cidev_navigation_script_2}">{%page.index%}</a> *}

	{include file="customer/buttons/button.tpl" href=$cidev_navigation_script_2 button_title=%page.index% data_theme="b"}
...
{if $navigation_page lt $total_super_pages*$navigation_max_pages}
        ...
        {if $navigation_page ne $total_pages_minus}
                ...
                {include file="customer/buttons/button.tpl" href=$cidev_navigation_script_3 button_title="next" data_theme="b"}

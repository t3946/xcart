      ...
      $.event.special.orientationchange,
      {
        ...
        add: function (handleObj) {
          ...
          handleObj.handler = function (event) {
            ...
            // сall the originally-bound event handler and return its result.
...
*/
        ...
        if (!(query in cache)) {
          var styleBlock = document.createElement("style"),
            cssrule =
              "@media " +
              query +
              " { #jquery-mediatest { position:absolute; } }";
  ...
  (function ($, undefined) {
    ...
    function transform3dTest() {
      ...
      return (
        validStyle("perspective", "10px", "moz") ||
        $.mobile.media(
          "(-" +
            vendors.join("-" + prop + "),(-") +
            "-" +
    ...
    $.extend($.support, {
      cssTransitions:
        ...
        (validStyle("transition", "height 100ms linear") && !opera),
  ...
  (function ($, undefined) {
    $.widget("mobile.page", $.mobile.widget, {
      ...
      removeContainerBackground: function () {
        $.mobile.pageContainer.removeClass(
          "ui-overlay-" + $.mobile.getInheritedTheme(this.element.parent())
        );
      },
      ...
      setContainerBackground: function (theme) {
        if (this.options.theme) {
          $.mobile.pageContainer.addClass(
            "ui-overlay-" + (theme || this.options.theme)
          );
        }
      },
  ...
  */
      ...
      return function (name, reverse, $to, $from) {
        var deferred = new $.Deferred(),
          ...
          none =
            ...
            !name ||
            name === "none" ||
            Math.max($(window).scrollTop(), toScroll) >
  ...
  (function ($, undefined) {
    ...
    var $window = $(window),
      ...
      path = {
        ...
        isFirstPageUrl: function (url) {
          ...
          var u = path.parseUrl(path.makeUrlAbsolute(url, documentBase)),
            ...
            samePath =
              u.hrefNoHash === documentUrl.hrefNoHash ||
              (documentBaseDiffers && u.hrefNoHash === documentBase.hrefNoHash),
      ...
      urlHistory = {
        ...
        clearForward: function () {
          urlHistory.stack = urlHistory.stack.slice(
            0,
        ...
        directHashChange: function (opts) {
          ...
          $.each(urlHistory.stack, function (i, historyEntry) {
            ...
            if (
              decodeURIComponent(opts.currentUrl) ===
              decodeURIComponent(historyEntry.url)
            ) {
          ...
          this.activeIndex =
            newActiveIndex !== undefined ? newActiveIndex : this.activeIndex;
          if (back) {
      ...
      documentBase = $base.length
        ? path.parseUrl(
            path.makeUrlAbsolute($base.attr("href"), documentUrl.href)
          )
        : documentUrl,
    ...
    function removeActiveLinkClass(forceRemoval) {
      if (
        !!$activeClickedLink &&
        (!$activeClickedLink.closest("." + $.mobile.activePageClass).length ||
          forceRemoval)
      ) {
    ...
    setLastScroll = function () {
      ...
      if (active) {
        ...
        active.lastScroll =
          lastScroll < $.mobile.minScrollBack
    ...
    function transitionPages(toPage, fromPage, transition, reverse) {
      ...
      var th =
          $.mobile.transitionHandlers[transition || "default"] ||
      ...
      promise.done(function () {
        ...
        toPage
          .data("page")
          ._trigger("show", null, { prevPage: fromPage || $("") });
      });
      return promise;
    }
    ...
    function resetActivePageHeight() {
      ...
      aPage.css(
        "min-height",
        getScreenHeight() - aPagePadT - aPagePadB - aPageBorderT - aPageBorderB
      );
    }
    ...
    $.mobile._bindPageRemove = function () {
      ...
      if (
        !page.data("page").options.domCache &&
    ...
    $.mobile.loadPage = function (url, options) {
      ...
      var deferred = $.Deferred(),
        ...
        findBaseWithDefault = function () {
          var closestBase =
            $.mobile.activePage && getClosestBaseUrl($.mobile.activePage);
      ...
      page = settings.pageContainer.children(
        "[data-" + $.mobile.ns + "url='" + dataUrl + "']"
      );
        ...
        $.ajax({
          ...
          success: function (html, textStatus, xhr) {
            ...
            page
              .attr(
                "data-" + $.mobile.ns + "url",
                path.convertUrlToDataUrl(fileUrl)
              )
    ...
    $.mobile.changePage = function (toPage, options) {
      ...
      var fromPage = settings.fromPage,
        url =
          (settings.dataUrl && path.convertUrlToDataUrl(settings.dataUrl)) ||
          toPage.jqmData("url"),
    ...
    $.mobile.navreadyDeferred.done(function () {
      ...
      $.mobile._handleHashChange = function (hash) {
        ...
        var to = path.stripHash(hash),
          ...
          transition =
            $.mobile.urlHistory.stack.length === 0 ? "none" : undefined,
        ...
        if (to) {
          ...
          to =
            typeof to === "string" && !path.isPath(to)
              ? path.makeUrlAbsolute("#" + to, documentBase)
              : to;
          ...
          if (
            to ===
              path.makeUrlAbsolute("#" + urlHistory.initialDst, documentBase) &&
            urlHistory.stack.length &&
            urlHistory.stack[0].url !==
              urlHistory.initialDst.replace(dialogHashKey, "")
          ) {
            to = $.mobile.firstPage;
          }
    ...
    $.extend(pushStateHandler, {
      ...
      state: function () {
        return {
          ...
          hash:
            $.mobile.path.parseLocation().hash || "#" + self.initialFilePath,
      ...
      onHashChange: function (e) {
        ...
        var href,
          ...
          resolutionUrl = isPath
            ? $.mobile.path.getLocation()
            : $.mobile.getDocumentUrl();
  ...
  (function ($, window, undefined) {
    $.widget("mobile.dialog", $.mobile.widget, {
      ...
      _create: function () {
		...
		*/
        $el
          .bind("vclick submit", function (event) {
      ...
      $(
        ...
        .each(function () {
          var $this = $(this),
            ...
            contentTheme =
              theme || o.contentTheme || (pageRole === "dialog" && pageTheme),
            $headeranchors,
            leftbtn,
            rightbtn,
            backBtn;
          ...
          if (role === "header" || role === "footer") {
            var thisTheme =
              theme ||
              (role === "header" ? o.headerTheme : o.footerTheme) ||
              pageTheme;
            $this
              //add theme class
            ...
            if (
              ...
              backBtn = $(
                ...
                .attr(
                  "data-" + $.mobile.ns + "theme",
                  o.backBtnTheme || thisTheme
                )
                .prependTo($this);
            }
            // Page title
  ...
  (function ($, undefined) {
    ...
    //auto self-init widgets
    $(document).bind("pagecreate create", function (e) {
      $(":jqmData(role='fieldcontain')", e.target)
        .jqmEnhanceable()
        .fieldcontain();
    });
  })(jQuery);
      ...
      for (var i = 0; i < $workingSet.length; i++) {
        var el = $workingSet.eq(i),
          ...
          o = $.extend(
            ...
            {
              icon:
                options.icon !== undefined ? options.icon : el.jqmData("icon"),
              iconpos:
              ...
              theme:
                options.theme !== undefined
                  ? options.theme
                  : el.jqmData("theme") || $.mobile.getInheritedTheme(el, "c"),
              inline:
              ...
              mini:
                options.mini !== undefined ? options.mini : el.jqmData("mini"),
            },
            options
          ),
          // Classes Defined
        ...
        buttonElements = $.data(
          e.tagName === "INPUT" || e.tagName === "BUTTON" ? e.parentNode : e,
          "buttonElements"
        );
        if (buttonElements) {
    ...
    var attachEvents = function () {
      ...
      $(document).bind({
        "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart":
          function (event) {
            var theme,
              ...
              isTouchEvent =
                event.originalEvent && /^touch/.test(event.originalEvent.type),
              evt = event.type;
            if ($btn.length) {
        ...
        "focusout blur": function (event) {
          $(closestEnabledButton(event.target)).removeClass(
            $.mobile.focusClass
          );
        },
      });
    ...
    $.widget("mobile.collapsible", $.mobile.widget, {
      ...
      _create: function () {
        ...
        if (collapsibleHeading.is("legend")) {
          collapsibleHeading = $(
            "<div role='heading'>" + collapsibleHeading.html() + "</div>"
        ...
        if (collapsibleSet.length) {
          ...
          if (!o.theme) {
            o.theme =
              collapsibleSet.jqmData("theme") ||
              $.mobile.getInheritedTheme(collapsibleSet, "c");
          }
        ...
        collapsibleContent.addClass(
          o.contentTheme ? "ui-body-" + o.contentTheme : ""
        );
        collapsedIcon =
          $el.jqmData("collapsed-icon") || o.collapsedIcon || "plus";
        expandedIcon =
          $el.jqmData("expanded-icon") || o.expandedIcon || "minus";
        collapsibleHeading
          ...
          .bind("expand collapse", function (event) {
            if (!event.isDefaultPrevented()) {
              ...
              collapsibleHeading
                ...
                .toggleClass(
                  "ui-icon-" + collapsedIcon,
                  isCollapse || expandedIcon === collapsedIcon
                )
                .end()
                .find("a")
                .first()
              ...
              if (
                contentTheme &&
                !!o.inset &&
                (!collapsibleSet.length ||
                  collapsible.jqmData("collapsible-last"))
              ) {
                collapsibleHeading
                  .find("a")
                  .first()
                  .add(collapsibleHeading.find(".ui-btn-inner"))
        ...
        collapsibleHeading
          ...
          .bind("click", function (event) {
            var type = collapsibleHeading.is(
    ...
    $.widget("mobile.collapsibleset", $.mobile.widget, {
          ...
          $el
            ...
            .bind("expand", function (event) {
              ...
              if (
                closestCollapsible
                  .parent()
                  .is(":jqmData(role='collapsible-set')")
              ) {
                closestCollapsible
      ...
      refresh: function () {
        var $el = this.element,
          o = this.options,
          collapsiblesInSet = $el.children(":jqmData(role='collapsible')");
        $.mobile.collapsible.prototype.enhance(
          collapsiblesInSet.not(".ui-collapsible")
        );
        // clean up borders
        if (!!o.inset) {
          collapsiblesInSet.each(function () {
            $(this)
              .jqmRemoveData("collapsible-last")
              .find(".ui-collapsible-heading")
              .find("a")
              .first()
  ...
  (function ($, undefined) {
    ...
    $.widget("mobile.listview", $.mobile.widget, {
      ...
      _refreshCorners: function (create) {
        ...
        $visibleli =
          create || $li.filter(":visible").length === 0
        ...
        if (this.options.inset) {
          ...
          $bottomli
            .add($bottomli.find(".ui-btn-inner"))
            .find(".ui-li-link-alt")
      ...
      refresh: function (create) {
        ...
        for (var pos = 0, numli = li.length; pos < numli; pos++) {
          ...
          if (create || !item.hasClass("ui-li")) {
            ...
            if (a.length && !isDivider) {
              ...
              item.buttonMarkup({
                ...
                iconpos: "right",
                icon:
                  a.length > 1 || icon === false ? false : icon || "arrow-r",
                theme: itemTheme,
              });
              ...
              if (a.length > 1) {
                ...
                last = a.last();
                splittheme =
                  listsplittheme || last.jqmData("theme") || o.splitTheme;
          ...
          if (ol && jsCount && itemClass.indexOf("ui-li-divider") < 0) {
            countParent =
              itemClass.indexOf("ui-li-static") > 0
                ? item
        ...
        $list
          ...
          .addClass(
            "ui-btn-up-" +
              ($list.jqmData("counttheme") || this.options.countTheme) +
              " ui-btn-corner-all"
          );
        ...
        $(parentList.find("li>ul, li>ol").toArray().reverse())
          .each(function (i) {
            var self = this,
              ...
              id =
                (parentUrl || "") + "&" + $.mobile.subPageUrlKey + "=" + listId,
              theme = list.jqmData("theme") || o.theme,
              countTheme =
                list.jqmData("counttheme") ||
        ...
        if (
          ...
          var newRemove = function (e, ui) {
            ...
            if (ui.nextPage) {
              ...
              if (
                npURL.indexOf(parentUrl + "&" + $.mobile.subPageUrlKey) !== 0
              ) {
      ...
      childPages: function () {
        ...
        return $(
          ":jqmData(url^='" + parentUrl + "&" + $.mobile.subPageUrlKey + "')"
        );
      },
    });
    //auto self-init widgets
    ...
    $.widget("mobile.checkboxradio", $.mobile.widget, {
      ...
      _create: function () {
        var self = this,
          ...
          icon = input.parents(":jqmData(type='horizontal')").length
            ? undefined
            : uncheckedState,
        ...
        label.bind({
          ...
          vclick: function (event) {
            ...
            input.prop(
              "checked",
              (inputtype === "radio" && true) || !input.prop("checked")
            );
  ...
  (function ($, undefined) {
    $.widget("mobile.button", $.mobile.widget, {
      ...
      refresh: function () {
        ...
        $(this.button.data("buttonElements").text)[
          $el.html() ? "html" : "text"
        ]($el.html() || $el.val());
      },
    });
  ...
  (function ($, undefined) {
    $.fn.controlgroup = function (options) {
      function flipClasses(els, flCorners) {
        els
          .removeClass(
            "ui-btn-corner-all ui-corner-top ui-corner-bottom ui-corner-left ui-corner-right ui-controlgroup-last ui-shadow"
          )
          .eq(0)
      ...
      return this.each(function () {
        ...
        $el.addClass(
          "ui-corner-all ui-controlgroup ui-controlgroup-" + o.direction
        );
        flipClasses(
          $el
            .find(".ui-btn" + (o.excludeInvisible ? ":visible" : ""))
  ...
  (function ($, undefined) {
    function fitSegmentInsideSegment(winSize, segSize, offset, desired) {
      ...
      if (winSize < segSize) {
        ...
        ret = Math.min(
          Math.max(offset, desired - segSize / 2),
          offset + winSize - segSize
        );
      }
      return ret;
    }
    ...
    $.widget("mobile.popup", $.mobile.widget, {
          ...
          this._ui.container
            ...
            .offset(
              this._placementCoords(
                this._desiredCoords(undefined, undefined, "window")
              )
            );
          this._resizeScreen();
      ...
      _create: function () {
        var ui = {
            ...
            container: $(
              "<div class='ui-popup-container ui-selectmenu-hidden'></div>"
            ),
          },
        ...
        this.options.container =
          this.options.container || $.mobile.pageContainer;
        // Apply the proto
      ...
      _applyTheme: function (dst, theme, prefix) {
        ...
        while (classes.length > 0) {
          ...
          matches = new RegExp("^ui-" + prefix + "-([a-z])$").exec(
            currentTheme
          );
      ...
      _setOption: function (key, value) {
        var exclusions,
          setter = "_set" + key.charAt(0).toUpperCase() + key.slice(1);
      ...
      _open: function (options) {
        ...
        coords = this._placementCoords(
          this._desiredCoords(
            options.x,
            options.y,
            options.positionTo || this.options.positionTo || "origin"
          )
        );
        ...
        if (!this.options.theme) {
          this._setTheme(
            this._page.jqmData("theme") ||
              $.mobile.getInheritedTheme(this._page, "c")
          );
        }
      ...
      _bindContainerClose: function () {
        var self = this;
        self.options.container.one(
          self.options.closeEvents,
      ...
      open: function (options) {
        ...
        if (!opts.history) {
          ...
          self.element.delegate(
            opts.closeLinkSelector,
            opts.closeLinkEvents,
            function (e) {
              self._close();
  ...
  (function ($, undefined) {
    $.widget("mobile.textinput", $.mobile.widget, {
      ...
      _create: function () {
        ...
        if (
          typeof input[0].autocorrect !== "undefined" &&
        ...
        if (input.is("[type='search'],:jqmData(type='search')")) {
          ...
          input.addClass(
            "ui-corner-all ui-shadow-inset" + themeclass + miniclass
          );
        }
        input
          .focus(function () {
      ...
      disable: function () {
        ...
        if (
          this.element
            .attr("disabled", true)
            .is("[type='search'], :jqmData(type='search')")
        ) {
              ...
              if (val) {
                ...
                for (var i = listItems.length - 1; i >= 0; i--) {
                  ...
                  if (item.is("li:jqmData(role=list-divider)")) {
                    ...
                    listview.options.filterCallback(itemtext, val, item)
                  ) {
                    //mark to be hidden
    ...
    $.widget("mobile.slider", $.mobile.widget, {
      ...
      _create: function () {
        ...
        var self = this,
          ...
          inlineClass =
            this.options.inline || control.jqmData("inline") === true
              ? " ui-slider-inline"
              : "",
          miniClass =
          ...
          slider = $(domSlider),
          valuebg =
            control.jqmData("highlight") && cType !== "select"
              ? (function () {
        ...
        if (cType === "select") {
          ...
          for (
            var j = 0, length = domSlider.childNodes.length;
            j < length;
            j++
          ) {
          ...
          for (
            var i = 0, optionsCount = options.length;
            i < optionsCount;
            i++
          ) {
            var side = !i ? "b" : "a",
      ...
      refresh: function (val, isfromControl, preventInputUpdate) {
        ...
        var control = this.element,
          ...
          max =
            cType === "input"
              ...
              : control.find("option").length - 1,
          step =
            cType === "input" && parseFloat(control.attr("step")) > 0
        ...
        if (typeof val === "object") {
          ...
          percent = Math.round(
            ((data.pageX - this.slider.offset().left) / this.slider.width()) *
              100
          );
        } else {
          if (val == null) {
        ...
        this.handle.attr({
          "aria-valuenow":
            cType === "input"
              ? newval
              : control.find("option").eq(newval).attr("value"),
          "aria-valuetext":
            cType === "input"
              ? newval
              : control.find("option").eq(newval).getEncodedText(),
          title:
            cType === "input"
              ? newval
              : control.find("option").eq(newval).getEncodedText(),
  ...
  (function ($, undefined) {
    $.widget("mobile.selectmenu", $.mobile.widget, {
      ...
      _preExtension: function () {
        ...
        this.select = this.element.wrap(
          "<div class='ui-select" + classes + "'>"
        );
        this.selectID = this.select.attr("id");
        this.label = $("label[for='" + this.selectID + "']").addClass(
          "ui-select"
        );
  ...
  (function ($, undefined) {
    var extendSelect = function (widget) {
      var select = widget.select,
        ...
        listbox = $("<div>", { class: "ui-selectmenu" })
  ...
  (function ($, undefined) {
    $.widget("mobile.fixedtoolbar", $.mobile.widget, {
      options: {
        ...
        tapToggle: true,
        tapToggleBlacklist:
          "a, button, input, select, textarea, .ui-header-fixed, .ui-footer-fixed, .ui-popup",
      ...
      _bindPageEvents: function () {
        ...
        $el
          ...
          .bind(
            "webkitAnimationStart animationstart updatelayout",
            function () {
              var thisPage = this;

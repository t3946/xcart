...
<div align="left">{include file="buttons/button.tpl" button_title=$lng.lbl_change_payment_method href="cart.php?mode=checkout"}</div>
<br />
{/if}
...
<div align="left">{include file="buttons/modify.tpl" href="register.php?mode=update&amp;action=cart&amp;paymentid=`$smarty.get.paymentid`"}</div>
...
<input type="hidden" name="is_mobile_checkout" value="N" />
<center>
...
{else}
{include file="buttons/button.tpl" button_title=$lng.lbl_submit_order style="button" href=$button_href b=1 button_type="submit_order"}

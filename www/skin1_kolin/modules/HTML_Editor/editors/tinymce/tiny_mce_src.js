  ...
  var tinymce = {
    ...
    _init: function () {
      ...
      function getBase(n) {
        if (
          n.src &&
          /tiny_mce(|_gzip|_jquery|_prototype)(_dev|_src)?.js/.test(n.src)
        ) {
...
(function () {
  ...
  tinymce.create("tinymce.util.URI", {
    URI: function (u, s) {
      ...
      if (
        /^(mailto|tel|news|javascript|about|data):/i.test(u) ||
        /^\s*#/.test(u)
      ) {
        t.source = u;
        return;
...
(function (tinymce) {
  ...
  var each = tinymce.each,
    ...
    isIE = tinymce.isIE,
    blockRe =
      /^(H[1-6R]|P|DIV|ADDRESS|PRE|FORM|T(ABLE|BODY|HEAD|FOOT|H|R|D)|LI|OL|UL|CAPTION|BLOCKQUOTE|CENTER|DL|DT|DD|DIR|FIELDSET|NOSCRIPT|MENU|ISINDEX|SAMP)$/,
    boolAttrs = makeMap(
  ...
  function makeMap(str) {
    ...
    str = str.split(",");
    for (i = str.length; i >= 0; i--) map[str[i]] = 1;
  ...
  tinymce.create("tinymce.dom.DOMUtils", {
    ...
    select: function (pa, s) {
      ...
      return tinymce.dom.Sizzle(
        pa,
        t.get(s) || t.get(t.settings.root_element) || t.doc,
        []
      );
    },
    ...
    is: function (n, selector) {
      ...
      if (n.length === undefined) {
        // Simple all selector
        if (selector === "*") return n.nodeType == 1;
      ...
      return (
        tinymce.dom.Sizzle.matches(selector, n.nodeType ? [n] : n).length > 0
      );
    },
      ...
      return this.run(e, function (e) {
        ...
        switch (n) {
          case "style":
            ...
            if (s.keep_values) {
              if (v && !t._isRes(v)) e.setAttribute("_mce_style", v, 2);
              else e.removeAttribute("_mce_style", 2);
            }
      ...
      return this.run(e, function (e) {
        ...
        if (isIE) {
          ...
          if (x) {
            ...
            h = h.replace(/<p ([^>]+)>|<p>/gi, '<div $1 _mce_tmp="1">');
    ...
    processHTML: function (h) {
      ...
      if (isIE) {
        ...
        h = h.replace(
          ...
          ""
        ); // IE doesn't handle default values correct
      }
      ...
      if (s.keep_values) {
        ...
        if (/<script|noscript|style/i.test(h)) {
          ...
          h = h.replace(
            ...
            function (v, attribs, text) {
              // Force type attribute
              if (!attribs) attribs = ' type="text/javascript"';
        ...
        function processTags(html) {
          return html.replace(
            tagRegExp,
            function (match, elm_name, attrs, end) {
              return (
                "<" +
                elm_name +
                attrs.replace(
                  ...
                  function (match, name, value, val2, val3) {
                    ...
                    if (
                      ...
                      if (name == "style")
                        mceValue = t.serializeStyle(
                          t.parseStyle(mceValue),
                          name
                        );
    ...
    split: function (pe, e, re) {
      ...
      function trim(node) {
        ...
        if (node.nodeType != 9) {
          ...
          if (node.nodeType == 3 && node.nodeValue.length > 0) return;
...
(function (ns) {
  ...
  function Range(dom) {
    ...
    function compareBoundaryPoints(h, r) {
      ...
      if (h === 0) return _compareBoundaryPoints(sc, so, sc, so);

      // Check START_TO_END
      if (h === 1) return _compareBoundaryPoints(sc, so, ec, eo);

      // Check END_TO_END
      if (h === 2) return _compareBoundaryPoints(ec, eo, ec, eo);

      // Check END_TO_START
      if (h === 3) return _compareBoundaryPoints(ec, eo, sc, so);
    }
  ...
  function Selection(selection) {
    ...
    function getRange() {
      ...
      function findEndPoint(start) {
        ...
        position = ieRange.compareEndPoints(
    ...
    this.addRange = function (rng) {
      ...
      if (ec.nodeType == 1 && ec.hasChildNodes()) {
        ...
        if (eo == 0) {
          ...
          if (ec.nodeType == 3) eo = ec.nodeValue.length;
        }
      }
      ...
      if (sc.nodeType == 3) {
        ...
        if (skipStart) dom.insertAfter(marker, sc);
        else sc.parentNode.insertBefore(marker, sc);
        ...
        if (so > 0) ieRng.move("character", so);
      } else {
        ieRng.moveToElementText(sc);

        if (skipStart) ieRng.collapse(FALSE);
      }
    ...
    this.getRangeAt = function () {
      ...
      if (
        !range ||
        !tinymce.dom.RangeUtils.compareRanges(lastIERng, selection.getRng())
      ) {
        range = getRange();
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.dom.Selection", {
      ...
      if (rng.duplicate || rng.item) {
        ...
        if (!collapsed) {
          ...
          rng2.insertNode(
            dom.create(
              "span",
              { _mce_type: "bookmark", id: id + "_end", style: styles },
              chr
            )
          );
        }
        ...
        rng.insertNode(
          dom.create(
            "span",
            { _mce_type: "bookmark", id: id + "_start", style: styles },
            chr
          )
        );
      }
    ...
    moveToBookmark: function (bookmark) {
      ...
      if (t.tridentSel) t.tridentSel.destroy();
          ...
          function setEndPoint(start) {
            ...
            if (point) {
              ...
              for (node = root, i = point.length - 1; i >= 1; i--) {
                ...
                if (children.length) node = children[point[i]];
              }

              // Set offset within container node
              if (start) rng.setStart(node, point[0]);
              else rng.setEnd(node, point[0]);
            }
          }
  ...
  tinymce.create("tinymce.dom.Serializer", {
    ...
    serialize: function (n, o) {
      ...
      if (
        ...
        if (n.nodeName != "BODY") n = doc.body.firstChild;
        else n = doc.body;
    ...
    _serializeNode: function (n, inner) {
      ...
      if (!s.node_filter || s.node_filter(n)) {
        switch (n.nodeType) {
          case 1: // Element
            if (
              n.hasAttribute
                ? n.hasAttribute("_mce_bogus")
                : n.getAttribute("_mce_bogus")
            )
              return;
            ...
            if (isIE) {
              ...
              if (s.fix_content_duplication) {
                if (n._mce_serialized == t.key) return;
            ...
            // Keep type attribute
            if (type && keep) w.writeAttribute("_mce_type", type);
            ...
            if (nn === "script" && tinymce.trim(n.innerHTML)) {
              ...
              w.writeCDATA(
                n.innerHTML.replace(/<!--|-->|<\[CDATA\[|\]\]>/g, "")
              ); // Remove comments and cdata stuctures
              hc = false;
              break;
            }
            ...
            if (ru.padd) {
              ...
              if (
                ...
                if (
                  cn.hasAttribute
                    ? cn.hasAttribute("_mce_bogus")
                    : cn.getAttribute("_mce_bogus")
                )
                  w.writeText("\u00a0");
              } else if (!hc) w.writeText("\u00a0"); // No children then padd it
            }
          ...
          case 3: // Text
            ...
            if (
              s.validate_children &&
              t.elementName &&
              !t.schema.isValid(t.elementName, "#text")
            )
              return;
      ...
      // Write element end
      if (!iv) {
        if (!closed) w.writeFullEndElement();
...
(function () {
  ...
  function unpack(lookup, data) {
    ...
    replace(data)
      .replace(/#/g, "#text")
      .replace(/(\w+)\[([^\]]+)\]/g, function (str, name, children) {
        var i,
          map = {};

        children = children.split(/\|/);

        for (i = children.length - 1; i >= 0; i--) map[children[i]] = 1;
  ...
  tinymce.EditorManager = extend(tinymce, {
    ...
    init: function (s) {
      ...
      Event.add(document, "init", function () {
        ...
        // сall onInit when all editors are initialized
        if (s.oninit) {
          l = co = 0;
...
(function (tinymce) {
  ...
  tinymce.create("tinymce.Editor", {
      ...
      if (s.custom_undo_redo) {
        ...
        t.onBeforeExecCommand.add(function (ed, cmd, ui, val, a) {
          if (
            ...
            if (!t.undoManager.hasUndo()) t.undoManager.add();
          }
        });
    ...
    nodeChanged: function (o) {
      var t = this,
        s = t.selection,
        n = (isIE ? s.getNode() : s.getStart()) || t.getBody();
    ...
    _addEvents: function () {
      ...
      each(lo, function (v, k) {
        switch (k) {
          case "contextmenu":
            ...
            } else t.dom.bind(t.getBody(), k, eventHandler);
            break;
      ...
      if (tinymce.isWebKit) {
        t.onClick.add(function (ed, e) {
          ...
          if (
            e.nodeName == "IMG" ||
            (e.nodeName == "A" && t.dom.hasClass(e, "mceItemAnchor"))
          )
      ...
      if (tinymce.isIE) {
        ...
        t.dom.bind(t.getDoc(), "controlselect", function (e) {
          ...
          if (re) t.dom.unbind(re.node, re.ev, re.cb);
    ...
    addCommands({
      ...
      "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (command) {
        ...
        each("left,center,right,full".split(","), function (name) {
          if (align != name) editor.formatter.remove("align" + name);
        });
      ...
      mceInsertRawHTML: function (command, ui, value) {
        ...
        editor.setContent(
          editor.getContent().replace(/tiny_mce_marker/g, value)
        );
      },
      ...
      mceInsertLink: function (command, ui, value) {
        ...
        if (tinymce.is(value, "string")) value = { href: value };
        ...
        if (!link) {
          ...
          if (value.href) dom.setAttribs(link, value);
          else editor.dom.remove(link, TRUE);
        }
      },
    ...
    return (self = {
      ...
      add: function (level) {
        ...
        if (lastLevel && lastLevel.content == level.content) {
          if (index > 0 || data.length == 1) return null;
        }
  ...
  tinymce.create("tinymce.ForceBlocks", {
    ...
    forceRoots: function (ed, e) {
      ...
      for (i = nl.length - 1; i >= 0; i--) {
        ...
        } else bl = null; // Time to create new block
      }
...
(function (tinymce) {
  tinymce.Formatter = function (ed) {
    ...
    function toggle(name, vars, node) {
      if (match(name, vars, node)) remove(name, vars, node);
        ...
        function findSelectorEndPoint(container, sibling_name) {
          ...
          for (i = 0; i < parents.length; i++) {
            for (y = 0; y < format.length; y++) {
              if (dom.is(parents[i], format[y].selector)) return parents[i];
            }
          }
      ...
      if (format.remove != "all") {
        ...
        each(format.attributes, function (value, name) {
          ...
          if (!compare_node || isEq(dom.getAttrib(compare_node, name), value)) {
            ...
            if (MCE_ATTR_RE.test(name)) node.removeAttribute("_mce_" + name);
    ...
    function isBookmarkNode(node) {
      return (
        node &&
        node.nodeType == 1 &&
        node.getAttribute("_mce_type") == "bookmark"
      );
    }
            ...
            function (event) {
              ed[event].addToTop(function (ed, e) {
                ...
                if (
                  ...
                  if (e.type == "keyup" || e.type == "mouseup") resetPending();
                }
              });
            }
          );

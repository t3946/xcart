...
{if !empty($order.refund_groups[$manufacturerid].products)}
<tr>
...
<tr>
    ...
    <td>
        <font style="FONT-SIZE: 11px">
            <a href="{if $product.clean_url ne ""}{$catalogs.customer}/{$product.clean_url}/{else}{$product.links.customer}{/if}">{$product.product}</a>

{* $Id: profile_data.tpl,v 1.15 2006/01/31 14:24:05 svowl Exp $ *}
...
<tr>
<td colspan="4"><b>{$lng.lbl_username_n_password}</b></td>
</tr>
...
{if $show_pwd && $config.Email.show_passwords_in_notifications eq "Y"}
<tr>
<td>&nbsp;&nbsp;&nbsp;</td>
...
<td>&nbsp;</td>
<td><tt>{$userinfo.phone}
{if $userinfo.phone_ext ne ""}&nbsp;{$lng.lbl_phone_ext}: {$userinfo.phone_ext}
{/if}
</tt></td>
</tr>
{/if}

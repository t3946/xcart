...
#
# $Id: import_taxes.php,v 1.8 2006/01/11 06:55:59 mclap Exp $
#
...
#
	...
	#
		...
		$_taxid = false;
		if (!empty($tax["taxid"]))
			$_taxid = func_query_first_cell("SELECT taxid FROM $sql_tbl[taxes] WHERE taxid='$tax[taxid]' AND tax_name='".addslashes($tax["tax"])."' LIMIT 1");

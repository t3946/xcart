{* $Id: atracking_logins.tpl,v 1.12.2.2 2006/07/11 08:39:26 svowl Exp $ *}
{if $statistics}
...
<tr>
	...
	<td><a href="user_modify.php?user={$statistics[idx].login|escape:"url"}&amp;usertype={$statistics[idx].usertype}">{$statistics[idx].login}</a></td>

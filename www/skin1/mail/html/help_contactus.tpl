{* $Id: help_contactus.tpl,v 1.9.2.1 2006/05/03 13:37:04 max Exp $ *}
...
{if $default_fields.b_address.avail || $default_fields.b_address_2.avail}
<tr>
<td>&nbsp;&nbsp;&nbsp;</td>

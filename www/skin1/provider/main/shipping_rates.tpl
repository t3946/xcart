...
<tr>
	...
	<td><b><label for="sm_{$zones_list[zone].zone.zoneid}_{$shipid}">{$shipping_method.shipping|trademark} ({if $shipping_method.destination eq "I"}{$lng.lbl_intl}{else}{$lng.lbl_national}{/if})</label></b></td>
</tr>
</table>

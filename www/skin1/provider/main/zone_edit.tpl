{* $Id: zone_edit.tpl,v 1.19.2.3 2006/10/03 10:20:57 max Exp $ *}
...
{include file="main/include_js.tpl" src="provider/main/zone_edit.js"}
...
<form action="zones.php" method="post" name="zoneform" onsubmit="javascript: return saveSelects(new Array('_zone_countries','_zone_states','_zone_counties'));">
...
<select id="_zone_countries" multiple="multiple" style="width: 100%;" size="{$countries_box_size}">
...
-->
	...
	<td align="center">
<input type="button" value="&lt;&lt;" onclick="javascript: moveSelect(document.getElementById('_zone_countries'), document.getElementById('rest_countries'), 'R');" />
<br /><br />
<input type="button" value="&gt;&gt;" onclick="javascript: moveSelect(document.getElementById('_zone_countries'), document.getElementById('rest_countries'), 'L');" />
	</td>
	<td>
...
<select id="_zone_states" multiple="multiple" style="width: 100%;" size="{$states_box_size}">
...
-->
	...
	<td align="center">
<input type="button" value="&lt;&lt;" onclick="javascript: moveSelect(document.getElementById('_zone_states'), document.getElementById('rest_states'), 'R');" />
<br /><br />
<input type="button" value="&gt;&gt;" onclick="javascript: moveSelect(document.getElementById('_zone_states'), document.getElementById('rest_states'), 'L');" />
	</td>
	<td>
...
<select id="_zone_counties" multiple="multiple" style="width: 100%;" size="{$counties_box_size}">
...
<tr>
	...
	<input type="submit" value="{$lng.lbl_save_zone_details|strip_tags:false|escape}" />
	</td>
</tr>

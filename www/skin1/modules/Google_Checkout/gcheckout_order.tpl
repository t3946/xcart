...
<b>#{$order.gcheckout_data.linked_orders[oids].orderid} ({include file="currency.tpl" value=$order.gcheckout_data.linked_orders[oids].total})</b>
{else}
<a href="order.php?orderid={$order.gcheckout_data.linked_orders[oids].orderid}">#{$order.gcheckout_data.linked_orders[oids].orderid} ({include file="currency.tpl" value=$order.gcheckout_data.linked_orders[oids].total})</a>
{/if}

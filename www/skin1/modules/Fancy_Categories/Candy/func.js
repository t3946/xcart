...
function fcSelect(obj) {
	...
	if (obj.bLeft)
		obj.bLeft.src = bLeftOn.src;
	if (obj.bCenter)
		setBGImage(obj.bCenter, bCenterOn.src);
	if (obj.bRight)
		obj.bRight.src = bRightOn.src;
...
function fcUnSelect(obj) {
	...
	if (obj.bLeft)
		obj.bLeft.src = bLeftOff.src;
	if (obj.bCenter)
		setBGImage(obj.bCenter, bCenterOff.src);
	if (obj.bRight)
		obj.bRight.src = bRightOff.src;

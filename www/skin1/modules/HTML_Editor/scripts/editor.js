...
function InnovaEditorUtil()
  ...
  this.activeElement;
  writeZIndexFrame(this.scriptPath);  
  }

function writeZIndexFrame(scriptPath){
  if(isIE){
    document.write("<iframe id='zIndexFrame' style='z-index:10;position:absolute;display:none;' scrolling='no' frameborder='0' src='"+images_dir+"/spacer.gif'></iframe>");
  }
}

{* $Id: template_sample_2.tpl,v 1.4 2006/02/10 14:15:19 max Exp $ *}
	...
	<td>
		...
		<tr>
			...
			<td width="100%" valign="top">
				...
				<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="100%"><img src="{$TplImages}/company_logo_2.gif" width="103" height="31" /></td>
				</tr>
				</table><br />
				...
				<tr>
					<td valign="bottom">
						<img src="{$TplImages}/spacer.gif" width="1" height="200" /><br />
						<img src="{$TplImages}/theme_2.jpg" />
					</td>
					<td valign="top">
...
{$giftcert.message|escape:"html"|replace:"\n":"<br />"}
						...
						<tr>
							<td><img src="{$TplImages}/delim_2.gif" width="100%" height="4" /></td>
						</tr>
						</table>

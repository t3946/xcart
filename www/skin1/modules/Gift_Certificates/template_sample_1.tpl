{* $Id: template_sample_1.tpl,v 1.4 2006/02/10 14:15:19 max Exp $ *}
...
<tr>
	<td>
		...
		<tr>
			<td><img src="{$TplImages}/left_top.gif" /></td>
			<td width="100%" valign="top"><img src="{$TplImages}/top_border.gif" width="100%" height="14" /></td>
			<td><img src="{$TplImages}/right_top.gif" /></td>
		</tr>
		</table>
	
		<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td><img src="{$TplImages}/left_border.gif" width="16" height="700" /></td>
			<td><img src="{$TplImages}/spacer.gif" width="34" height="1" /></td>
			<td width="100%" valign="top">
				
				<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="100%"><img src="{$TplImages}/company_logo.gif" width="103" height="31" /></td>
				</tr>
				</table><br />
				...
				<tr>
					<td valign="bottom">
						<img src="{$TplImages}/spacer.gif" width="1" height="350" /><br />
						<img src="{$TplImages}/theme.jpg" />
					</td>
					<td valign="top">
						...
						<table width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td class="gcInfo">{$lng.lbl_gc_id}:</td>
							<td class="gcInfo">&nbsp;&nbsp;</td>
							<td class="gcInfo">{$giftcert.gcid|default:$lng.lbl_gcid_notdefined}</td>
						</tr>
						<tr>
							<td class="gcInfo">{$lng.lbl_from}:</td>
							<td class="gcInfo">&nbsp;&nbsp;</td>
							<td class="gcInfo">{$giftcert.purchaser|escape:"html"}</td>
						</tr>
						<tr>
							<td class="gcInfo">{$lng.lbl_to}:</td>
							<td class="gcInfo">&nbsp;&nbsp;</td>
							<td class="gcInfo">{$giftcert.recipient|escape:"html"}</td>
						</tr>
						<tr>
							<td class="gcInfo">{$lng.lbl_amount}:</td>
							<td class="gcInfo">&nbsp;&nbsp;</td>
							<td class="gcInfo">{include file="currency.tpl" value=$giftcert.amount}</td>
						</tr>
						<tr>
							<td class="gcInfo">&nbsp;&nbsp;</td>
							<td class="gcInfo">&nbsp;&nbsp;</td>
						...
						<tr>
							<td class="gcInfo">{$lng.lbl_message}:</td>
							<td class="gcInfo">&nbsp;&nbsp;</td>
...
{$giftcert.message|escape:"html"|replace:"\n":"<br />"}
						...
						<tr>
							<td><img src="{$TplImages}/spacer.gif" width="1" height="4" /></td>
						</tr>
						<tr>
							<td><img src="{$TplImages}/delim.gif" width="100%" height="4" /></td>
						</tr>
						</table>
						...
						<tr>
							...
							<td class="gcPostalInfo">{$giftcert.recipient_zipcode|escape:"html"}</td>
						</tr>
...
{/if}
			...
			<td><img src="{$TplImages}/spacer.gif" width="34" height="1" /></td>
			<td align="right"><img src="{$TplImages}/right_border.gif" width="20" height="700" /></td>
		</tr>
		</table>

		<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td><img src="{$TplImages}/left_bottom.gif" /></td>
			<td valign="bottom" width="100%"><img src="{$TplImages}/bottom_border.gif" height="25" width="100%" /></td>
			<td><img src="{$TplImages}/curl.gif" /></td>
		</tr>
		</table>

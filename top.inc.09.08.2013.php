...
#
# $Id: top.inc.php,v 1.17.2.6 2006/11/24 07:27:35 max Exp $
#
...
#
    ...
    foreach (get_defined_vars() as $__key => $__val) {
	    ...
	    if (!in_array($__key, array('GLOBALS', '_GET', '_POST', '_SERVER', '_ENV', '_COOKIE', '_FILES', '__key', '__val', 'HTTP_RAW_POST_DATA'))) {
		unset($$__key);
	}
    }

...
if (!isset($bing_catalog[$storefrontid]))
	$BingMerchantID = 0;
else
	$BingMerchantID = $bing_catalog[$storefrontid];
...
//					SubmitProductToGBFeed($product["productid"], $MerchantID, $client_id, $key_file_location, $product["utype"], $service, $product["forsale"]);
				...
				{
					$SubmitBingInventoryBatch_arr = SubmitBingProductsBatch($binventory, $BingMerchantID, 0, $bing_username, $bing_password, $bing_token);
				...
				{
					$SubmitBingProductsBatch_arr = SubmitBingProductsBatch($bproducts, $BingMerchantID, 0, $bing_username, $bing_password, $bing_token);

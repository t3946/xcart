...
smarty_core_load_plugins(array('plugins' => array(array('function', 'xevent', 'common_templates.tpl', 1, false),)), $this); ?>
<?php if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'before','tpl' => "common_templates.tpl"), $this); endif;  if ($this->_tpl_vars['main'] == 'last_admin'):  $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php elseif ($this->_tpl_vars['main'] == 'mc_news_archive'):  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Mailchimp_Subscription/customer/news_archive.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<?php elseif ($this->_tpl_vars['main'] == 'mc_news_lists'):  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Mailchimp_Subscription/customer/news_lists.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<?php endif;  if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'after','tpl' => "common_templates.tpl"), $this); endif; ?>
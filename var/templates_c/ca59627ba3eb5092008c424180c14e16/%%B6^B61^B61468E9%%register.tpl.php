...
smarty_core_load_plugins(array('plugins' => array(array('function', 'xevent', 'customer/main/register.tpl', 1, false),array('modifier', 'amp', 'customer/main/register.tpl', 187, false),array('modifier', 'default', 'customer/main/register.tpl', 209, false),array('modifier', 'escape', 'customer/main/register.tpl', 295, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/register.tpl","lbl_modify_profile,lbl_create_profile,lbl_create_customer_profile,lbl_modify_customer_profile,txt_create_customer_profile,txt_modify_customer_profile,txt_modify_profile_msg,lbl_return_to_search_results,txt_registration_error,txt_email_already_exists,txt_user_already_exists,err_billing_state,err_shipping_state,err_billing_county,err_shipping_county,txt_email_invalid,err_username_invalid,txt_terms_and_conditions_newbie_note,txt_newbie_registration_bottom,txt_user_registration_bottom,lbl_submit,lbl_save,lbl_continue_checkout_1,txt_profile_modified,txt_partner_created,txt_profile_created"); ?><?php if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'before','tpl' => "customer/main/register.tpl"), $this); endif;  if ($this->_tpl_vars['minicart_total_items'] == 0): ?>
...
<?php if ($this->_tpl_vars['av_error'] == 1): ?>
...
<?php if ($this->_tpl_vars['usertype'] != 'C'):  if ($this->_tpl_vars['config']['General']['use_js_states'] == 'Y'):  $_smarty_tpl_vars = $this->_tpl_vars;
...
<?php if ($this->_tpl_vars['newbie'] == 'Y'):  if ($this->_tpl_vars['registered'] == ""):  if ($GLOBALS['_GET']['mode'] == 'update'): ?>
<font class="Text">
...
function check_registerform_fields() {
  ...
  <?php if ($this->_tpl_vars['usertype'] != 'P' && $this->_tpl_vars['usertype'] != 'A'): ?>
	...
	if($('#ship2diff').attr('checked')) {
        	...
        	$('#b_country').val(countrySelected_b);

	        var state_code_b = cidev_get_state_code("b_statename", "b_countryname");
        	$('#b_state').val(state_code_b);
	}

  <?php endif; ?>

	if (<?php if ($this->_tpl_vars['usertype'] != 'P' && $this->_tpl_vars['usertype'] != 'A'): ?>cidev_new_check_zip_code()<?php else: ?>check_zip_code()<?php endif;  if ($this->_tpl_vars['default_fields']['email']['avail'] == 'Y'): ?> && checkEmailAddress(document.registerform.email, '<?php echo $this->_tpl_vars['default_fields']['email']['required']; ?>
...
?<?php echo ((is_array($_tmp=$GLOBALS['_SERVER']['QUERY_STRING'])) ? $this->_run_mod_handler('amp', true, $_tmp) : smarty_modifier_amp($_tmp)); ?>
...
<?php if ($this->_tpl_vars['active_modules']['Mailchimp_Subscription'] && $this->_tpl_vars['mc_newslists']): ?>

<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Mailchimp_Subscription/customer/register_newslists.tpl", 'smarty_include_vars' => array('userinfo' => $this->_tpl_vars['userinfo'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif; ?>
...
<?php if ($GLOBALS['_GET']['mode'] == 'update'): ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/buttons/button.tpl", 'smarty_include_vars' => array('button_title' => $this->_tpl_vars['lng']['lbl_submit'],'type' => 'input','data_theme' => 'b')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<?php else:  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/buttons/button.tpl", 'smarty_include_vars' => array('button_title' => $this->_tpl_vars['lng']['lbl_save'],'type' => 'input','data_theme' => 'b')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif; ?>
...
<br />
<font style="color: #000000"><I><?php echo $this->_tpl_vars['lng']['lbl_continue_checkout_1']; ?>
</I></font>
...
<input type="hidden" name="usertype" value="<?php if ($GLOBALS['_GET']['usertype'] != ""):  echo ((is_array($_tmp=$GLOBALS['_GET']['usertype'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  else:  echo $this->_tpl_vars['usertype'];  endif; ?>" />
</form>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  else:  if ($GLOBALS['_POST']['mode'] == 'update' || $GLOBALS['_GET']['mode'] == 'update'):  echo $this->_tpl_vars['lng']['txt_profile_modified']; ?>

<?php elseif ($GLOBALS['_GET']['usertype'] == 'B' || $this->_tpl_vars['usertype'] == 'B'):  echo $this->_tpl_vars['lng']['txt_partner_created']; ?>
...
<?php endif;  if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'after','tpl' => "customer/main/register.tpl"), $this); endif; ?>
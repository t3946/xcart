...
<?php $this->_smarty_vars['capture']['javascript_code'] = ob_get_contents(); ob_end_clean();  echo smarty_function_load_defer(array('file' => 'javascript_code','direct_info' => $this->_smarty_vars['capture']['javascript_code'],'type' => 'js'), $this);?>

<?php echo smarty_function_load_defer(array('file' => "common.js",'type' => 'js'), $this);?>


<?php if ($this->_tpl_vars['active_modules']['Amazon_Checkout'] != "" && $this->_tpl_vars['amazon_widget_url']): ?>
      <script type="text/javascript" src="<?php echo $this->_tpl_vars['amazon_widget_url']; ?>
"></script>
  <?php endif;  if ($this->_tpl_vars['active_modules']['PayPalAuth'] != ""): ?>
  <?php echo smarty_function_load_defer(array('file' => "modules/PayPalAuth/ppa.js",'type' => 'js'), $this);?>

<?php endif;  echo smarty_function_load_defer(array('file' => "lib/jquery-min.js",'type' => 'js'), $this);?>
...
unset($_smarty_tpl_vars);
  if ($this->_tpl_vars['active_modules']['Google_Analytics'] && $this->_tpl_vars['config']['Google_Analytics']['ganalytics_version'] == 'Asynchronous'): ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Google_Analytics/ga_code_async.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'after','tpl' => "customer/service_js.tpl"), $this); endif; ?>
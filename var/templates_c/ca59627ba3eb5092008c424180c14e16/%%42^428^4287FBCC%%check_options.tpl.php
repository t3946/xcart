...
smarty_core_load_plugins(array('plugins' => array(array('function', 'xevent', 'modules/Product_Options/check_options.tpl', 1, false),array('function', 'math', 'modules/Product_Options/check_options.tpl', 35, false),array('modifier', 'default', 'modules/Product_Options/check_options.tpl', 27, false),array('modifier', 'escape', 'modules/Product_Options/check_options.tpl', 27, false),array('modifier', 'strip_tags', 'modules/Product_Options/check_options.tpl', 127, false),)), $this); ?>
<?php func_load_lang($this, "modules/Product_Options/check_options.tpl","txt_exception_warning,txt_exception_warning,txt_out_of_stock,lbl_no_items_available,txt_items_available,lbl_item,lbl_items,lbl_quantity,lbl_price_per_item,txt_note,lbl_including_tax"); ?><?php if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'before','tpl' => "modules/Product_Options/check_options.tpl"), $this); endif; ?><script type="text/javascript" language="JavaScript 1.2">
<!--
...
] = [<?php echo '[';  if ($this->_tpl_vars['product']['map_price'] > $this->_tpl_vars['v']['taxed_price']):  echo '';  echo $this->_tpl_vars['product']['map_price'];  echo '';  else:  echo '';  echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['v']['taxed_price'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['v']['price']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['v']['price'])))) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['product']['taxed_price']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['product']['taxed_price'])))) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['product']['price']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['product']['price']));  echo '';  endif;  echo ', ';  echo ((is_array($_tmp=@$this->_tpl_vars['v']['avail'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0));  echo ', new Image(), \'';  echo ((is_array($_tmp=@$this->_tpl_vars['v']['weight'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0));  echo '\', ';  echo ((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['v']['price'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['product']['price']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['product']['price'])))) ? $this->_run_mod_handler('default', true, $_tmp, '0') : smarty_modifier_default($_tmp, '0'));  echo ', "';  echo ((is_array($_tmp=$this->_tpl_vars['v']['productcode'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript'));  echo '"],'; ?>{<?php echo '';  $_from = $this->_tpl_vars['v']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['opts'] = array('total' => count($_from), 'iteration' => 0);
...
unset($_smarty_tpl_vars);
  if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'after','tpl' => "modules/Product_Options/check_options.tpl"), $this); endif; ?>
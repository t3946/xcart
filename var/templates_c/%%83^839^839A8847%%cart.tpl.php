...
smarty_core_load_plugins(array('plugins' => array(array('function', 'xevent', 'customer/main/cart.tpl', 1, false),array('function', 'math', 'customer/main/cart.tpl', 237, false),array('modifier', 'substitute', 'customer/main/cart.tpl', 205, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/cart.tpl","txt_cart_note,lbl_minimum_order_amount_message,lbl_items_shipped_from_warehouse,lbl_we_dont_ship_to_Canada_cart_page,lbl_selected_options,txt_warn_increase,lbl_no_shipping_for_location,lbl_gcheckout_product_disabled,lbl_minimum_order_amount_message,lbl_minimum_order_amount_message,lbl_subtotal_sg,lbl_your_mer_subtotal,lbl_continue_shopping,lbl_shipping_quote,lbl_checkout,lbl_checkout,lbl_checkout,lbl_checkout,lbl_continue_checkout_0,lbl_shipping_quote,lbl_update_qties,lbl_clear_cart,lbl_checkout,lbl_checkout,lbl_checkout,txt_your_shopping_cart_is_empty"); ?><?php if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'before','tpl' => "customer/main/cart.tpl"), $this); endif;  $this->assign('subtotal_shipping_charge', 0);  if ($this->_tpl_vars['active_modules']['Product_Options']):  $_smarty_tpl_vars = $this->_tpl_vars;
...
<input type="text" <?php if ($this->_tpl_vars['main'] == 'fast_lane_checkout'): ?> autocomplete="off" style="background: #ffffff;" id="productindex_<?php echo $this->_tpl_vars['products'][$this->_sections['product']['index']]['cartid']; ?>
...
<tr>
<td align="center">
<font style="color: #000000"><I><?php echo $this->_tpl_vars['lng']['lbl_continue_checkout_0']; ?>
</I></font>
</td>
</tr>
</table>

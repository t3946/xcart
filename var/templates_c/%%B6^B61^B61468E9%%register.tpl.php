...
$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/submit.tpl", 'smarty_include_vars' => array('type' => 'input','style' => 'button','href' => "javascript: return check_registerform_fields();",'b' => '1','button_type' => 'submit')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  else: ?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  if ($this->_tpl_vars['x_core_started']):  echo x_tpl_fire_event(array('name' => 'after','tpl' => "customer/main/register.tpl"), $this); endif; ?>
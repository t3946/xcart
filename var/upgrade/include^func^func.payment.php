...
#
# $Id: func.payment.php,v 1.4.2.6 2006/12/01 08:57:50 max Exp $
#
...
function func_check_webinput($check_php = 1) {
	...
	if ($not_found) {
		x_log_flag('log_payment_processing_errors', 'PAYMENTS', "The script '".$HTTP_SERVER_VARS["PHP_SELF"]."' is not an entry point for a payment system!", true);
		header("Location: ../");
		die("Access denied");
	}

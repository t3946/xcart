...
<td class="{$bg_title_class}"{$reading_direction_tag}><font class="ProductTitle">&nbsp;{$button_title}&nbsp;</font>{if $arrow eq "Y"}<img src="{$ImagesDir}/rarrow_flc.gif" class="BBCorner" alt="" />{/if}</td>

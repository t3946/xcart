	...
	<td align="right">
		...
		<tr>	
			<td align="center" nowrap="nowrap">
				{$config.Search_products.search_products_box_code|substitute:"gcse-id":$config.Search_products.search_products_unique_id:"pre-query":$smarty.get.sku:"gcse-extend":'google_custom_search(customSearchControl);'}

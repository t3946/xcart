...
<!--
	...
	function add_upload_row(multi_id) {ldelim}
		...
		td.innerHTML = "<input type=\"button\" value=\"{$lng.lbl_browse_|strip_tags:false|escape}\" onclick=\"javascript: popup_image_selection('D_"+row_max_index+"', '{$product.productid}', '');\" />&nbsp;<span id=\"upload_fname_"+row_max_index+"\"></span>";
		td = new_row.insertCell(-1);
...
<td width="20%" nowrap="nowrap" class="DataTable">{$lng.lbl_image_properties}</td>
<td width="20%" nowrap="nowrap">{$lng.lbl_gen_thumbnail}</td>
</tr>
...
<td>
<input type="button" value="{$lng.lbl_browse_|strip_tags:false|escape}" onclick="javascript: popup_image_selection('D_1', '{$product.productid}', '');" />&nbsp;<span id="upload_fname_1"></span>
</td>

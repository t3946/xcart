...
#
# $Id: cc_smartpag_71.php,v 1.12.2.1 2006/09/27 13:03:14 max Exp $
#
...
#NUM_PARCELA		: Installment number
#FORMA_PAGTO		: Code of payment method utilized
...
#NUM_PARCELA		: Installment number received in
...
$response.= "&NUM_PARCELA=".$HTTP_POST_VARS["NUM_PARCELA"];
$response.= "&STS_RECEIVE_TRANS=OK";
$response.= "&COD_CONTROLE=".$HTTP_POST_VARS["COD_CONTROLE"];;

func_http_post_request("homolog.smartpag.com.br","/ReceiveOkPagto.asp",$response);
exit;
?>

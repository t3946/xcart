...
#
# $Id: cc_ideal_rb_prof.php,v 1.1.2.2 2006/11/20 06:32:50 max Exp $
#
...
if ($HTTP_GET_VARS["ec"] && $HTTP_GET_VARS["trxid"]) {
	...
	$bill_output["sessid"] = func_query_first_cell("SELECT sessionid FROM $sql_tbl[cc_pp3_data] WHERE ref = '".$HTTP_GET_VARS["ec"]."'");
...
XML;
	...
	if (!ideala_test()) {
		$bill_output["code"] = 2;
		$bill_output["billmes"] = func_get_langvar_by_name("lbl_cc_ideal_openssl_key_not_found", array(), false, true);
		return;
	}

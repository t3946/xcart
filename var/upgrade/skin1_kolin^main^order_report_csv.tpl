...
#{$delimiter}{$lng.lbl_status}{$delimiter}{$lng.lbl_net}{$delimiter}{$lng.lbl_processor}{$delimiter}{$lng.lbl_net}{$delimiter}{$lng.lbl_cost_to_us}{$delimiter}{$lng.lbl_shipping}{$delimiter}{$lng.lbl_ref_to_cust}{$delimiter}{$lng.lbl_ref_to_us}{$delimiter}{$lng.lbl_profit}{$delimiter}{$lng.lbl_profit}
{$lng.lbl_distr}{$delimiter}{$lng.lbl_customer}{$delimiter}{$lng.lbl_gst_in}{$delimiter}{$lng.lbl_payment}{$delimiter}{$lng.lbl_gst_in}{$delimiter}{$lng.lbl_gst_out}{$delimiter}{$lng.lbl_gst_out}{$delimiter}{$delimiter}{$lng.lbl_gst_out}{$delimiter}{$lng.lbl_gst_in}{$delimiter}{$lng.lbl_margin}
{$delimiter}{$delimiter}{$lng.lbl_pst_in}{$delimiter}{$lng.lbl_date}{$delimiter}{$lng.lbl_pst_in}{$delimiter}{$lng.lbl_pst_out}{$delimiter}{$lng.lbl_pst_out}{$delimiter}{$lng.lbl_pst_out}{$delimiter}{$lng.lbl_pst_in}{$delimiter}{$lng.lbl_pst_in}
{$delimiter}{$delimiter}{$lng.lbl_gross}{$delimiter}{$lng.lbl_time}{$delimiter}{$lng.lbl_gross}{$delimiter}{$lng.lbl_cost_to_us}{$delimiter}{$lng.lbl_shipping}{$delimiter}{$lng.lbl_ref_to_cust}{$delimiter}{$lng.lbl_ref_to_us}{$delimiter}{$lng.lbl_profit}

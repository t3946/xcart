...
<tr class="TableHead TableHeadAccounting">
  <td width="5">&nbsp;</td>
  <td width="5%">{$lng.lbl_c2b_payment|upper}</td>
  <td width="9%">{$lng.lbl_customer}</td>
  <td width="9%">{$lng.lbl_net}</td>
  <td width="9%">{$lng.lbl_processor}</td>
  <td width="9%">{$lng.lbl_net}</td>
  <td width="9%">{$lng.lbl_cost_to_us}</td>
  <td width="9%">{$lng.lbl_shipping}</td>
  <td width="9%">{$lng.lbl_ref_to_cust}</td>
  <td width="9%">{$lng.lbl_ref_to_us}</td>
  <td width="9%">{$lng.lbl_profit}</td>
  <td width="9%">{$lng.lbl_profit}</td>
</tr>
...
{if ($v.cb_status eq 'P' || $v.dc_status eq 'C' || $v.dc_status eq 'S' || $v.cb_status eq 'R') && $v.acc_paymentid ne 0}

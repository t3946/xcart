...
function popup_image_selection (type, id, imgid) {
	...
	return window.open("image_selection.php?type="+type+"&id="+id+"&imgid="+imgid+"&notimage="+not_image,"selectimage","width=500,height=350,toolbar=no,status=no,scrollbars=yes,resizable=no,menubar=no,location=no,direction=no");
}

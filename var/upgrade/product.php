...
##
###
if ( false !== strpos( $QUERY_STRING, 'sort' ) || false !== strpos( $QUERY_STRING, 'path' ) || false !== strpos( $QUERY_STRING, 'sort_direction' ) || false !== strpos( $QUERY_STRING, 'page' ) || false !== strpos( $QUERY_STRING, 'cat' )){
        $canonical_page = "Y";
        $smarty->assign("canonical_page", $canonical_page);

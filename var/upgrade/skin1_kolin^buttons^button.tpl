...
<TR>
<TD class="Button2Off" valign="middle" onMouseOver="this.className='Button2On'" onMouseOut="this.className='Button2Off'"><FONT class="Button2">&nbsp;{if $b eq "1"}<b>{/if}{$button_title}&nbsp;{if $b eq 1}</b>{/if}</TD>
</TR>
</TABLE>

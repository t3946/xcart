...
<br /><br />
<b>{$lng.lbl_date}:</b> {$order.date|date_format:$config.Appearance.datetime_format}<br /><b>{$lng.lbl_order_id}:</b> {$order.order_prefix}{$order.orderid}<br /><b>{$lng.lbl_order_status}:</b> {$lng.lbl_please_see_below}<br />

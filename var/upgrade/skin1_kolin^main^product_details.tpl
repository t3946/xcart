...
{if $product.product|strlen > $FROOGLE_TITLE_LENGTH}
<tr>
	{if $geid ne ''}<td width="15" class="TableSubHead"><input type="checkbox" value="Y" name="fields[product]" /></td>{/if}
...
<tr>
        ...
        <td class="ProductDetails"><input type="text" name="discount_table" size="45" class="InputWidth" value="{$product.discount_table|escape|default:'2,3,4,6,8,12'}" /></td>
</tr>

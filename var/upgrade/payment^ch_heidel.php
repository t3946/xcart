...
#
# $Id: ch_heidel.php,v 1.4.2.2 2006/09/11 06:14:31 max Exp $
#
...
#$post[] = "PAYMENT.CODE=CT.CD"; #CT: CreditTransfer; CD:CREDIT
...
#$post[] = "ACCOUNT.IBAN=".$userinfo["check_ban"];
$post[] = "ACCOUNT.NUMBER=".$userinfo["check_ban"];
#$post[] = "ACCOUNT.BIC=".$userinfo["check_brn"];
...
$post[] = "CONTACT.IP=".func_get_valid_ip($HTTP_SERVER_VARS["REMOTE_ADDR"]);

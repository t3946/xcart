...
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="{$lng.lbl_generate_discounts|strip_tags:false|escape}" onclick="javascript: if (checkMarks(this.form, new RegExp('productids\[[0-9]+\]', 'gi'))) {ldelim} document.processproductform.action='product_modify.php'; submitForm(this, 'gen_discounts'); {rdelim}" />
{/if}
<br /><br /><br />

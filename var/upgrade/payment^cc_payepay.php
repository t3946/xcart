...
#
# $Id: cc_payepay.php,v 1.22.2.2 2006/09/27 13:03:14 max Exp $
#

if ($HTTP_SERVER_VARS['REQUEST_METHOD'] == "POST" && !empty($HTTP_POST_VARS["option1"]) && !empty($HTTP_POST_VARS["cc_status"])) {

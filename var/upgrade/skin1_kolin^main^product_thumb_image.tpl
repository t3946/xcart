...
<form action="product_modify.php" method="post" name="modifythumbform">
...
<tr> 
	...
	{include file="main/edit_image.tpl" type="P" id=$product.productid delete_js="submitForm(this, 'delete_product_image');" button_name='no_button' idtag="edit_product_image" image=$product.image.P already_loaded=$product.is_image_P}
	</td>
...
<tr> 
	...
	<td class="ProductDetails">
	{include file="main/edit_image.tpl" type="T" id=$product.productid delete_js="submitForm(this, 'delete_thumbnail');" button_name='no_button' image=$product.image.T already_loaded=$product.is_image_T}
	</td>
	<td colspan="2">&nbsp;</td>
</tr>
</table>

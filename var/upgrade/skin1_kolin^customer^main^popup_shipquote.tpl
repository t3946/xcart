...
<tr>
	...
	<tr>
		...
		<tr>
			<td class="ButtonsRow" align="center" colspan="3"><br />{include file="buttons/button.tpl" button_title=$lng.lbl_calculate_shippings type="input" href="javascript: document.shipquoteform.submit()" js_to_href="Y" b="1"}</td>
		</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		<td class="ButtonsRow" align="left">
			{if $short eq 'Y'}

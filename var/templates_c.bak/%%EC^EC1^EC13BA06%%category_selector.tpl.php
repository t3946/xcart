...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'main/category_selector.tpl', 61, false),)), $this); ?>
<?php func_load_lang($this, "main/category_selector.tpl","lbl_please_select_category"); ?><?php if ($this->_tpl_vars['display_field'] == ''):  $this->assign('display_field', 'category_path');  endif;  echo '
...
"<?php echo $this->_tpl_vars['extra']; ?>
 onChange="<?php if ($this->_tpl_vars['override_onchange'] == ''): ?>javascript: showTitle(this.options[this.selectedIndex].text, 'right');<?php else:  echo $this->_tpl_vars['override_onchange'];  endif; ?>">
...
<option value=""></option>
<?php endif;  $_from = $this->_tpl_vars['allcategories']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['catid'] => $this->_tpl_vars['c']):
 if ($this->_tpl_vars['display_only_selected'] == "" || $this->_tpl_vars['categoryid'] == $this->_tpl_vars['catid']): ?>
<option value="<?php echo $this->_tpl_vars['catid']; ?>
"<?php if ($this->_tpl_vars['categoryid'] == $this->_tpl_vars['catid']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['c'][$this->_tpl_vars['display_field']]; ?>
</option>

...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'amp', 'location.tpl', 7, false),)), $this); ?>
...
$this->_sections['position']['last']       = ($this->_sections['position']['iteration'] == $this->_sections['position']['total']);
 echo '';  if ($this->_tpl_vars['location'][$this->_sections['position']['index']]['1'] != ""):  echo '<a href="';  echo ((is_array($_tmp=$this->_tpl_vars['location'][$this->_sections['position']['index']]['1'])) ? $this->_run_mod_handler('amp', true, $_tmp) : smarty_modifier_amp($_tmp));  echo '" class="NavigationPath">';  endif;  echo '';  echo $this->_tpl_vars['location'][$this->_sections['position']['index']]['0'];  echo '';  if ($this->_tpl_vars['location'][$this->_sections['position']['index']]['1'] != ""):  echo '</a>';  endif;  echo '';  if (! $this->_sections['position']['last']):  echo '&nbsp;::&nbsp;';  endif;  echo '';  endfor; endif;  echo ''; ?>

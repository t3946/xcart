...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'modules/Fast_Lane_Checkout/cart_subtotal.tpl', 26, false),)), $this); ?>
<?php func_load_lang($this, "modules/Fast_Lane_Checkout/cart_subtotal.tpl","lbl_subtotal,lbl_discount,lbl_discount_coupon,lbl_unset_coupon,lbl_unset_coupon,lbl_discounted_subtotal,lbl_including,lbl_giftcert_discount,lbl_applied_giftcerts,lbl_unset_gc,txt_order_total_msg"); ?><div align="right">

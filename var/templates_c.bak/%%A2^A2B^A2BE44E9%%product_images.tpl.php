...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'modules/Detailed_Product_Images/product_images.tpl', 8, false),)), $this); ?>
<?php func_load_lang($this, "modules/Detailed_Product_Images/product_images.tpl","lbl_detailed_images,lbl_product_files"); ?><?php if ($this->_tpl_vars['images'] != ""):  ob_start(); ?>
<center>
...
$this->_sections['image']['last']       = ($this->_sections['image']['iteration'] == $this->_sections['image']['total']);
 if ($this->_tpl_vars['images'][$this->_sections['image']['index']]['avail'] == 'Y'):  if ($this->_tpl_vars['images'][$this->_sections['image']['index']]['tmbn_url']): ?>

...
:</td>
	<td width="10" height="10"><font class="FormButtonOrange"></font></td>
	<td height="10">
<textarea cols="65" rows="4" name="meta_keywords"><?php if ($this->_tpl_vars['category_error'] != ""):  echo ((is_array($_tmp=$GLOBALS['HTTP_POST_VARS']['meta_keywords'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  elseif ($this->_tpl_vars['mode'] != 'add'):  echo ((is_array($_tmp=$this->_tpl_vars['current_category']['meta_keywords'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?></textarea>
	</td>
</tr>
...
:</td>
	<td width="10" height="10"><font class="FormButtonOrange"></font></td>
	<td height="10">
<textarea cols="65" rows="4" name="meta_descr"><?php if ($this->_tpl_vars['category_error'] != ""):  echo ((is_array($_tmp=$GLOBALS['HTTP_POST_VARS']['meta_descr'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  elseif ($this->_tpl_vars['mode'] != 'add'):  echo ((is_array($_tmp=$this->_tpl_vars['current_category']['meta_descr'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'));  endif; ?></textarea>
	</td>
</tr>

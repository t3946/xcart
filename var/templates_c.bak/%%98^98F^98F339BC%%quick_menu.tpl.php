...
<?php func_load_lang($this, "main/quick_menu.tpl","txt_quick_menu_text,lbl_select_target,lbl_quick_menu"); ?>
...
:</td>
	...
	<select style='width: 200px;' onchange="javascript: if (this.selectedIndex != 0) self.location=this.value;">
		<option value="">[<?php echo $this->_tpl_vars['lng']['lbl_select_target']; ?>
]</option>
...
$this->_sections['id']['last']       = ($this->_sections['id']['iteration'] == $this->_sections['id']['total']);
 if ($this->_tpl_vars['items'][$this->_sections['id']['index']]['title'] == ""): ?>
		<option value="">------------------------------------</option>
<?php else: ?>

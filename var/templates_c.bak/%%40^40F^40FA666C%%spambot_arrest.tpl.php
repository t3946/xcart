...
<?php func_load_lang($this, "modules/Image_Verification/spambot_arrest.tpl","lbl_word_verification,lbl_type_the_characters,lbl_get_a_different_code,lbl_type_the_characters,lbl_get_a_different_code,lbl_type_the_characters,lbl_get_a_different_code"); ?>
<?php if (! $this->_tpl_vars['id']):  $this->assign('id', 'image');  endif;  if ($this->_tpl_vars['mode'] == 'advanced'): ?>
<tr>	
	<td colspan="3">

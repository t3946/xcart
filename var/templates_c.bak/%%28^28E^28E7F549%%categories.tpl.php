<?php /* Smarty version 2.6.12, created on 2011-10-11 07:01:45
         compiled from admin/main/categories.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'admin/main/categories.tpl', 23, false),array('modifier', 'strip_tags', 'admin/main/categories.tpl', 32, false),array('modifier', 'escape', 'admin/main/categories.tpl', 32, false),array('function', 'cycle', 'admin/main/categories.tpl', 71, false),)), $this); ?>
<?php func_load_lang($this, "admin/main/categories.tpl","lbl_categories_management,lbl_info_pages,txt_categories_management_top_text,lbl_current_category,lbl_root_level,lbl_root_level,txt_category_disabled,lbl_modify_category,lbl_modify,lbl_category_products,lbl_delete_category,lbl_delete,txt_list_of_subcategories,lbl_pos,lbl_subcat,lbl_categories_more,lbl_category_name,lbl_products,lbl_parent_categories,lbl_enabled,lbl_is_bold,txt_not_available,txt_not_available,lbl_categories_more,lbl_categories_more,txt_not_available,txt_not_available,txt_not_available,lbl_yes,lbl_no,txt_no_categories,lbl_note,txt_categoryies_management_note,lbl_update,lbl_modify_selected,lbl_delete_selected,lbl_add_new_,lbl_categories,lbl_info_pages"); ?><?php if (( $GLOBALS['HTTP_GET_VARS']['mode'] != 'info' )):  $_smarty_tpl_vars = $this->_tpl_vars;
...
*</td>
	...
	<td align="center"><?php echo $this->_tpl_vars['lng']['lbl_is_bold']; ?>
</td>
</tr>
...
" /></td>
	...
	<td align="center">
	        <input type="checkbox" <?php if (( $this->_tpl_vars['c']['parentid'] == $this->_tpl_vars['cat'] && $this->_tpl_vars['c']['is_bold'] == 'Y' ) || ( $this->_tpl_vars['c']['parentid'] != $this->_tpl_vars['cat'] && $this->_tpl_vars['additional_parentid'][$this->_tpl_vars['catid']][$this->_tpl_vars['cat']]['is_bold'] == 'Y' )): ?>checked="checked"<?php endif; ?> name="posted_data[<?php echo $this->_tpl_vars['catid']; ?>
][is_bold]" />
	</td>
</tr>

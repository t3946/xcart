...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'customer/main/buy_now.tpl', 10, false),array('modifier', 'substitute', 'customer/main/buy_now.tpl', 130, false),array('function', 'math', 'customer/main/buy_now.tpl', 48, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/buy_now.tpl","lbl_more_info,lbl_quantity,txt_out_of_stock,txt_out_of_stock,lbl_added,lbl_error,lbl_buy_now,lbl_more_info,txt_need_min_amount"); ?><?php if ($this->_tpl_vars['product']['price'] > 0):  if ($this->_tpl_vars['config']['Product_Options']['buynow_with_options_enabled'] == 'Y' || ( $this->_tpl_vars['product']['avail'] == 0 && $this->_tpl_vars['product']['variantid'] && $this->_tpl_vars['product']['product_type'] != 'C' )):  $this->assign('buynow_enabled', false);  else:  $this->assign('buynow_enabled', true);  endif; ?>
...
<tr>
	<td height="25">
		...
		<tr>
			<td>
				<?php $this->assign('button_href', ((is_array($_tmp=$GLOBALS['HTTP_GET_VARS']['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html'))); ?>
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/buy_now.tpl", 'smarty_include_vars' => array('style' => 'button','href' => "product.php?productid=".($this->_tpl_vars['product']['productid'])."&cat=".($this->_tpl_vars['cat'])."&page=".($this->_tpl_vars['button_href']),'b' => 1)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			</td>
			<?php if ($this->_tpl_vars['featured'] == 'Y'): ?>
				<?php $this->assign('button_href', "product.php?productid=".($this->_tpl_vars['products'][$this->_sections['product']['index']]['productid'])."&cat=".($this->_tpl_vars['cat'])."&path=alt&page=".($this->_tpl_vars['navigation_page'])."&featured"); ?>
			<?php else: ?>
				<?php $this->assign('button_href', "product.php?productid=".($this->_tpl_vars['products'][$this->_sections['product']['index']]['productid'])."&cat=".($this->_tpl_vars['cat'])."&path=alt&page=".($this->_tpl_vars['navigation_page'])); ?>
			<?php endif; ?>
...
<?php if ($this->_tpl_vars['tmp'] < 2):  $this->assign('minamount', $this->_tpl_vars['product']['min_amount']); ?> 
<?php else: ?> 
<?php $this->assign('minamount', 1);  endif; ?> 
...
"<?php if ($GLOBALS['HTTP_GET_VARS']['quantity'] == $this->_sections['quantity']['index']): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['quantity']['index']; ?>
</option>
<?php endfor; endif; ?>
</select>
<?php endif; ?>
...
<table cellpadding="0" cellspacing="0">
<tr>
<?php if ($this->_tpl_vars['js_enabled']):  if ($this->_tpl_vars['special_offers_add_to_cart'] == 'Y'): ?>
...
">
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/buy_now.tpl", 'smarty_include_vars' => array('style' => 'button','href' => "javascript: if ('".($this->_tpl_vars['config']['General']['opt_ajax_cart'])."' == 'Y' &amp;&amp; !('".($this->_tpl_vars['product']['is_product_options'])."' == 'Y' &amp;&amp; !'".($this->_tpl_vars['buynow_enabled'])."')) ajax_add_to_cart(".($this->_tpl_vars['product']['productid']).", ".($this->_tpl_vars['product']['add_date']).", 'list'); else document.orderform_".($this->_tpl_vars['product']['productid'])."_".($this->_tpl_vars['product']['add_date']).".submit();",'b' => 1,'class' => 'ajax_button')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></td>
<?php endif;  if (( $this->_tpl_vars['login'] != "" || $this->_tpl_vars['config']['Wishlist']['add2wl_unlogged_user'] == 'Y' ) && $this->_tpl_vars['active_modules']['Wishlist'] != "" && $this->_tpl_vars['special_offers_add_to_cart'] == "" && ( $this->_tpl_vars['product']['is_product_options'] != 'Y' || $this->_tpl_vars['buynow_enabled'] )): ?>
...
<tr>
	<td colspan="3"><font class="ProductDetailsTitle"><?php echo ((is_array($_tmp=$this->_tpl_vars['lng']['txt_need_min_amount'])) ? $this->_run_mod_handler('substitute', true, $_tmp, 'items', $this->_tpl_vars['product']['min_amount']) : smarty_modifier_substitute($_tmp, 'items', $this->_tpl_vars['product']['min_amount'])); ?>
</font></td>
</tr>
<?php endif;  endif; ?>
</table>

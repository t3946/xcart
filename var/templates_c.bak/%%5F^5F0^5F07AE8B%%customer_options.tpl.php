...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'modules/Product_Options/customer_options.tpl', 17, false),array('modifier', 'escape', 'modules/Product_Options/customer_options.tpl', 25, false),)), $this); ?>
<?php func_load_lang($this, "modules/Product_Options/customer_options.tpl","txt_product_options_combinations_warn"); ?><?php if ($this->_tpl_vars['product_options'] != ''):  if ($this->_tpl_vars['nojs'] != 'Y'): ?>
...
"<?php if ($this->_tpl_vars['disable']): ?> disabled="disabled"<?php endif;  if ($this->_tpl_vars['nojs'] != 'Y'): ?> onchange="javascript: check_options();"<?php endif; ?>>

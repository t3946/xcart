...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'modules/Brands/customer_brand_products.tpl', 10, false),)), $this); ?>
<?php func_load_lang($this, "modules/Brands/customer_brand_products.tpl","txt_no_products_in_brand"); ?><br>
<?php ob_start(); ?>
...
<tr>
<?php endif; ?>
	<td valign="top"><?php echo $this->_tpl_vars['brand']['descr']; ?>
</td>
</tr>
</table>
<br />
...
$this->_smarty_include(array('smarty_include_tpl_file' => "dialog.tpl", 'smarty_include_vars' => array('title' => $this->_tpl_vars['brand']['brand'],'content' => $this->_smarty_vars['capture']['dialog'],'extra' => 'width="100%"')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/main/navigation.tpl", 'smarty_include_vars' => array()));

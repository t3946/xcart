...
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'customer/main/subcategories.tpl', 28, false),array('modifier', 'escape', 'customer/main/subcategories.tpl', 36, false),array('modifier', 'lower', 'customer/main/subcategories.tpl', 39, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/subcategories.tpl","lbl_products,lbl_in,lbl_subcat_no_products,lbl_in,lbl_categories,lbl_this_category,lbl_empty_category,txt_no_products_in_cat"); ?><?php if ($this->_tpl_vars['active_modules']['Bestsellers'] != "" && $this->_tpl_vars['config']['Bestsellers']['bestsellers_menu'] != 'Y'): ?>
<p />
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  ob_start();  if (( $this->_tpl_vars['navigation_page'] == "" ) || ( $this->_tpl_vars['navigation_page'] == '1' )):  echo $this->_tpl_vars['current_category']['description']; ?>
<p /><?php endif;  $this->assign('tmp', '0');  $_from = $this->_tpl_vars['subcategories']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
$this->_smarty_include(array('smarty_include_tpl_file' => "main/search_sort_by.tpl", 'smarty_include_vars' => array('sort_fields' => $this->_tpl_vars['sort_fields'],'selected' => $this->_tpl_vars['search_prefilled']['sort_field'],'direction' => $this->_tpl_vars['search_prefilled']['sort_direction'],'url' => "home.php?cat=".($this->_tpl_vars['cat'])."&amp;path=alt&amp;")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></div>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  else:  if ($this->_tpl_vars['current_category']['main_order_by'] <= 500): ?>
<hr size="1" width="100%" />
<?php endif;  endif;  if ($this->_tpl_vars['current_category']['main_order_by'] <= 500):  $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  endif;  if ($this->_tpl_vars['products'] == "" && $this->_tpl_vars['tmp'] == '0'):  if ($this->_tpl_vars['current_category']['main_order_by'] <= 500):  echo $this->_tpl_vars['lng']['txt_no_products_in_cat']; ?>

<?php endif;  endif;  $this->_smarty_vars['capture']['dialog'] = ob_get_contents(); ob_end_clean();  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "dialog.tpl", 'smarty_include_vars' => array('title' => $this->_tpl_vars['current_category']['category'],'content' => $this->_smarty_vars['capture']['dialog'],'extra' => 'width="100%"')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);

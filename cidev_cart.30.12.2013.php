...
##
###
if ($cidev_filter_mode == "save_use_my_account" && !empty($use_my_account) && !empty($manufacturerid)){
	$cart["use_my_account"][$manufacturerid] = $use_my_account;
}

if ($cidev_filter_mode == "save_use_my_account_number" && !empty($use_my_account_number) && !empty($use_my_account_number)){
...
if ($cidev_filter_mode == "save_shippingid" && !empty($shippingids) && is_array($shippingids)){

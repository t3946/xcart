...
+-- Modules
    +-- ModuleName
        +--Components/
        |  +--NameComponent.php (описание в свободной форме )
        |
        +--Commands/ (для конмольных команд)
        |  |--NameCommand.php (extend Command)
        |
        +--Controllers/
        |  +--NameController.php (extend Controller or AdminController)
        |
        +--Models/

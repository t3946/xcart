...
//die();
		...
		db_query("INSERT INTO $sql_tbl[search_stats] (search_phrase, area_selector, customer_id, date_time, source_url, request_delay, hits) VALUES ('".addslashes($e_search_data["substring"])."', '$area_selector', '".$$XCART_SESSION_NAME."', '".time()."', '".$_SERVER["REQUEST_URI"]."', '".$result["took"]."', '".$result["hits"]["total"]."')");
	}
	#

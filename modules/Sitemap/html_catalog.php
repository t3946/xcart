...
foreach ($hc_state['catalog_dirs'] as $catdir) {
    ...
    list($http_headers, $page_src) = func_fetch_page($site_location['host'] . ':' . $site_location['port'], $site_location['path'] . DIR_CUSTOMER . '/' . $additional_hc_data_current['page_url'], 'sl=' . $catdir['code'] . $shop_closed_var . $additional_hc_data_current['page_params'], $robot_cookies);

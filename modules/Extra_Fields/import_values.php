...
#
# $Id: import_values.php,v 1.2.2.1 2006/06/29 13:54:02 max Exp $
#
...
#
	...
	foreach ($values as $n => $v) {
		...
		if (is_null($_fieldid)) {
			$_fieldid = func_query_first_cell("SELECT fieldid FROM $sql_tbl[extra_fields] WHERE service_name = '$n'".$provider_condition);
			if (empty($_fieldid)) {
				$_fieldid = NULL;
			} elseif ($action == "do") {

...
#
# $Id: func.php,v 1.2 2006/01/11 06:56:09 mclap Exp $
#
...
function keygen($productid, $key_TTL, $itemid) {
	...
	db_query("REPLACE INTO $sql_tbl[download_keys] (download_key, expires, productid, itemid) VALUES('$key', '$expires', '$productid', '$itemid')");
	return $key;
}

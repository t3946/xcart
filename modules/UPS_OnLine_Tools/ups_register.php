...
#
# $Id: ups_register.php,v 1.14 2006/01/11 06:56:20 mclap Exp $
#
...
if ($ups_reg_step > 0)
	$ups_title .= " Licensing & Registration Wizard";

$ups_reg_step_titles[0] = " - Main page";
$ups_reg_step_titles[1] = " - Step 1";
$ups_reg_step_titles[2] = " - Step 2";
$ups_reg_step_titles[3] = " - Step 3";
$ups_reg_step_titles[4] = " - Registration Successful - Step 4";

$location[] = array($ups_title.$ups_reg_step_titles[$ups_reg_step], "ups.php");

$smarty->assign("location", $location);
$smarty->assign("ups_reg_step", $ups_reg_step);
$smarty->assign("title", $ups_title.$ups_reg_step_titles[$ups_reg_step]);
...
if ($mode == "showlicense") {
	...
	if (@$raw == 1) {
		...
		if (empty($ups_licensetext)) {
			...
			echo "<div align='justify'><font style='FONT-FAMILY: Courier; FONT-SIZE: 10px;'>";
			print $pre;
			echo "</font></div>";
		}
	}
		...
		$pre = "<div align='justify'><font style='FONT-FAMILY: Courier; FONT-SIZE: 10px;'><b>UPS LICENSE AGREEMENT</b><br /><br />$pre</font></div>";

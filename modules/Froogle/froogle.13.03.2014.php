...
//					$product['page_url'] = $product['froogle_location'] . constant('DIR_CUSTOMER') . '/product.php?productid=' . $product['productid'] . '&utm_source=' . $sf_info['prefix'] . 'thefind&utm_medium=feed&utm_campaign='.$utm_campaign;
...
*/
				...
				$tmbn."\t".
				$product['page_url']."\t".
				$product['froogle_location'] . '/'.$clean_url_link."\t".

...
if ($REQUEST_METHOD == "POST" && $mode == "f_update_options"){
	...
	if (empty($id)){
		db_query("INSERT INTO $sql_tbl[froogle_options] (storefrontid, MerchantID, ClientID, enable_incremental_feed_updates) VALUES ('$current_storefront', '$MerchantID', '$ClientID', '$enable_incremental_feed_updates')");		
	} else {
		db_query("UPDATE $sql_tbl[froogle_options] SET MerchantID='$MerchantID', ClientID='$ClientID', enable_incremental_feed_updates='$enable_incremental_feed_updates' WHERE id='$id'");
	}

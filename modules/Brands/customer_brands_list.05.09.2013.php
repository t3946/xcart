...
x_session_register("filter_current_brandid");
...
if ($filter_current_brandid != $brandid){
	$filter_current_brandid = $brandid;
	x_session_save("filter_current_brandid");
...
$filter_selected_brandids[0] = $brandid;
x_session_save('filter_selected_brandids');

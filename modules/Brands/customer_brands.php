...
/*$brands_products = func_query_hash("SELECT $sql_tbl[brands].brandid/*, $sql_tbl[products].productid*//* FROM $sql_tbl[brands] $sf_join$sf_condition"
    . " GROUP BY $sql_tbl[products].brandid", 'brandid', false, true);*/
$brands_products = func_query_hash($brandidssql, 'brandid', false, true);
...
//              $cidev_brands_menu = array_values(func_brand_array_sort($brands_menu, 'first_letter'));
...
//              $count_in_row = ($count_cidev_brands_menu + $count_cidev_letters_arr)/3;

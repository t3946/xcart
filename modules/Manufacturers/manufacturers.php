...
#
		...
		#
			...
			$query_data = array(
				...
				"d_pay_to_distributor_by" => ($d_pay_to_distributor_by),
				"d_we_can_save" => ($d_we_can_save),
				"d_pay_to_distributor_save_text" => ($d_pay_to_distributor_save_text),
				"d_product_catalog" => ($d_product_catalog),
				"d_price_list" => ($d_price_list),
				"d_map_policy" => ($d_map_policy),
				"d_map_prices" => ($d_map_prices),
				"d_shipping_weights_dimensions" => ($d_shipping_weights_dimensions),
				"d_website_search_for_sku_url" => ($d_website_search_for_sku_url),
				"amazon_leadtime_to_ship" => intval($amazon_leadtime_to_ship),
				"amazon_leadtime_for_fba_loads" => intval($amazon_leadtime_for_fba_loads),
				"d_ships_to_within" => ($d_ships_to_within),
				"d_shipping_methods_usps" => ($d_shipping_methods_usps),
				"d_shipping_methods_ups" => ($d_shipping_methods_ups),
				"d_shipping_methods_fedex" => ($d_shipping_methods_fedex),
				"d_shipping_methods_trucking_company" => ($d_shipping_methods_trucking_company),
				"d_shipping_methods_other" => ($d_shipping_methods_other),
				"d_drop_ship_fee_select" => ($d_drop_ship_fee_select),
				"d_drop_ship_fee_in_us" => ($d_drop_ship_fee_in_us),
				"d_minimum_order_amount" => ($d_minimum_order_amount),
				"d_minimum_order_amount_in_us" => ($d_minimum_order_amount_in_us),
				"d_for_orders_below_min_order_amount" => ($d_for_orders_below_min_order_amount),
				"d_dealer_discount_reduced_from" => ($d_dealer_discount_reduced_from),
				"d_dealer_discount_reduced_to" => ($d_dealer_discount_reduced_to),
				...
				"d_preferred_way_submit_orders" => ($d_preferred_way_submit_orders),
				"d_url_to_login_to_distributor_website" => ($d_url_to_login_to_distributor_website),
				"d_login" => ($d_login),
				"d_password" => ($d_password),
				"d_submit_to_order_entry_operator" => ($d_submit_to_order_entry_operator),
				"d_order_entry_operator_email" => ($d_order_entry_operator_email),
				...
				"d_tax_policy_in_states" => ($d_tax_policy_in_states),
				"d_dispatch_instructions" => ($d_dispatch_instructions),
				"d_warranty_starts_when_order_is" => ($d_warranty_starts_when_order_is),
				"d_warranty_last_day" => ($d_warranty_last_day),
				"d_re_stocking_fee_for_authorized_returns" => ($d_re_stocking_fee_for_authorized_returns),
				"d_re_stocking_fee_for_unauthorized_returns" => ($d_re_stocking_fee_for_unauthorized_returns),
				"d_we_pay_to_distributor_by" => ($d_we_pay_to_distributor_by),
				"d_net_payment_terms_in_days" => ($d_net_payment_terms_in_days),
				"d_bulk_or_individual_order_payments" => ($d_bulk_or_individual_order_payments),
				...
				"d_available_on_distributor_site_checkbox" => ($d_available_on_distributor_site_checkbox),
				"d_sent_by_email_to" => ($d_sent_by_email_to),
				"d_put_on_the_invoices" => ($d_put_on_the_invoices),
				"d_available_on_distributor_site_url" => ($d_available_on_distributor_site_url),
				"d_sent_by_email_to_email_address" => ($d_sent_by_email_to_email_address),
				"d_invoices_sent_by_email_to" => ($d_invoices_sent_by_email_to),
				"d_invoices_sent_by_fax_to" => ($d_invoices_sent_by_fax_to),
				"d_invoices_sent_to" => ($d_invoices_sent_to),
				"d_invoices_by_fax_sent_to" => ($d_invoices_by_fax_sent_to),
				"d_invoices_mailed_to_our" => ($d_invoices_mailed_to_our),
				"d_invoices_mailed_to_our_checkbox" => ($d_invoices_mailed_to_our_checkbox),
				"d_availability_must_be_checked" => ($d_availability_must_be_checked),
				"d_send_to_email_14" => ($d_send_to_email_14),
				"d_message_body_14" => $d_message_body_14,
				"d_email_subject_14" => ($d_email_subject_14),
				"d_link_to_order_distributors_website" => ($d_link_to_order_distributors_website),

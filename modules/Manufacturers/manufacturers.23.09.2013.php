...
###
				...
				"d_instructions_to_order_entry_operator" => addslashes($d_instructions_to_order_entry_operator),
...
###
			...
			if (!empty($distributor_contacts) && is_array($distributor_contacts)){
				foreach ($distributor_contacts as $field_code => $v){
					db_query("INSERT INTO $sql_tbl[distributor_contacts] (manufacturerid, distributor_field_name, distributor_field_code, contact_name, email, phone, ext, fax) VALUES ('$manufacturerid', '".addslashes($v["distributor_field_name"])."', '$field_code', '".addslashes($v["contact_name"])."', '".addslashes($v["email"])."', '".addslashes($v["phone"])."', '".addslashes($v["ext"])."', '".addslashes($v["fax"])."')");
				}
			}
###
##
...
###
/*
			$distributor_contacts_field_names = array(
...
*/
			...
			foreach ($distributor_contacts_field_names as $field_code => $field_name){

				$distributor_contacts_values = func_query_first("SELECT * FROM $sql_tbl[distributor_contacts] WHERE manufacturerid = '$manufacturerid' AND distributor_field_code='$field_code'");

				if (!empty($distributor_contacts_values) && is_array($distributor_contacts_values)){
					$manufacturer_data["distributor_contacts"]["$field_code"] = $distributor_contacts_values;
				} else {
					db_query("INSERT INTO $sql_tbl[distributor_contacts] (manufacturerid, distributor_field_code) VALUES ('$manufacturerid', '$field_code');");
				}

//				$manufacturer_data["distributor_contacts"]["$field_code"]["distributor_field_name"] = $distributor_contacts_field_names["$field_code"];
			}


//func_print_r($manufacturer_data);

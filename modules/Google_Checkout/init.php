...
#
# $Id: init.php,v 1.1.2.13 2007/01/22 08:37:45 svowl Exp $
#
...
$gcheckout_requirements['tax_included_into_price'] = (func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[taxes] WHERE price_includes_tax='Y'") > 0 ? 'N' : 'Y');
...
$gcheckout_xml_url = "https://$gcheckout_env.google.com:443/{$gcheckout_sbx}cws/v2/Merchant/".$config['Google_Checkout']['gcheckout_mid']."/request";

# Only 'USD' can be used as a currency
$config['Google_Checkout']['gcheckout_currency'] = 'USD';

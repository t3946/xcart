...
if ($REQUEST_METHOD == 'POST' && $_POST['PAYGATEID'] && $_POST['ORDERNO'] && $_POST['CHECKSUM']) {
	require "./auth.php";

	$bill_output['sessid'] = func_query_first_cell("SELECT sessionid FROM $sql_tbl[cc_pp3_data] WHERE ref='" . $_POST['ORDERNO'] . "'");

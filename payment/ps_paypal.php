...
#
# $Id: ps_paypal.php,v 1.27.2.3 2006/12/28 10:44:39 max Exp $
#
...
##
###
        $tmp_pp_prefix = func_query_first_cell("SELECT order_prefix FROM $sql_tbl[orders] WHERE orderid='$secure_oid[0]'");
        if (!empty($tmp_pp_prefix)){
                $pp_prefix = $tmp_pp_prefix;
        }
###
##
#

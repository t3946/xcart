...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && $_GET['User1'] && $_GET['IPAddress'] && $_GET['TransactionID']) {
	require "./auth.php";

	if (!func_is_active_payment("cc_pswbill.php"))
		exit;

	$bill_output['sessid'] = func_query_first_cell("SELECT sessionid FROM $sql_tbl[cc_pp3_data] WHERE ref = '" . $_GET['User1'] . "'");

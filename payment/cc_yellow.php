...
if ($REQUEST_METHOD == 'POST' && $_POST['txtOrderIDShop'] && $_POST['txtPayMet']) {
	require "./auth.php";


	$bill_output['sessid'] = func_query_first_cell("SELECT sessionid FROM $sql_tbl[cc_pp3_data] WHERE ref='" . $_POST['txtOrderIDShop'] . "'");
	$bill_output["code"] = 1;

...
#
# $Id: cc_psigate_xml.php,v 1.5.2.4 2006/11/03 06:32:11 max Exp $
#
...
if ($return['Approved'] == 'APPROVED') {
	$bill_output['code'] = 1;
	$bill_output['billmes'] = "Approced: OrderID: ".$return['OrderID']."; Transaction ID: ".$return['TransRefNumber'];
} elseif($return['Approved'] == 'DECLINED') {
	$bill_output['code'] = 2;
	$bill_output['billmes'] = "Delined: OrderID: ".$return['OrderID']."; Transaction ID: ".$return['TransRefNumber']."; ReturnCode: ".$return['ReturnCode'];

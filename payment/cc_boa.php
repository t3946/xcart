...
if ($REQUEST_METHOD == 'GET' && isset($_GET['IOC_response_code']) && isset($_GET['IOC_merchant_order_id'])) {
	require "./auth.php";
	...
	$bill_output['sessid'] = array_first(func_query_first("SELECT sessionid FROM $sql_tbl[cc_pp3_data] WHERE ref='" . $_GET['ioc_merchant_order_id'] . "'"));

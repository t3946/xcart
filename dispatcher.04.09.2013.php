...
// Perform lookup in clean urls table.
    ...
    if (!empty($cidev_dispatched_request_arr) && is_array($cidev_dispatched_request_arr)){
        ...
        } elseif ($cidev_dispatched_request_arr[0] == "category" || $cidev_dispatched_request_arr[0] == "information"){
...
//print"_SERVER variable returns:";
//func_print_r($_SERVER, $request_uri_info, $clean_url_data);
//die();
...
case 'M':
    ...
    require $xcart_dir.DIR_CUSTOMER.'/brands.php';
    break;

...
if(!empty($send_browser) && $adaptives['is_first_start'] == 'Y' && $REQUEST_METHOD == 'GET'  && !empty($adaptives) && is_array($adaptives) && !empty($adaptives['is_first_start']) ) {
	...
	$arr = func_array_map("addslashes", $arr);

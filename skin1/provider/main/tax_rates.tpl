{* $Id: tax_rates.tpl,v 1.11.2.4 2006/10/25 06:39:36 max Exp $ *}
...
checkboxes = new Array({foreach from=$tax_rates item=v key=k}{if $k > 0},{/if}'to_delete[{$v.rateid}]'{/foreach});
...
<tr>
	...
	<input type="button" value="{$lng.lbl_delete_selected|strip_tags:false|escape}" onclick="javascript: submitForm(this, 'delete_rates');" />
	</td>
</tr>

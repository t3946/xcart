{* $Id: check_cc_number_script.tpl,v 1.21 2006/03/18 08:07:41 max Exp $ *}
...
var current_year = parseInt('{$smarty.now|date_format:"%Y"}');
var current_month = parseInt('{$smarty.now|date_format:"%m"}');

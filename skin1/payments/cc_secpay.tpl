{* $Id: cc_secpay.tpl,v 1.7.2.2 2006/07/11 08:39:37 svowl Exp $ *}
<h3>SECPay</h3>
...
<option value="true"{if $module_data.param03 eq "true"} selected="selected"{/if}>true
<option value="false"{if $module_data.param03 eq "false"} selected="selected"{/if}>false
</select>
</td>
</tr>
...
<option value="NOK"{if $module_data.param04 eq "NOK"} selected="selected"{/if}>Norwegian kroners
<option value="SEK"{if $module_data.param04 eq "SEK"} selected="selected"{/if}>Swedish kroners
<option value="DKK"{if $module_data.param04 eq "DKK"} selected="selected"{/if}>Danish kroners
<option value="USD"{if $module_data.param04 eq "USD"} selected="selected"{/if}>US dollars
<option value="EUR"{if $module_data.param04 eq "EUR"} selected="selected"{/if}>Euros
<option value="GBP"{if $module_data.param04 eq "GBP"} selected="selected"{/if}>British pounds
</select>
</td>
</tr>

<tr>
<td>{$lng.lbl_secpay_remotepass}:</td>
<td><input type="text" name="param06" value="{$module_data.param06|escape}" /></td>
</tr>

<tr>
<td>{$lng.lbl_secpay_digest}:</td>

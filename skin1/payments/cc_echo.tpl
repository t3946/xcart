{* $Id: cc_echo.tpl,v 1.6.2.2 2006/07/11 08:39:36 svowl Exp $ *}
<h3>ECHOnline</h3>
...
<tr>
<td>{$lng.lbl_cc_echo_merchantid}:</td>
<td><input type="text" name="param01" size="32" value="{$module_data.param01|escape}" /><br />
{$lng.lbl_cc_echo_merchantid_note}
</td>
</tr>
<tr>
<td>{$lng.lbl_cc_echo_merchantpin}:</td>

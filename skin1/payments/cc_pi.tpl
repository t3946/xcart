{* $Id: cc_pi.tpl,v 1.6.2.2 2006/07/11 08:39:37 svowl Exp $ *}
<h3>Pasat Internet</h3>
{$lng.txt_cc_configure_top_text}
<p />
{$lng.txt_cc_pi_note|substitute:"http_location":$http_location:"https_location":$https_location}
<p />
{capture name=dialog}

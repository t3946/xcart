{* $Id: ups_access_license_4.tpl,v 1.7 2006/02/01 14:26:44 max Exp $ *}
{capture name=dialog}
...
<table>
<tr>
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_finish style="button" href="javascript: document.upsstep4form.submit();"}</td>

{* $Id: ups_access_license_3.tpl,v 1.8 2006/02/01 14:26:44 max Exp $ *}
{capture name=dialog}
...
<tr>
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_fill_from_profile style="button" href="ups.php?mode=fillform"}</td>
	<td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>
	<td>{include file="buttons/button.tpl" button_title=$lng.lbl_next style="button" href="javascript: if (checkEmailAddress(document.upsstep3form.email)) document.upsstep3form.submit()"}</td>
	<td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>

{* $Id: images_location.tpl,v 1.28.2.3 2006/10/25 06:39:32 max Exp $ *}
...
<tr>
	...
	<td nowrap="nowrap"><input type="text" name="data[{$type}][default_image]" value="{$config_data.default_image}" /></td>
</tr>
<tr>
	<td colspan="2">&nbsp;</td>
</tr>

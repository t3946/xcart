...
function func_CHECK_FULLNAMES_FOR_EMAIL($order_data){
	...
	$_res = db_query("SELECT DISTINCT firstname FROM $sql_tbl[orders] WHERE email='$email' AND date <= '$order_date'");
        $total_items = db_num_rows($_res);
...
function func_CHECK_DIFFERENT_SHIPPINGS_FOR_IP($order_data){
	...
	$order_date = $order_data["order"]["date"];
        ...
        $orders = func_query("SELECT orderid,  s_address, s_city, s_state, s_country, s_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date'");
...
function func_CHECK_DIFFERENT_BILLINGS_FOR_IP($order_data){
	...
	$order_date = $order_data["order"]["date"];
        ...
        $time_condition = $order_date - 60*60*24*7;
        $orders = func_query("SELECT orderid,  b_address, b_city, b_state, b_country, b_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date'");
...
function func_CHECK_DIFFERENT_SHIPPINGS_FOR_PHONE($order_data){
	...
	$order_date = $order_data["order"]["date"];
        ...
        $time_condition = $order_date - 60*60*24*60;
        $orders = func_query("SELECT orderid, phone, s_address, s_city, s_state, s_country, s_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date'");
...
function func_CHECK_DIFFERENT_BILLINGSS_FOR_PHONE($order_data){
	...
	$order_date = $order_data["order"]["date"];
        ...
        $time_condition = $order_date - 60*60*24*60;
        $orders = func_query("SELECT orderid, phone, b_address, b_city, b_state, b_country, b_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date'");
...
function func_CHECK_DIFFERENT_SHIPPINGS_FOR_EMAIL($order_data){
	...
	$order_date = $order_data["order"]["date"];
        ...
        $time_condition = $order_date - 60*60*24*60;
        $orders = func_query("SELECT orderid, email, s_address, s_city, s_state, s_country, s_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date' AND email='$email'");
...
function func_CHECK_DIFFERENT_BILLINGS_FOR_EMAIL($order_data){
	...
	$order_date = $order_data["order"]["date"];
        ...
        $time_condition = $order_date - 60*60*24*60;
        $orders = func_query("SELECT orderid, email, b_address, b_city, b_state, b_country, b_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date' AND email='$email'");
...
function func_CHECK_DIFFERENT_SHIPPINGS_FOR_CARD($order_data){
	...
	if ($credit_card_found && $credit_card_type_found){
		...
		$credit_card_val = func_correct_field($credit_card_val);
	        ...
	        $time_condition = $order_date - 60*60*24*60;
        	$all_details = func_query("SELECT details, orderid,  s_address, s_city, s_state, s_country, s_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date'");
...
function func_CHECK_DIFFERENT_BILLING_FOR_SHIPPING($order_data){
	...
	$address_s_from_db = func_query_first("SELECT s_address, s_city, s_state, s_country, s_zipcode FROM $sql_tbl[orders] WHERE orderid='".$order_data["order"]["orderid"]."'");
        ...
        $time_condition = $order_date - 60*60*24*60;
        $orders = func_query("SELECT orderid, phone, s_address, s_city, s_state, s_country, s_zipcode, b_address, b_city, b_state, b_country, b_zipcode FROM $sql_tbl[orders] WHERE date >= '$time_condition' AND date <= '$order_date'");

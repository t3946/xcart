...
//			echo "<br>".$prod_taxes['shipping']."=<br>";

		}
			$whole_taxes = func_calculate_taxes($products, $customer_info, $sum_freight + $shipping_cost, $provider_for);
			//print_r($whole_taxes['taxes']);echo "<hr>";

//print_r($taxes);echo "<hr>$shipping_cost<hr>\n";
...
//			echo "<br><b>".$shipping_cost."---".$display_shipping_cost."</b><br>";
			$_display_subtotal = 0;
	...
	$return = array(
		"total_cost" => price_format($total + $freight_cost),

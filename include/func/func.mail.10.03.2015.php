...
#
# $Id: func.mail.php,v 1.11.2.3 2006/12/04 05:57:40 max Exp $
#
...
#
function func_send_mail($to, $subject_template, $body_template, $from, $to_admin, $crypted=false, $preg_from=false, $send_anyway=false, $reply_to_email="", $files_attached='N', $orderid=false) {
...
###
	...
	if (!empty($orderid)){
		$amazonorderid = func_query_first_cell("SELECT amazonorderid FROM $sql_tbl[orders] WHERE orderid='$orderid'");

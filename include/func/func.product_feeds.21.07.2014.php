...
*/
		    ...
		    if (!empty($all_feed_productcodes) && is_array($all_feed_productcodes)){
				...
				while ($product = db_fetch_array($ALV_products)) {
						...
						db_query("UPDATE $sql_tbl[products] SET avail='0', forsale='N', update_search_index='D' WHERE productid='".$product["productid"]."'");
					}
				}
			}
		    }
...
*/
					...
					if ($QUALIFIER == "D"){
						...
						$new_avail = 0;
               	                                ...
               	                                db_query("UPDATE $sql_tbl[products] SET avail='$new_avail', forsale='$new_forsale', update_search_index='D' WHERE productid='$productid'");
...
//func_print_r($cost_to_us, $price);
                                ...
                                $product_info = func_query_first("SELECT productid, forsale, free_ship_zone, eta_date_mm_dd_yyyy, manufacturerid, shipping_freight, low_avail_limit, free_tax, discount_slope, discount_table, discount_avail FROM $sql_tbl[products] WHERE productcode='".addslashes($SKU)."'");
...
#
				...
				$product_info = func_query_first("SELECT productid, forsale, free_ship_zone, eta_date_mm_dd_yyyy, manufacturerid, shipping_freight, low_avail_limit, free_tax, discount_slope, discount_table, discount_avail, avail FROM $sql_tbl[products] WHERE productcode='".addslashes($SKU)."'");

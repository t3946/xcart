...
##
	if (!empty($new_categoryid)){
		...
		db_query("UPDATE $sql_tbl[products_categories] SET categoryid='$new_categoryid', pc_most_relevant_categories='$pc_most_relevant_categories' WHERE productid='$productid' AND main='Y'");

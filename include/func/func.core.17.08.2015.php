...
function func_log_cidev_surf($resource_type, $resource_id = "0"){
	global $sql_tbl, $XCARTSESSID, $current_storefront, $detect_isMobile_was_created, $clean_url_data, $is_robot;
...
*/
	...
	if (empty($surf_meta)){
                ...
                func_array2insert("cidev_surf_meta", $cidev_surf_meta_arr);
		...
		db_query("UPDATE $sql_tbl[cidev_surf_meta] SET points_visited='$points_visited', last_update='".time()."' WHERE id='$surf_meta[id]'");

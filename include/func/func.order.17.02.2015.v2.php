...
function func_alt_products_table($alt_products){
        ...
        $alt_products_str = '<table cellpadding="3" cellspacing="1" width="100%"><tr style="background: #cccccc;"><td width="17%"><B>SKU</B></td><td width="*"><B>Product</B></td><td width="7%"><B>Price</B></td></tr>';
        foreach ($alt_products as $k => $v){
                $alt_products_str .= '<tr><td>'.$v["productcode"].'</td><td>'.$v["product"].'</td><td>$'.$v["price"].'</td></tr>';
        }

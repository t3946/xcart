		...
		$mes .= "STEP L ".date("H:i:s")."\n";
			...
			#
				...
				$mes .= "STEP N ".date("H:i:s")."\n";
	                	$mail_smarty->assign('type', 'A');
		                func_send_mail($config['Company']['orders_department'], 'mail/order_notification_subj.tpl', 'mail/order_notification.tpl', $userinfo['email'], true, true, false, false, $userinfo["firstname"]);

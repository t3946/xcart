...
###
    ...
    if ($resource_type == "C"){
        ...
        if (strpos($clean_url, $cidev_str) === false){
            ...
            $cidev_categoryid_path = func_query_first_cell("SELECT categoryid_path FROM $sql_tbl[categories] WHERE categoryid='$resource_id'");
            ...
            if (!empty($cidev_categoryid_path)){
                ...
                if (!empty($cidev_categoryid_path_arr) && is_array($cidev_categoryid_path_arr)){
                    ...
                    foreach ($cidev_categoryid_path_arr as $k => $v){
                        if ($tmp_count != $k){
                            $cidev_categoryid_path_name = func_query_first_cell("SELECT category FROM $sql_tbl[categories] WHERE categoryid='$v'"); 
    ...
    if ($resource_type == "P"){
        ...
        if (strpos($clean_url, $cidev_str) === false){
            ...
            $cat_id = func_query_first_cell("SELECT categoryid FROM $sql_tbl[products_categories] WHERE productid='$resource_id' AND main='Y'");

            $cidev_categoryid_path = func_query_first_cell("SELECT categoryid_path FROM $sql_tbl[categories] WHERE categoryid='$cat_id'");
...
###
        ...
        if (strpos($url, $cidev_str) === false){
            ...
            $cat_id = func_query_first_cell("SELECT categoryid FROM $sql_tbl[products_categories] WHERE productid='$productid' AND main='Y'");
            $cidev_categoryid_path = func_query_first_cell("SELECT categoryid_path FROM $sql_tbl[categories] WHERE categoryid='$cat_id'");
...
###
        ...
        if (strpos($url, $cidev_str) === false){
            ...
            $cidev_categoryid_path = func_query_first_cell("SELECT categoryid_path FROM $sql_tbl[categories] WHERE categoryid='$categoryid'");

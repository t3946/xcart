...
function func_oe_update_order($cart, $shipping_groups, $old_products="") {
	global $sql_tbl, $config, $active_modules, $xcart_dir, $dhl_ext_country, $all_languages, $price_details_names, $user_account;
...
//        	        $v['dc_status'] = 'B';
    ...
    if (isset($_POST['ref_groups'])) {
        func_update_refunded_groups($_POST['ref_groups'], $cart['orderid'], true);
    }
...
function func_update_refunded_groups(&$groups, $orderid, $can_delete_group = false) {
    global $sql_tbl;

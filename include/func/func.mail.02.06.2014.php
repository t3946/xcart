...
#
function func_send_mail($to, $subject_template, $body_template, $from, $to_admin, $crypted=false, $preg_from=false, $send_anyway=false, $name_of_sender="") {
...
##
###
	if (!empty($name_of_sender)){
		$from = $name_of_sender."<".$from.">";
	}
###
##
#

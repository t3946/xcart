...
#
function func_send_mail($to, $subject_template, $body_template, $from, $to_admin, $crypted=false, $preg_from=false) {
...
###
	...
	if (($current_area == "A" || $current_area == "P") && $_POST["mode"] == "order_edit_apply"){

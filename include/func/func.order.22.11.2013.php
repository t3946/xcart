...
# START: random:19771 [2009 Nov 25 15:10] 
	if ($order["paymentid"] == 2) {
		...
		$tmp = explode("\n",$order["details"]);
		if ($tmp) {
			$po_fields = array("po_number" => "PO Number", "company_name" => "Company name",	"name_of_purchaser" => "Name of purchaser",	"position" => "Position");
...
//func_print_r($mnfs[$m_id]["good_time_to_send_email_to_distributor"]);

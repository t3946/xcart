...
# END: random:1073746882_1073747063 [2008 Dec 24 16:25] 
	...
	if (!empty($active_modules["Manufacturers"])) {
		...
		$add_fields .= ", $sql_tbl[manufacturers].manufacturer, $sql_tbl[manufacturers].cost_to_us_coef_x, $sql_tbl[manufacturers].price_coef_x, $sql_tbl[manufacturers].price_coef_y, $sql_tbl[manufacturers].price_coef_z, $sql_tbl[manufacturers].map_price_coef_x ";
	}

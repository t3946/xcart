...
#
# $Id: func.image.php,v 1.7.2.6 2006/10/27 08:09:32 max Exp $
#
			...
			throw new Exception(_('Invalid or corrupted image file, please try uploading another image.'));
                ...
                * to PHP. */
	                ...
	                $R = MIN(620/$width,800/$height,1);
                        ...
                        $image_info["file_size"] = filesize($file_name_path);

			if ($update && !empty($image_data["imageid"])){
				db_query("UPDATE $sql_tbl[images_D] SET image_x='$new_width', image_y='$new_height', image_size='$image_info[file_size]' WHERE imageid='$image_data[imageid]'");
			}

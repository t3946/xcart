...
#
# $Id: func.files.php,v 1.22.2.8 2006/11/24 08:58:25 svowl Exp $
#
...
###
	$get_default_image = func_get_default_image($type);
        ...
        if ($current_area == "C" && !$HTTPS && !empty($get_default_image) && !empty($config["Appearance"]["CDN_domain"]) && $config["Appearance"]["Enable_CDN"] == "Y" && strpos($get_default_image, "default_image.gif")!== false){

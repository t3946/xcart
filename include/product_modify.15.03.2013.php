...
if (empty($productid) && $mode_add_product == "y" && !empty($productcode)){
	if (!empty($manufacturerid)){
		$tmp_prod_info = func_query_first("SELECT $sql_tbl[manufacturers].cost_to_us_coef_x, $sql_tbl[manufacturers].price_coef_x, $sql_tbl[manufacturers].price_coef_y, $sql_tbl[manufacturers].price_coef_z, $sql_tbl[manufacturers].map_price_coef_x FROM $sql_tbl[manufacturers] WHERE $sql_tbl[manufacturers].manufacturerid='$manufacturerid'");

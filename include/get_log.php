...
#
# $Id: get_log.php,v 1.5 2006/01/11 06:55:59 mclap Exp $
#
...
if (!$is_found || empty($file) || !$fp) {
	func_header_location("error_message.php?access_denied&id=62");
}

header('Content-Type: text/plain; name="'.preg_replace("/\.php$/", ".txt", $file).'"');
header('Content-Length: '.(filesize($filename)-strlen(X_LOG_SIGNATURE)));

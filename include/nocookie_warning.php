...
if ((empty($_COOKIE) || isset($NO_COOKIE_WARNING))
&& ($REQUEST_METHOD == 'POST' || ($REQUEST_METHOD == 'GET' && (isset($_GET['sl']) && !isset($_GET['is_https_redirect'])) || isset($NO_COOKIE_WARNING)))
) {
	if (isset($NO_COOKIE_WARNING)) {
		...
		if (empty($HTTP_REFERER)) {
			...
			$repost = (($old_page['domain'] != $_SERVER['HTTP_HOST']) || ($old_page['scheme'] == 'http' && $HTTPS) || ($old_page['scheme'] == 'https' && !$HTTPS));
		}

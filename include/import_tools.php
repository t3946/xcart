...
#
# $Id: import_tools.php,v 1.5.2.2 2006/09/13 07:26:38 max Exp $
#
...
//			array("link" => "orders.php?page_name=export", "title" => "Export orders"),
//			array("link" => "import.php?mode=export", "title" => func_get_langvar_by_name("lbl_export_data"))
	));

	if (AREA_TYPE == 'A'){
		$dialog_tools_data['left'][] = array("link" => "import.php", "title" => func_get_langvar_by_name("lbl_import_data"));
		$dialog_tools_data['left'][] = array("link" => "orders.php?page_name=export", "title" => "Export orders");
	}
	$dialog_tools_data['left'][] = array("link" => "import.php?mode=export", "title" => func_get_langvar_by_name("lbl_export_data"));
	...
	if(!empty($active_modules["Froogle"]) && AREA_TYPE == 'A')

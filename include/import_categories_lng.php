...
# Export data
	...
	while ($id = func_export_get_row($data)) {
		...
		if (!empty($active_modules['Multiple_Storefronts'])) {
			$row = func_query_first("SELECT cl.* FROM $sql_tbl[categories_lng] as cl LEFT JOIN $sql_tbl[categories] as c ON c.categoryid=cl.categoryid WHERE cl.categoryid = '$id' AND cl.code = '$current_code' AND c.storefrontid=$current_storefront");
		} else {

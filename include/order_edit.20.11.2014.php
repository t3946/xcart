...
### https://basecamp.com/2070980/projects/1577907/messages/33784697
				...
				if ((($v["cb_status"] == "P" || $v["cb_status"] == "3" || $v["cb_status"] == "V" || $v["cb_status"] == "H" || $v["cb_status"] == "R") && $order["shipping_groups"][$m_id]["shipping_cost"]["net"] != $v["shipping_cost_net"]) && ((strpos($v["shipping_cost_net"], "r")) === false && (strpos($v["shipping_cost_net"], "R")) === false)){
...
##
						if ($current_dc_status == "E" && $v['dc_status'] == "L" && $cart_tmp["shipping_groups"][$m_id]["all_distributor_info"]["submit_to_operator"] == "through_distributor_website"){
							db_query("UPDATE $sql_tbl[order_groups] SET dc_dispatched_time='".time()."' WHERE manufacturerid='$m_id' AND orderid='$orderid'");
						}
##
					}
                                }

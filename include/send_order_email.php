...
//	func_send_mail($config['Company']['orders_department'], 'mail/order_notification_subj.tpl', 'mail/order_notification_admin.tpl', $order_info['userinfo']['email'], true, true);
        ...
        $from = $order_info['userinfo']['firstname']."<".$config['Company']['orders_department'].">";
        $reply_to = $order_info['userinfo']['firstname']."<".$order_info['userinfo']['email'].">";
        func_send_mail($to, 'mail/order_notification_subj.tpl', 'mail/order_notification_admin.tpl', $from, true, true, false, false, $reply_to);

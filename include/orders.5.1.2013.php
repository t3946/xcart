...
$advanced_options = array("orderid1", "orderid2", "total_max", "payment_method", "shipping_method", "provider", "features", "product_substring", "productcode", "productid", "price_max", "customer", "address_type", "phone", "email", "s_zipcode", "orderid");
...
//        if ($fast_search == 'Y' && !empty($data['s_zipcode'])) {
		...
		$search_condition .= " AND $sql_tbl[orders].s_zipcode='".addslashes($data['s_zipcode'])."' ";
	}
...
//die();
	...
	x_session_register("order_search_condition", $search_condition);

...
### Search_Filter ###
###################################################################################
	if (!empty($active_modules['CIDEV_Best_Search_Filter']) && $mode == 'search' && !empty($search_data['products']['sorted_filter_values_id']) && is_array($search_data['products']['sorted_filter_values_id']) && $current_area != 'C') {

...
# START: random:20341 [2010 Jul 29 14:46] 
//	if ($current_area == 'A') {
	if ($current_area == 'A' && (!empty($search_data["orders"]["cb_status"]) || !empty($search_data["orders"]["dc_status"]) || !empty($search_data["orders"]["bd_status"]) || !empty($search_data["orders"]["po_status"]))) {

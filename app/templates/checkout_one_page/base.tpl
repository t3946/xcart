...
{block "header"}
    <header class="checkout-hat" itemscope itemtype="http://schema.org/WPHeader">
        <div class="checkout-hat-top-line d-none d-lg-block">
            <div class="container">
                <div class="row">
        ...
        <div class="container">
            <div class="row checkout-hat-wrapper">
                <div class="col-6 col-lg-4 checkout-hat-logo">
                    <a href="/">
                ...
                <div class="col-6 col-lg-4 checkout-hat-logo checkout-hat-logo-company">
...
{block "content-wrapper"}
    ...
    <div class="cart_shipping-page default-content-page container">
        {block "content"}{/block}
    </div>
{/block}

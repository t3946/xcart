...
<div class="default-content-page home-page">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 column slider-products slider-featured-product">
        ...
        <div class="row">
            <div class="col-12 column slider-products slider-bestsellers">
        ...
        <div class="row">
            <div class="col-12 column slider-products slider-new">

                        ...
                        <div class="row">
                            <div class="column small-12">
                                <div class="info" itemscope itemtype="http://schema.org/Person">
                                    <div class="photo">
                                        <img data-original="{$team[0]->getField('photo')->getUrl()}" alt="{$team[0]->name|escape}" class="lazy lazy-img" itemprop="image">
                                    </div>
                                    ...
                                    {if $item->photo2->getValue()}
                                        <div class="photo effect__flip effect__flip--vertical">
                                            ...
                                            <div class="back" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                                                <img data-original="{$item->getField('photo2')->getUrl()}" alt="{$item->name|escape}" class="lazy lazy-img">

            ...
            foreach ($mnfs as $m_id => $mv) {
                ...
                if ($order_group = OrderGroupModel::objects()->get(
                    ...
                    if (!empty($products) && is_array($products)) {
                        ...
                        $order_products = '<br /><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td valign="top"><img alt="" src="https://www.artistsupplysource.com/skin1_kolin/images/S3-Stores-Logo-M.png"></td><td width="100%" valign="top"><table width="100%" cellspacing="0" cellpadding="2"><tr><td width="30">&nbsp;</td><td valign="top"><h1 style="margin-bottom: 0px; margin-top: 0px; text-transform: uppercase;">PURCHASE ORDER</h1><b>Order date:</b> ' . date("j-M-Y", $order["date"]) . '<br /><b>Order #:</b> ' . $order["order_prefix"] . $order["orderid"] . '<br /></td><td valign="bottom" align="right"><b>S3 Stores, Inc.</b><br />27 Joseph St.,<br>Chatham, Ontario<br />N7L 3G5, Canada<br />Toll Free: ' . $config["Company"]["company_phone"] . '<br />Tel: ' . $config["Company"]["company_phone_2"] . '<br />Fax: ' . $config["Company"]["company_fax"] . '<br>Email: orders@s3stores.com</td></tr></table></td></tr></table><hr style="width:100%;margin: 0px 0 5px 0; border: 0 none; border-bottom: 1px solid #999999;">';

<tr class="{cycle ["", "TableSubHead"] index=$index}"
    ...
    <td class="tree" align="center">
        <div data-url="{url 'product:group_product' id=$model->productid}" data-level="{Modules\Goods\Helpers\ProductHelper::getGroupLevel($model->group_option)}" class="tree_cell single"></div>
    </td>
    <td class="checkbox">

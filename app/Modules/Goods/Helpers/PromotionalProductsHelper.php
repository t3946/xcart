...
class PromotionalProductsHelper
{
    ...
    public static function getNewProduct(): ?ProductModel
    {
        ...
        $qs->filter(['detail_images__image_id__isnull' => false,]);
        /** @var ProductModel $product */
    ...
    {
        $qs = ProductModel::showed();
        $qs->filter(['detail_images__path__isnull' => false, 'detail_images__width__gt' => 730]);
        /** @var ProductModel $product */
    ...
    {
        if ($model && $image = $model->getMainImage()) {
            return $image->getCdnURL(ProductImageModel::IMAGE_SIZE_DETAIL);
        }
        return '';
    }

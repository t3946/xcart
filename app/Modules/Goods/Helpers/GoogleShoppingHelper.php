...
class GoogleShoppingHelper
{
    public const MAX_WEIGHT = 2000;
    public const MAX_PRICE = 20000;

    public static function getGoogleShoppingEntity(ProductModel $product, SiteMarketplaceModel $marketplace, string $lang): ProductsCustomBatchRequestEntry
    {
            ...
            $w->setValue(max(min($dimx, $dimy, 150), 0.1));
            ...
            $entry->setMerchantId($marketplace->P1);
            return $entry;
    }
}
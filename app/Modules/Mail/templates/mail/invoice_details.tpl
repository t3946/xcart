        ...
        <tr>
            <td colspan="{$colspan}">
                <b>
                    ...
                    (delivery from {$distributor->m_city}, {$distributor->m_state}, {$distributor->m_country} by {$shipping->getFrontendName()}, {$site_currency->symbol_prefix}{$site_currency} {$site_currency->getCurrencyFormat($group->shipping_gross)}):
                </b>
            </td>
        </tr>
        {/if}

        ...
        <tr>
            <td colspan="{$colspan}">
                <b>
                    ...
                    {if $site_config.show_full_state_country === 'Y'}{$distributor->country_model}{else}{$distributor->m_country}{/if}  {if $shipping} {t 'by'} {$shipping->getFrontendName()} {t 'shipping'}{/if}, {$group->shipping_gross|site_currency}
                </b>
            </td>
        </tr>
        {/if}

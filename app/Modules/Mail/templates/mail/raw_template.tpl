...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    <tr>
        <td style="background-color: #f2f5f7 {block 'background_color'}{/block};" align="center" valign="top">
            <table cellpadding="0" cellspacing="0" border="0" width="960" style="margin-top: 70px;box-shadow: 0 13px 27px rgba(0,0,0,.05);">
                <tr>
                    <td style="background-color: #fff;" valign="top" align="center">
                        <table cellpadding="0" cellspacing="0" border="0" width="960" style="margin-top: 35px;">
                            <tr>
                            ...
                            <tr>
                                <td valign="top" style="font-family: Arial; font-size:14px; text-align: left;">

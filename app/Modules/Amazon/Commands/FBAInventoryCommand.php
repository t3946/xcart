...
class FBAInventoryCommand extends Command
{
    ...
    {
        $log = " * * *  Cron started  * * * \n";
        func_backprocess_log('amazon_fba_inventory', $log);
        echo $log;
        ...
        while ($aProductsBatch = ProductModel::objects()->filter([
            'amazon_offer_model__competitors__seller' => AmazonOfferHelper::OUR_MERCHANT_ID,
            'amazon_offer_model__competitors__channel' => 'FBA',
        ])
            ...
            try {
                ...
                func_backprocess_log('amazon_fba_inventory', $log_text . $e->getMessage());
            }

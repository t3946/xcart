...
class ListInboundCommand extends Command
{
    public const LOG_CATEGORY = 'cron_amazon_list_inbound_shipment_items';
    ...
    public function handle($arguments = [])
    {
        ...
        func_backprocess_log(self::LOG_CATEGORY, $log_text);

...
{block 'heading'}
    ...
    {if $site && $user}
        ...
        <a class="column large-2 create-order" href="{url 'dashboard:search'}?form_collapse=1" target="_blank">Most recent orders</a>
    {/if}
{/block}
...
{block 'content'}
    <div class="smarty-admin-block">
        <div class="tabs">
            <ul>
                <li>
                    <a href="#my_responsibilities" class="link">My responsibilities</a>
                </li>
                <li>
                    <a href="#dashboard" class="link active">Order dashboard</a>
                </li>
                <li>

        ...
        <tr>
            <td align="center">
                <form action="" method="post" name="hide_no_orders_test_checkoutform">
                    ...
                    <input type="button" value="Done!" onclick="javascript: $('#id_mode_hide_no_orders_test_checkout_message').val('hide_no_orders_test_checkout_message'); this.form.submit();" />
                </form>
            </td>
        </tr>
    </table>

...
define("ace/mode/php_completions", ["require", "exports", "module"], function (
  ...
  var functionMap = {
    ...
    call_user_func: [
      ...
      "сall a user function which is the first parameter",
    ],
    call_user_func_array: [
      "mixed call_user_func_array(string function_name, array parameters)",
      "сall a user function which is the first parameter with the arguments contained in array",
    ],
    call_user_method: [
      "mixed call_user_method(string method_name, mixed object [, mixed parameter] [, mixed ...])",
      "сall a user method on a specific object or class",
    ],
    call_user_method_array: [
      "mixed call_user_method_array(string method_name, mixed object, array params)",
      "сall a user method on a specific object or class using a parameter array",
    ],
    ceil: [
        ...
        if (text == ">") {
          ...
          if (is(token, "attribute-value")) {
            ...
            if (firstChar == '"' || firstChar == "'") {
              ...
              if (
                tokenEnd > position.column ||
                (tokenEnd == position.column && firstChar != lastChar)
              )
                return;
            }
          }

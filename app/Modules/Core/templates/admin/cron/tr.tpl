...
<tr data-pk="{$pk}" style="{if $color} background-color: {$color};{/if} {if !$item->active} color: gray;{/if} {if $item->run_force} border-bottom: 2px solid orange; {/if} {if}border-bottom: 2px solid green; {/if}">
